 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wu="FirebaseError";class $e extends Error{constructor(t,e,i){super(e),this.code=t,this.customData=i,this.name=Wu,Object.setPrototypeOf(this,$e.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,sl.prototype.create)}}class sl{constructor(t,e,i){this.service=t,this.serviceName=e,this.errors=i}create(t,...e){const i=e[0]||{},r=`${this.service}/${t}`,s=this.errors[t],a=s?Qu(s,i):"Error",c=`${this.serviceName}: ${a} (${r}).`;return new $e(r,c,i)}}function Qu(n,t){return n.replace(Gu,(e,i)=>{const r=t[i];return r!=null?String(r):`<${i}?>`})}const Gu=/\{\$([^}]+)}/g;function Lr(n,t){if(n===t)return!0;const e=Object.keys(n),i=Object.keys(t);for(const r of e){if(!i.includes(r))return!1;const s=n[r],a=t[r];if(ta(s)&&ta(a)){if(!Lr(s,a))return!1}else if(s!==a)return!1}for(const r of i)if(!e.includes(r))return!1;return!0}function ta(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gt=new al("@firebase/app"),gd="@firebase/app-compat",yd="@firebase/analytics-compat",vd="@firebase/analytics",Ad="@firebase/app-check-compat",bd="@firebase/app-check",_d="@firebase/auth",wd="@firebase/auth-compat",Ed="@firebase/database",Id="@firebase/data-connect",xd="@firebase/database-compat",Td="@firebase/functions",Rd="@firebase/functions-compat",Cd="@firebase/installations",Pd="@firebase/installations-compat",Sd="@firebase/messaging",Vd="@firebase/messaging-compat",Dd="@firebase/performance",kd="@firebase/performance-compat",Nd="@firebase/remote-config",Bd="@firebase/remote-config-compat",Ld="@firebase/storage",Md="@firebase/storage-compat",Od="@firebase/firestore",Fd="@firebase/vertexai-preview",zd="@firebase/firestore-compat",jd="firebase",qd="10.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zr="[DEFAULT]",Hd={[Fr]:"fire-core",[gd]:"fire-core-compat",[vd]:"fire-analytics",[yd]:"fire-analytics-compat",[bd]:"fire-app-check",[Ad]:"fire-app-check-compat",[_d]:"fire-auth",[wd]:"fire-auth-compat",[Ed]:"fire-rtdb",[Id]:"fire-data-connect",[xd]:"fire-rtdb-compat",[Td]:"fire-fn",[Rd]:"fire-fn-compat",[Cd]:"fire-iid",[Pd]:"fire-iid-compat",[Sd]:"fire-fcm",[Vd]:"fire-fcm-compat",[Dd]:"fire-perf",[kd]:"fire-perf-compat",[Nd]:"fire-rc",[Bd]:"fire-rc-compat",[Ld]:"fire-gcs",[Md]:"fire-gcs-compat",[Od]:"fire-fst",[zd]:"fire-fst-compat",[Fd]:"fire-vertex","fire-js":"fire-js",[jd]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ei=new Map,Ud=new Map,jr=new Map;function oa(n,t){try{n.container.addComponent(t)}catch(e){Gt.debug(`Component ${t.name} failed to register with FirebaseApp ${n.name}`,e)}}function Ii(n){const t=n.name;if(jr.has(t))return Gt.debug(`There were multiple attempts to register component ${t}.`),!1;jr.set(t,n);for(const e of Ei.values())oa(e,n);for(const e of Ud.values())oa(e,n);return!0}function $d(n,t){const e=n.container.getProvider("heartbeat").getImmediate({optional:!0});return e&&e.triggerHeartbeat(),n.container.getProvider(t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gd=qd;function ul(n,t={}){let e=n;typeof t!="object"&&(t={name:t});const i=Object.assign({name:zr,automaticDataCollectionEnabled:!1},t),r=i.name;if(typeof r!="string"||!r)throw re.create("bad-app-name",{appName:String(r)});if(e||(e=ol()),!e)throw re.create("no-options");const s=Ei.get(r);if(s){if(Lr(e,s.options)&&Lr(i,s.config))return s;throw re.create("duplicate-app",{appName:r})}const a=new Zu(r);for(const u of jr.values())a.addComponent(u);const c=new Qd(e,i,a);return Ei.set(r,c),c}function Kd(n=zr){const t=Ei.get(n);if(!t&&n===zr&&ol())return ul();if(!t)throw re.create("no-app",{appName:n});return t}function Le(n,t,e){var i;let r=(i=Hd[n])!==null&&i!==void 0?i:n;e&&(r+=`-${e}`);const s=r.match(/\s|\//),a=t.match(/\s|\//);if(s||a){const c=[`Unable to register library "${r}" with version "${t}":`];s&&c.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&a&&c.push("and"),a&&c.push(`version name "${t}" contains illegal characters (whitespace or "/")`),Gt.warn(c.join(" "));return}Ii(new En(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xd="firebase-heartbeat-database",Jd=1,In="firebase-heartbeat-store";let Rr=null;function dl(){return Rr||(Rr=dd(Xd,Jd,{upgrade:(n,t)=>{switch(t){case 0:try{n.createObjectStore(In)}catch(e){console.warn(e)}}}}).catch(n=>{throw re.create("idb-open",{originalErrorMessage:n.message})})),Rr}async function Zd(n){try{const e=(await dl()).transaction(In),i=await e.objectStore(In).get(hl(n));return await e.done,i}catch(t){if(t instanceof $e)Gt.warn(t.message);else{const e=re.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});Gt.warn(e.message)}}}async function sa(n,t){try{const i=(await dl()).transaction(In,"readwrite");await i.objectStore(In).put(t,hl(n)),await i.done}catch(e){if(e instanceof $e)Gt.warn(e.message);else{const i=re.create("idb-set",{originalErrorMessage:e==null?void 0:e.message});Gt.warn(i.message)}}}function hl(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rh(n){Ii(new En("platform-logger",t=>new fd(t),"PRIVATE")),Ii(new En("heartbeat",t=>new eh(t),"PRIVATE")),Le(Fr,ra,n),Le(Fr,ra,"esm2017"),Le("fire-js","")}rh("");var oh="firebase",sh="10.14.1";/**
 * @license
...
*/var ve,pl;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function t(_,m){function A(){}A.prototype=m.prototype,_.D=m.prototype,_.prototype=new A,_.prototype.constructor=_,_.C=function(w,E,R){for(var b=Array(arguments.length-2),St=2;St<arguments.length;St++)b[St-2]=arguments[St];return m.prototype[E].apply(w,b)}}function e(){this.blockSize=-1}function i(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}t(i,e),i.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function r(_,m,A){A||(A=0);var w=Array(16);if(typeof m=="string")for(var E=0;16>E;++E)w[E]=m.charCodeAt(A++)|m.charCodeAt(A++)<<8|m.charCodeAt(A++)<<16|m.charCodeAt(A++)<<24;else for(E=0;16>E;++E)w[E]=m[A++]|m[A++]<<8|m[A++]<<16|m[A++]<<24;m=_.g[0],A=_.g[1],E=_.g[2];var R=_.g[3],b=m+(R^A&(E^R))+w[0]+3614090360&4294967295;m=A+(b<<7&4294967295|b>>>25),b=R+(E^m&(A^E))+w[1]+3905402710&4294967295,R=m+(b<<12&4294967295|b>>>20),b=E+(A^R&(m^A))+w[2]+606105819&4294967295,E=R+(b<<17&4294967295|b>>>15),b=A+(m^E&(R^m))+w[3]+3250441966&4294967295,A=E+(b<<22&4294967295|b>>>10),b=m+(R^A&(E^R))+w[4]+4118548399&4294967295,m=A+(b<<7&4294967295|b>>>25),b=R+(E^m&(A^E))+w[5]+1200080426&4294967295,R=m+(b<<12&4294967295|b>>>20),b=E+(A^R&(m^A))+w[6]+2821735955&4294967295,E=R+(b<<17&4294967295|b>>>15),b=A+(m^E&(R^m))+w[7]+4249261313&4294967295,A=E+(b<<22&4294967295|b>>>10),b=m+(R^A&(E^R))+w[8]+1770035416&4294967295,m=A+(b<<7&4294967295|b>>>25),b=R+(E^m&(A^E))+w[9]+2336552879&4294967295,R=m+(b<<12&4294967295|b>>>20),b=E+(A^R&(m^A))+w[10]+4294925233&4294967295,E=R+(b<<17&4294967295|b>>>15),b=A+(m^E&(R^m))+w[11]+2304563134&4294967295,A=E+(b<<22&4294967295|b>>>10),b=m+(R^A&(E^R))+w[12]+1804603682&4294967295,m=A+(b<<7&4294967295|b>>>25),b=R+(E^m&(A^E))+w[13]+4254626195&4294967295,R=m+(b<<12&4294967295|b>>>20),b=E+(A^R&(m^A))+w[14]+2792965006&4294967295,E=R+(b<<17&4294967295|b>>>15),b=A+(m^E&(R^m))+w[15]+1236535329&4294967295,A=E+(b<<22&4294967295|b>>>10),b=m+(E^R&(A^E))+w[1]+4129170786&4294967295,m=A+(b<<5&4294967295|b>>>27),b=R+(A^E&(m^A))+w[6]+3225465664&4294967295,R=m+(b<<9&4294967295|b>>>23),b=E+(m^A&(R^m))+w[11]+643717713&4294967295,E=R+(b<<14&4294967295|b>>>18),b=A+(R^m&(E^R))+w[0]+3921069994&4294967295,A=E+(b<<20&4294967295|b>>>12),b=m+(E^R&(A^E))+w[5]+3593408605&4294967295,m=A+(b<<5&4294967295|b>>>27),b=R+(A^E&(m^A))+w[10]+38016083&4294967295,R=m+(b<<9&4294967295|b>>>23),b=E+(m^A&(R^m))+w[15]+3634488961&4294967295,E=R+(b<<14&4294967295|b>>>18),b=A+(R^m&(E^R))+w[4]+3889429448&4294967295,A=E+(b<<20&4294967295|b>>>12),b=m+(E^R&(A^E))+w[9]+568446438&4294967295,m=A+(b<<5&4294967295|b>>>27),b=R+(A^E&(m^A))+w[14]+3275163606&4294967295,R=m+(b<<9&4294967295|b>>>23),b=E+(m^A&(R^m))+w[3]+4107603335&4294967295,E=R+(b<<14&4294967295|b>>>18),b=A+(R^m&(E^R))+w[8]+1163531501&4294967295,A=E+(b<<20&4294967295|b>>>12),b=m+(E^R&(A^E))+w[13]+2850285829&4294967295,m=A+(b<<5&4294967295|b>>>27),b=R+(A^E&(m^A))+w[2]+4243563512&4294967295,R=m+(b<<9&4294967295|b>>>23),b=E+(m^A&(R^m))+w[7]+1735328473&4294967295,E=R+(b<<14&4294967295|b>>>18),b=A+(R^m&(E^R))+w[12]+2368359562&4294967295,A=E+(b<<20&4294967295|b>>>12),b=m+(A^E^R)+w[5]+4294588738&4294967295,m=A+(b<<4&4294967295|b>>>28),b=R+(m^A^E)+w[8]+2272392833&4294967295,R=m+(b<<11&4294967295|b>>>21),b=E+(R^m^A)+w[11]+1839030562&4294967295,E=R+(b<<16&4294967295|b>>>16),b=A+(E^R^m)+w[14]+4259657740&4294967295,A=E+(b<<23&4294967295|b>>>9),b=m+(A^E^R)+w[1]+2763975236&4294967295,m=A+(b<<4&4294967295|b>>>28),b=R+(m^A^E)+w[4]+1272893353&4294967295,R=m+(b<<11&4294967295|b>>>21),b=E+(R^m^A)+w[7]+4139469664&4294967295,E=R+(b<<16&4294967295|b>>>16),b=A+(E^R^m)+w[10]+3200236656&4294967295,A=E+(b<<23&4294967295|b>>>9),b=m+(A^E^R)+w[13]+681279174&4294967295,m=A+(b<<4&4294967295|b>>>28),b=R+(m^A^E)+w[0]+3936430074&4294967295,R=m+(b<<11&4294967295|b>>>21),b=E+(R^m^A)+w[3]+3572445317&4294967295,E=R+(b<<16&4294967295|b>>>16),b=A+(E^R^m)+w[6]+76029189&4294967295,A=E+(b<<23&4294967295|b>>>9),b=m+(A^E^R)+w[9]+3654602809&4294967295,m=A+(b<<4&4294967295|b>>>28),b=R+(m^A^E)+w[12]+3873151461&4294967295,R=m+(b<<11&4294967295|b>>>21),b=E+(R^m^A)+w[15]+530742520&4294967295,E=R+(b<<16&4294967295|b>>>16),b=A+(E^R^m)+w[2]+3299628645&4294967295,A=E+(b<<23&4294967295|b>>>9),b=m+(E^(A|~R))+w[0]+4096336452&4294967295,m=A+(b<<6&4294967295|b>>>26),b=R+(A^(m|~E))+w[7]+1126891415&4294967295,R=m+(b<<10&4294967295|b>>>22),b=E+(m^(R|~A))+w[14]+2878612391&4294967295,E=R+(b<<15&4294967295|b>>>17),b=A+(R^(E|~m))+w[5]+4237533241&4294967295,A=E+(b<<21&4294967295|b>>>11),b=m+(E^(A|~R))+w[12]+1700485571&4294967295,m=A+(b<<6&4294967295|b>>>26),b=R+(A^(m|~E))+w[3]+2399980690&4294967295,R=m+(b<<10&4294967295|b>>>22),b=E+(m^(R|~A))+w[10]+4293915773&4294967295,E=R+(b<<15&4294967295|b>>>17),b=A+(R^(E|~m))+w[1]+2240044497&4294967295,A=E+(b<<21&4294967295|b>>>11),b=m+(E^(A|~R))+w[8]+1873313359&4294967295,m=A+(b<<6&4294967295|b>>>26),b=R+(A^(m|~E))+w[15]+4264355552&4294967295,R=m+(b<<10&4294967295|b>>>22),b=E+(m^(R|~A))+w[6]+2734768916&4294967295,E=R+(b<<15&4294967295|b>>>17),b=A+(R^(E|~m))+w[13]+1309151649&4294967295,A=E+(b<<21&4294967295|b>>>11),b=m+(E^(A|~R))+w[4]+4149444226&4294967295,m=A+(b<<6&4294967295|b>>>26),b=R+(A^(m|~E))+w[11]+3174756917&4294967295,R=m+(b<<10&4294967295|b>>>22),b=E+(m^(R|~A))+w[2]+718787259&4294967295,E=R+(b<<15&4294967295|b>>>17),b=A+(R^(E|~m))+w[9]+3951481745&4294967295,_.g[0]=_.g[0]+m&4294967295,_.g[1]=_.g[1]+(E+(b<<21&4294967295|b>>>11))&4294967295,_.g[2]=_.g[2]+E&4294967295,_.g[3]=_.g[3]+R&4294967295}i.prototype.u=function(_,m){m===void 0&&(m=_.length);for(var A=m-this.blockSize,w=this.B,E=this.h,R=0;R<m;){if(E==0)for(;R<=A;)r(this,_,R),R+=this.blockSize;if(typeof _=="string"){for(;R<m;)if(w[E++]=_.charCodeAt(R++),E==this.blockSize){r(this,w),E=0;break}}else for(;R<m;)if(w[E++]=_[R++],E==this.blockSize){r(this,w),E=0;break}}this.h=E,this.o+=m},i.prototype.v=function(){var _=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);_[0]=128;for(var m=1;m<_.length-8;++m)_[m]=0;var A=8*this.o;for(m=_.length-8;m<_.length;++m)_[m]=A&255,A/=256;for(this.u(_),_=Array(16),m=A=0;4>m;++m)for(var w=0;32>w;w+=8)_[A++]=this.g[m]>>>w&255;return _};function s(_,m){var A=c;return Object.prototype.hasOwnProperty.call(A,_)?A[_]:A[_]=m(_)}function a(_,m){this.h=m;for(var A=[],w=!0,E=_.length-1;0<=E;E--){var R=_[E]|0;w&&R==m||(A[E]=R,w=!1)}this.g=A}var c={};function u(_){return-128<=_&&128>_?s(_,function(m){return new a([m|0],0>m?-1:0)}):new a([_|0],0>_?-1:0)}function h(_){if(isNaN(_)||!isFinite(_))return y;if(0>_)return g(h(-_));for(var m=[],A=1,w=0;_>=A;w++)m[w]=_/A|0,A*=4294967296;return new a(m,0)}function f(_,m){if(_.length==0)throw Error("number format error: empty string");if(m=m||10,2>m||36<m)throw Error("radix out of range: "+m);if(_.charAt(0)=="-")return g(f(_.substring(1),m));if(0<=_.indexOf("-"))throw Error('number format error: interior "-" character');for(var A=h(Math.pow(m,8)),w=y,E=0;E<_.length;E+=8){var R=Math.min(8,_.length-E),b=parseInt(_.substring(E,E+R),m);8>R?(R=h(Math.pow(m,R)),w=w.j(R).add(h(b))):(w=w.j(A),w=w.add(h(b)))}return w}var y=u(0),v=u(1),I=u(16777216);n=a.prototype,n.m=function(){if(T(this))return-g(this).m();for(var _=0,m=1,A=0;A<this.g.length;A++){var w=this.i(A);_+=(0<=w?w:4294967296+w)*m,m*=4294967296}return _},n.toString=function(_){if(_=_||10,2>_||36<_)throw Error("radix out of range: "+_);if(k(this))return"0";if(T(this))return"-"+g(this).toString(_);for(var m=h(Math.pow(_,6)),A=this,w="";;){var E=S(A,m).g;A=x(A,E.j(m));var R=((0<A.g.length?A.g[0]:A.h)>>>0).toString(_);if(A=E,k(A))return R+w;for(;6>R.length;)R="0"+R;w=R+w}},n.i=function(_){return 0>_?0:_<this.g.length?this.g[_]:this.h};function k(_){if(_.h!=0)return!1;for(var m=0;m<_.g.length;m++)if(_.g[m]!=0)return!1;return!0}function T(_){return _.h==-1}n.l=function(_){return _=x(this,_),T(_)?-1:k(_)?0:1};function g(_){for(var m=_.g.length,A=[],w=0;w<m;w++)A[w]=~_.g[w];return new a(A,~_.h).add(v)}n.abs=function(){return T(this)?g(this):this},n.add=function(_){for(var m=Math.max(this.g.length,_.g.length),A=[],w=0,E=0;E<=m;E++){var R=w+(this.i(E)&65535)+(_.i(E)&65535),b=(R>>>16)+(this.i(E)>>>16)+(_.i(E)>>>16);w=b>>>16,R&=65535,b&=65535,A[E]=b<<16|R}return new a(A,A[A.length-1]&-2147483648?-1:0)};function x(_,m){return _.add(g(m))}n.j=function(_){if(k(this)||k(_))return y;if(T(this))return T(_)?g(this).j(g(_)):g(g(this).j(_));if(T(_))return g(this.j(g(_)));if(0>this.l(I)&&0>_.l(I))return h(this.m()*_.m());for(var m=this.g.length+_.g.length,A=[],w=0;w<2*m;w++)A[w]=0;for(w=0;w<this.g.length;w++)for(var E=0;E<_.g.length;E++){var R=this.i(w)>>>16,b=this.i(w)&65535,St=_.i(E)>>>16,Vt=_.i(E)&65535;A[2*w+2*E]+=b*Vt,P(A,2*w+2*E),A[2*w+2*E+1]+=R*Vt,P(A,2*w+2*E+1),A[2*w+2*E+1]+=b*St,P(A,2*w+2*E+1),A[2*w+2*E+2]+=R*St,P(A,2*w+2*E+2)}for(w=0;w<m;w++)A[w]=A[2*w+1]<<16|A[2*w];for(w=m;w<2*m;w++)A[w]=0;return new a(A,0)};function P(_,m){for(;(_[m]&65535)!=_[m];)_[m+1]+=_[m]>>>16,_[m]&=65535,m++}function B(_,m){this.g=_,this.h=m}function S(_,m){if(k(m))throw Error("division by zero");if(k(_))return new B(y,y);if(T(_))return m=S(g(_),m),new B(g(m.g),g(m.h));if(T(m))return m=S(_,g(m)),new B(g(m.g),m.h);if(30<_.g.length){if(T(_)||T(m))throw Error("slowDivide_ only works with positive integers.");for(var A=v,w=m;0>=w.l(_);)A=M(A),w=M(w);var E=D(A,1),R=D(w,1);for(w=D(w,2),A=D(A,2);!k(w);){var b=R.add(w);0>=b.l(_)&&(E=E.add(A),R=b),w=D(w,1),A=D(A,1)}return m=x(_,E.j(m)),new B(E,m)}for(E=y;0<=_.l(m);){for(A=Math.max(1,Math.floor(_.m()/m.m())),w=Math.ceil(Math.log(A)/Math.LN2),w=48>=w?1:Math.pow(2,w-48),R=h(A),b=R.j(m);T(b)||0<b.l(_);)A-=w,R=h(A),b=R.j(m);k(R)&&(R=v),E=E.add(R),_=x(_,b)}return new B(E,_)}n.A=function(_){return S(this,_).h},n.and=function(_){for(var m=Math.max(this.g.length,_.g.length),A=[],w=0;w<m;w++)A[w]=this.i(w)&_.i(w);return new a(A,this.h&_.h)},n.or=function(_){for(var m=Math.max(this.g.length,_.g.length),A=[],w=0;w<m;w++)A[w]=this.i(w)|_.i(w);return new a(A,this.h|_.h)},n.xor=function(_){for(var m=Math.max(this.g.length,_.g.length),A=[],w=0;w<m;w++)A[w]=this.i(w)^_.i(w);return new a(A,this.h^_.h)};function M(_){for(var m=_.g.length+1,A=[],w=0;w<m;w++)A[w]=_.i(w)<<1|_.i(w-1)>>>31;return new a(A,_.h)}function D(_,m){var A=m>>5;m%=32;for(var w=_.g.length-A,E=[],R=0;R<w;R++)E[R]=0<m?_.i(R+A)>>>m|_.i(R+A+1)<<32-m:_.i(R+A);return new a(E,_.h)}i.prototype.digest=i.prototype.v,i.prototype.reset=i.prototype.s,i.prototype.update=i.prototype.u,pl=i,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=h,a.fromString=f,ve=a}).apply(typeof ca<"u"?ca:typeof self<"u"?self:typeof window<"u"?window:{});var hi=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var fl,mn,ml,yi,qr,gl,yl,vl;(function(){var n,t=typeof Object.defineProperties=="function"?Object.defineProperty:function(o,l,d){return o==Array.prototype||o==Object.prototype||(o[l]=d.value),o};function e(o){o=[typeof globalThis=="object"&&globalThis,o,typeof window=="object"&&window,typeof self=="object"&&self,typeof hi=="object"&&hi];for(var l=0;l<o.length;++l){var d=o[l];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var i=e(this);function r(o,l){if(l)t:{var d=i;o=o.split(".");for(var p=0;p<o.length-1;p++){var C=o[p];if(!(C in d))break t;d=d[C]}o=o[o.length-1],p=d[o],l=l(p),l!=p&&l!=null&&t(d,o,{configurable:!0,writable:!0,value:l})}}function s(o,l){o instanceof String&&(o+="");var d=0,p=!1,C={next:function(){if(!p&&d<o.length){var V=d++;return{value:l(V,o[V]),done:!1}}return p=!0,{done:!0,value:void 0}}};return C[Symbol.iterator]=function(){return C},C}r("Array.prototype.values",function(o){return o||function(){return s(this,function(l,d){return d})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var a=a||{},c=this||self;function u(o){var l=typeof o;return l=l!="object"?l:o?Array.isArray(o)?"array":l:"null",l=="array"||l=="object"&&typeof o.length=="number"}function h(o){var l=typeof o;return l=="object"&&o!=null||l=="function"}function f(o,l,d){return o.call.apply(o.bind,arguments)}function y(o,l,d){if(!o)throw Error();if(2<arguments.length){var p=Array.prototype.slice.call(arguments,2);return function(){var C=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(C,p),o.apply(l,C)}}return function(){return o.apply(l,arguments)}}function v(o,l,d){return v=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?f:y,v.apply(null,arguments)}function I(o,l){var d=Array.prototype.slice.call(arguments,1);return function(){var p=d.slice();return p.push.apply(p,arguments),o.apply(this,p)}}function k(o,l){function d(){}d.prototype=l.prototype,o.aa=l.prototype,o.prototype=new d,o.prototype.constructor=o,o.Qb=function(p,C,V){for(var O=Array(arguments.length-2),Z=2;Z<arguments.length;Z++)O[Z-2]=arguments[Z];return l.prototype[C].apply(p,O)}}function T(o){const l=o.length;if(0<l){const d=Array(l);for(let p=0;p<l;p++)d[p]=o[p];return d}return[]}function g(o,l){for(let d=1;d<arguments.length;d++){const p=arguments[d];if(u(p)){const C=o.length||0,V=p.length||0;o.length=C+V;for(let O=0;O<V;O++)o[C+O]=p[O]}else o.push(p)}}class x{constructor(l,d){this.i=l,this.j=d,this.h=0,this.g=null}get(){let l;return 0<this.h?(this.h--,l=this.g,this.g=l.next,l.next=null):l=this.i(),l}}function P(o){return/^[\s\xa0]*$/.test(o)}function B(){var o=c.navigator;return o&&(o=o.userAgent)?o:""}function S(o){return S[" "](o),o}S[" "]=function(){};var M=B().indexOf("Gecko")!=-1&&!(B().toLowerCase().indexOf("webkit")!=-1&&B().indexOf("Edge")==-1)&&!(B().indexOf("Trident")!=-1||B().indexOf("MSIE")!=-1)&&B().indexOf("Edge")==-1;function D(o,l,d){for(const p in o)l.call(d,o[p],p,o)}function _(o,l){for(const d in o)l.call(void 0,o[d],d,o)}function m(o){const l={};for(const d in o)l[d]=o[d];return l}const A="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function w(o,l){let d,p;for(let C=1;C<arguments.length;C++){p=arguments[C];for(d in p)o[d]=p[d];for(let V=0;V<A.length;V++)d=A[V],Object.prototype.hasOwnProperty.call(p,d)&&(o[d]=p[d])}}function E(o){var l=1;o=o.split(":");const d=[];for(;0<l&&o.length;)d.push(o.shift()),l--;return o.length&&d.push(o.join(":")),d}function R(o){c.setTimeout(()=>{throw o},0)}function b(){var o=Ze;let l=null;return o.g&&(l=o.g,o.g=o.g.next,o.g||(o.h=null),l.next=null),l}class St{constructor(){this.h=this.g=null}add(l,d){const p=Vt.get();p.set(l,d),this.h?this.h.next=p:this.g=p,this.h=p}}var Vt=new x(()=>new xe,o=>o.reset());class xe{constructor(){this.next=this.g=this.h=null}set(l,d){this.h=l,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let Ut,Jt=!1,Ze=new St,Qn=()=>{const o=c.Promise.resolve(void 0);Ut=()=>{o.then(Te)}};var Te=()=>{for(var o;o=b();){try{o.h.call(o.g)}catch(d){R(d)}var l=Vt;l.j(o),100>l.h&&(l.h++,o.next=l.g,l.g=o)}Jt=!1};function Dt(){this.s=this.s,this.C=this.C}Dt.prototype.s=!1,Dt.prototype.ma=function(){this.s||(this.s=!0,this.N())},Dt.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function J(o,l){this.type=o,this.g=this.target=l,this.defaultPrevented=!1}J.prototype.h=function(){this.defaultPrevented=!0};var Rt=function(){if(!c.addEventListener||!Object.defineProperty)return!1;var o=!1,l=Object.defineProperty({},"passive",{get:function(){o=!0}});try{const d=()=>{};c.addEventListener("test",d,l),c.removeEventListener("test",d,l)}catch{}return o}();function Bt(o,l){if(J.call(this,o?o.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,o){var d=this.type=o.type,p=o.changedTouches&&o.changedTouches.length?o.changedTouches[0]:null;if(this.target=o.target||o.srcElement,this.g=l,l=o.relatedTarget){if(M){t:{try{S(l.nodeName);var C=!0;break t}catch{}C=!1}C||(l=null)}}else d=="mouseover"?l=o.fromElement:d=="mouseout"&&(l=o.toElement);this.relatedTarget=l,p?(this.clientX=p.clientX!==void 0?p.clientX:p.pageX,this.clientY=p.clientY!==void 0?p.clientY:p.pageY,this.screenX=p.screenX||0,this.screenY=p.screenY||0):(this.clientX=o.clientX!==void 0?o.clientX:o.pageX,this.clientY=o.clientY!==void 0?o.clientY:o.pageY,this.screenX=o.screenX||0,this.screenY=o.screenY||0),this.button=o.button,this.key=o.key||"",this.ctrlKey=o.ctrlKey,this.altKey=o.altKey,this.shiftKey=o.shiftKey,this.metaKey=o.metaKey,this.pointerId=o.pointerId||0,this.pointerType=typeof o.pointerType=="string"?o.pointerType:Ye[o.pointerType]||"",this.state=o.state,this.i=o,o.defaultPrevented&&Bt.aa.h.call(this)}}k(Bt,J);var Ye={2:"touch",3:"pen",4:"mouse"};Bt.prototype.h=function(){Bt.aa.h.call(this);var o=this.i;o.preventDefault?o.preventDefault():o.returnValue=!1};var Zt="closure_listenable_"+(1e6*Math.random()|0),Zc=0;function Yc(o,l,d,p,C){this.listener=o,this.proxy=null,this.src=l,this.type=d,this.capture=!!p,this.ha=C,this.key=++Zc,this.da=this.fa=!1}function Gn(o){o.da=!0,o.listener=null,o.proxy=null,o.src=null,o.ha=null}function Kn(o){this.src=o,this.g={},this.h=0}Kn.prototype.add=function(o,l,d,p,C){var V=o.toString();o=this.g[V],o||(o=this.g[V]=[],this.h++);var O=nr(o,l,p,C);return-1<O?(l=o[O],d||(l.fa=!1)):(l=new Yc(l,this.src,V,!!p,C),l.fa=d,o.push(l)),l};function er(o,l){var d=l.type;if(d in o.g){var p=o.g[d],C=Array.prototype.indexOf.call(p,l,void 0),V;(V=0<=C)&&Array.prototype.splice.call(p,C,1),V&&(Gn(l),o.g[d].length==0&&(delete o.g[d],o.h--))}}function nr(o,l,d,p){for(var C=0;C<o.length;++C){var V=o[C];if(!V.da&&V.listener==l&&V.capture==!!d&&V.ha==p)return C}return-1}var ir="closure_lm_"+(1e6*Math.random()|0),rr={};function ts(o,l,d,p,C){if(Array.isArray(l)){for(var V=0;V<l.length;V++)ts(o,l[V],d,p,C);return null}return d=is(d),o&&o[Zt]?o.K(l,d,h(p)?!!p.capture:!1,C):tu(o,l,d,!1,p,C)}function tu(o,l,d,p,C,V){if(!l)throw Error("Invalid event type");var O=h(C)?!!C.capture:!!C,Z=sr(o);if(Z||(o[ir]=Z=new Kn(o)),d=Z.add(l,d,p,O,V),d.proxy)return d;if(p=eu(),d.proxy=p,p.src=o,p.listener=d,o.addEventListener)Rt||(C=O),C===void 0&&(C=!1),o.addEventListener(l.toString(),p,C);else if(o.attachEvent)o.attachEvent(ns(l.toString()),p);else if(o.addListener&&o.removeListener)o.addListener(p);else throw Error("addEventListener and attachEvent are unavailable.");return d}function eu(){function o(d){return l.call(o.src,o.listener,d)}const l=nu;return o}function es(o,l,d,p,C){if(Array.isArray(l))for(var V=0;V<l.length;V++)es(o,l[V],d,p,C);else p=h(p)?!!p.capture:!!p,d=is(d),o&&o[Zt]?(o=o.i,l=String(l).toString(),l in o.g&&(V=o.g[l],d=nr(V,d,p,C),-1<d&&(Gn(V[d]),Array.prototype.splice.call(V,d,1),V.length==0&&(delete o.g[l],o.h--)))):o&&(o=sr(o))&&(l=o.g[l.toString()],o=-1,l&&(o=nr(l,d,p,C)),(d=-1<o?l[o]:null)&&or(d))}function or(o){if(typeof o!="number"&&o&&!o.da){var l=o.src;if(l&&l[Zt])er(l.i,o);else{var d=o.type,p=o.proxy;l.removeEventListener?l.removeEventListener(d,p,o.capture):l.detachEvent?l.detachEvent(ns(d),p):l.addListener&&l.removeListener&&l.removeListener(p),(d=sr(l))?(er(d,o),d.h==0&&(d.src=null,l[ir]=null)):Gn(o)}}}function ns(o){return o in rr?rr[o]:rr[o]="on"+o}function nu(o,l){if(o.da)o=!0;else{l=new Bt(l,this);var d=o.listener,p=o.ha||o.src;o.fa&&or(o),o=d.call(p,l)}return o}function sr(o){return o=o[ir],o instanceof Kn?o:null}var ar="__closure_events_fn_"+(1e9*Math.random()>>>0);function is(o){return typeof o=="function"?o:(o[ar]||(o[ar]=function(l){return o.handleEvent(l)}),o[ar])}function ft(){Dt.call(this),this.i=new Kn(this),this.M=this,this.F=null}k(ft,Dt),ft.prototype[Zt]=!0,ft.prototype.removeEventListener=function(o,l,d,p){es(this,o,l,d,p)};function _t(o,l){var d,p=o.F;if(p)for(d=[];p;p=p.F)d.push(p);if(o=o.M,p=l.type||l,typeof l=="string")l=new J(l,o);else if(l instanceof J)l.target=l.target||o;else{var C=l;l=new J(p,o),w(l,C)}if(C=!0,d)for(var V=d.length-1;0<=V;V--){var O=l.g=d[V];C=Xn(O,p,!0,l)&&C}if(O=l.g=o,C=Xn(O,p,!0,l)&&C,C=Xn(O,p,!1,l)&&C,d)for(V=0;V<d.length;V++)O=l.g=d[V],C=Xn(O,p,!1,l)&&C}ft.prototype.N=function(){if(ft.aa.N.call(this),this.i){var o=this.i,l;for(l in o.g){for(var d=o.g[l],p=0;p<d.length;p++)Gn(d[p]);delete o.g[l],o.h--}}this.F=null},ft.prototype.K=function(o,l,d,p){return this.i.add(String(o),l,!1,d,p)},ft.prototype.L=function(o,l,d,p){return this.i.add(String(o),l,!0,d,p)};function Xn(o,l,d,p){if(l=o.i.g[String(l)],!l)return!0;l=l.concat();for(var C=!0,V=0;V<l.length;++V){var O=l[V];if(O&&!O.da&&O.capture==d){var Z=O.listener,ct=O.ha||O.src;O.fa&&er(o.i,O),C=Z.call(ct,p)!==!1&&C}}return C&&!p.defaultPrevented}function rs(o,l,d){if(typeof o=="function")d&&(o=v(o,d));else if(o&&typeof o.handleEvent=="function")o=v(o.handleEvent,o);else throw Error("Invalid listener argument");return 2147483647<Number(l)?-1:c.setTimeout(o,l||0)}function os(o){o.g=rs(()=>{o.g=null,o.i&&(o.i=!1,os(o))},o.l);const l=o.h;o.h=null,o.m.apply(null,l)}class iu extends Dt{constructor(l,d){super(),this.m=l,this.l=d,this.h=null,this.i=!1,this.g=null}j(l){this.h=arguments,this.g?this.i=!0:os(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function tn(o){Dt.call(this),this.h=o,this.g={}}k(tn,Dt);var ss=[];function as(o){D(o.g,function(l,d){this.g.hasOwnProperty(d)&&or(l)},o),o.g={}}tn.prototype.N=function(){tn.aa.N.call(this),as(this)},tn.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var lr=c.JSON.stringify,ru=c.JSON.parse,ou=class{stringify(o){return c.JSON.stringify(o,void 0)}parse(o){return c.JSON.parse(o,void 0)}};function cr(){}cr.prototype.h=null;function ls(o){return o.h||(o.h=o.i())}function cs(){}var en={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function ur(){J.call(this,"d")}k(ur,J);function dr(){J.call(this,"c")}k(dr,J);var de={},us=null;function Jn(){return us=us||new ft}de.La="serverreachability";function ds(o){J.call(this,de.La,o)}k(ds,J);function nn(o){const l=Jn();_t(l,new ds(l))}de.STAT_EVENT="statevent";function hs(o,l){J.call(this,de.STAT_EVENT,o),this.stat=l}k(hs,J);function wt(o){const l=Jn();_t(l,new hs(l,o))}de.Ma="timingevent";function ps(o,l){J.call(this,de.Ma,o),this.size=l}k(ps,J);function rn(o,l){if(typeof o!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){o()},l)}function on(){this.g=!0}on.prototype.xa=function(){this.g=!1};function su(o,l,d,p,C,V){o.info(function(){if(o.g)if(V)for(var O="",Z=V.split("&"),ct=0;ct<Z.length;ct++){var G=Z[ct].split("=");if(1<G.length){var mt=G[0];G=G[1];var gt=mt.split("_");O=2<=gt.length&&gt[1]=="type"?O+(mt+"="+G+"&"):O+(mt+"=redacted&")}}else O=null;else O=V;return"XMLHTTP REQ ("+p+") [attempt "+C+"]: "+l+`
`+d+`
`+O})}function au(o,l,d,p,C,V,O){o.info(function(){return"XMLHTTP RESP ("+p+") [ attempt "+C+"]: "+l+`
`+d+`
`+V+" "+O})}function Re(o,l,d,p){o.info(function(){return"XMLHTTP TEXT ("+l+"): "+cu(o,d)+(p?" "+p:"")})}function lu(o,l){o.info(function(){return"TIMEOUT: "+l})}on.prototype.info=function(){};function cu(o,l){if(!o.g)return l;if(!l)return null;try{var d=JSON.parse(l);if(d){for(o=0;o<d.length;o++)if(Array.isArray(d[o])){var p=d[o];if(!(2>p.length)){var C=p[1];if(Array.isArray(C)&&!(1>C.length)){var V=C[0];if(V!="noop"&&V!="stop"&&V!="close")for(var O=1;O<C.length;O++)C[O]=""}}}}return lr(d)}catch{return l}}var Zn={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},fs={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},hr;function Yn(){}k(Yn,cr),Yn.prototype.g=function(){return new XMLHttpRequest},Yn.prototype.i=function(){return{}},hr=new Yn;function Yt(o,l,d,p){this.j=o,this.i=l,this.l=d,this.R=p||1,this.U=new tn(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new ms}function ms(){this.i=null,this.g="",this.h=!1}var gs={},pr={};function fr(o,l,d){o.L=1,o.v=ii($t(l)),o.m=d,o.P=!0,ys(o,null)}function ys(o,l){o.F=Date.now(),ti(o),o.A=$t(o.v);var d=o.A,p=o.R;Array.isArray(p)||(p=[String(p)]),Vs(d.i,"t",p),o.C=0,d=o.j.J,o.h=new ms,o.g=Ks(o.j,d?l:null,!o.m),0<o.O&&(o.M=new iu(v(o.Y,o,o.g),o.O)),l=o.U,d=o.g,p=o.ca;var C="readystatechange";Array.isArray(C)||(C&&(ss[0]=C.toString()),C=ss);for(var V=0;V<C.length;V++){var O=ts(d,C[V],p||l.handleEvent,!1,l.h||l);if(!O)break;l.g[O.key]=O}l=o.H?m(o.H):{},o.m?(o.u||(o.u="POST"),l["Content-Type"]="application/x-www-form-urlencoded",o.g.ea(o.A,o.u,o.m,l)):(o.u="GET",o.g.ea(o.A,o.u,null,l)),nn(),su(o.i,o.u,o.A,o.l,o.R,o.m)}Yt.prototype.ca=function(o){o=o.target;const l=this.M;l&&Wt(o)==3?l.j():this.Y(o)},Yt.prototype.Y=function(o){try{if(o==this.g)t:{const gt=Wt(this.g);var l=this.g.Ba();const Se=this.g.Z();if(!(3>gt)&&(gt!=3||this.g&&(this.h.h||this.g.oa()||Os(this.g)))){this.J||gt!=4||l==7||(l==8||0>=Se?nn(3):nn(2)),mr(this);var d=this.g.Z();this.X=d;e:if(vs(this)){var p=Os(this.g);o="";var C=p.length,V=Wt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){he(this),sn(this);var O="";break e}this.h.i=new c.TextDecoder}for(l=0;l<C;l++)this.h.h=!0,o+=this.h.i.decode(p[l],{stream:!(V&&l==C-1)});p.length=0,this.h.g+=o,this.C=0,O=this.h.g}else O=this.g.oa();if(this.o=d==200,au(this.i,this.u,this.A,this.l,this.R,gt,d),this.o){if(this.T&&!this.K){e:{if(this.g){var Z,ct=this.g;if((Z=ct.g?ct.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!P(Z)){var G=Z;break e}}G=null}if(d=G)Re(this.i,this.l,d,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,gr(this,d);else{this.o=!1,this.s=3,wt(12),he(this),sn(this);break t}}if(this.P){d=!0;let Lt;for(;!this.J&&this.C<O.length;)if(Lt=uu(this,O),Lt==pr){gt==4&&(this.s=4,wt(14),d=!1),Re(this.i,this.l,null,"[Incomplete Response]");break}else if(Lt==gs){this.s=4,wt(15),Re(this.i,this.l,O,"[Invalid Chunk]"),d=!1;break}else Re(this.i,this.l,Lt,null),gr(this,Lt);if(vs(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),gt!=4||O.length!=0||this.h.h||(this.s=1,wt(16),d=!1),this.o=this.o&&d,!d)Re(this.i,this.l,O,"[Invalid Chunked Response]"),he(this),sn(this);else if(0<O.length&&!this.W){this.W=!0;var mt=this.j;mt.g==this&&mt.ba&&!mt.M&&(mt.j.info("Great, no buffering proxy detected. Bytes received: "+O.length),wr(mt),mt.M=!0,wt(11))}}else Re(this.i,this.l,O,null),gr(this,O);gt==4&&he(this),this.o&&!this.J&&(gt==4?$s(this.j,this):(this.o=!1,ti(this)))}else Ru(this.g),d==400&&0<O.indexOf("Unknown SID")?(this.s=3,wt(12)):(this.s=0,wt(13)),he(this),sn(this)}}}catch{}finally{}};function vs(o){return o.g?o.u=="GET"&&o.L!=2&&o.j.Ca:!1}function uu(o,l){var d=o.C,p=l.indexOf(`
`,d);return p==-1?pr:(d=Number(l.substring(d,p)),isNaN(d)?gs:(p+=1,p+d>l.length?pr:(l=l.slice(p,p+d),o.C=p+d,l)))}Yt.prototype.cancel=function(){this.J=!0,he(this)};function ti(o){o.S=Date.now()+o.I,As(o,o.I)}function As(o,l){if(o.B!=null)throw Error("WatchDog timer not null");o.B=rn(v(o.ba,o),l)}function mr(o){o.B&&(c.clearTimeout(o.B),o.B=null)}Yt.prototype.ba=function(){this.B=null;const o=Date.now();0<=o-this.S?(lu(this.i,this.A),this.L!=2&&(nn(),wt(17)),he(this),this.s=2,sn(this)):As(this,this.S-o)};function sn(o){o.j.G==0||o.J||$s(o.j,o)}function he(o){mr(o);var l=o.M;l&&typeof l.ma=="function"&&l.ma(),o.M=null,as(o.U),o.g&&(l=o.g,o.g=null,l.abort(),l.ma())}function gr(o,l){try{var d=o.j;if(d.G!=0&&(d.g==o||yr(d.h,o))){if(!o.K&&yr(d.h,o)&&d.G==3){try{var p=d.Da.g.parse(l)}catch{p=null}if(Array.isArray(p)&&p.length==3){var C=p;if(C[0]==0){t:if(!d.u){if(d.g)if(d.g.F+3e3<o.F)ci(d),ai(d);else break t;_r(d),wt(18)}}else d.za=C[1],0<d.za-d.T&&37500>C[2]&&d.F&&d.v==0&&!d.C&&(d.C=rn(v(d.Za,d),6e3));if(1>=ws(d.h)&&d.ca){try{d.ca()}catch{}d.ca=void 0}}else fe(d,11)}else if((o.K||d.g==o)&&ci(d),!P(l))for(C=d.Da.g.parse(l),l=0;l<C.length;l++){let G=C[l];if(d.T=G[0],G=G[1],d.G==2)if(G[0]=="c"){d.K=G[1],d.ia=G[2];const mt=G[3];mt!=null&&(d.la=mt,d.j.info("VER="+d.la));const gt=G[4];gt!=null&&(d.Aa=gt,d.j.info("SVER="+d.Aa));const Se=G[5];Se!=null&&typeof Se=="number"&&0<Se&&(p=1.5*Se,d.L=p,d.j.info("backChannelRequestTimeoutMs_="+p)),p=d;const Lt=o.g;if(Lt){const di=Lt.g?Lt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(di){var V=p.h;V.g||di.indexOf("spdy")==-1&&di.indexOf("quic")==-1&&di.indexOf("h2")==-1||(V.j=V.l,V.g=new Set,V.h&&(vr(V,V.h),V.h=null))}if(p.D){const Er=Lt.g?Lt.g.getResponseHeader("X-HTTP-Session-Id"):null;Er&&(p.ya=Er,Y(p.I,p.D,Er))}}d.G=3,d.l&&d.l.ua(),d.ba&&(d.R=Date.now()-o.F,d.j.info("Handshake RTT: "+d.R+"ms")),p=d;var O=o;if(p.qa=Gs(p,p.J?p.ia:null,p.W),O.K){Es(p.h,O);var Z=O,ct=p.L;ct&&(Z.I=ct),Z.B&&(mr(Z),ti(Z)),p.g=O}else Hs(p);0<d.i.length&&li(d)}else G[0]!="stop"&&G[0]!="close"||fe(d,7);else d.G==3&&(G[0]=="stop"||G[0]=="close"?G[0]=="stop"?fe(d,7):br(d):G[0]!="noop"&&d.l&&d.l.ta(G),d.v=0)}}nn(4)}catch{}}var du=class{constructor(o,l){this.g=o,this.map=l}};function bs(o){this.l=o||10,c.PerformanceNavigationTiming?(o=c.performance.getEntriesByType("navigation"),o=0<o.length&&(o[0].nextHopProtocol=="hq"||o[0].nextHopProtocol=="h2")):o=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=o?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function _s(o){return o.h?!0:o.g?o.g.size>=o.j:!1}function ws(o){return o.h?1:o.g?o.g.size:0}function yr(o,l){return o.h?o.h==l:o.g?o.g.has(l):!1}function vr(o,l){o.g?o.g.add(l):o.h=l}function Es(o,l){o.h&&o.h==l?o.h=null:o.g&&o.g.has(l)&&o.g.delete(l)}bs.prototype.cancel=function(){if(this.i=Is(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const o of this.g.values())o.cancel();this.g.clear()}};function Is(o){if(o.h!=null)return o.i.concat(o.h.D);if(o.g!=null&&o.g.size!==0){let l=o.i;for(const d of o.g.values())l=l.concat(d.D);return l}return T(o.i)}function hu(o){if(o.V&&typeof o.V=="function")return o.V();if(typeof Map<"u"&&o instanceof Map||typeof Set<"u"&&o instanceof Set)return Array.from(o.values());if(typeof o=="string")return o.split("");if(u(o)){for(var l=[],d=o.length,p=0;p<d;p++)l.push(o[p]);return l}l=[],d=0;for(p in o)l[d++]=o[p];return l}function pu(o){if(o.na&&typeof o.na=="function")return o.na();if(!o.V||typeof o.V!="function"){if(typeof Map<"u"&&o instanceof Map)return Array.from(o.keys());if(!(typeof Set<"u"&&o instanceof Set)){if(u(o)||typeof o=="string"){var l=[];o=o.length;for(var d=0;d<o;d++)l.push(d);return l}l=[],d=0;for(const p in o)l[d++]=p;return l}}}function xs(o,l){if(o.forEach&&typeof o.forEach=="function")o.forEach(l,void 0);else if(u(o)||typeof o=="string")Array.prototype.forEach.call(o,l,void 0);else for(var d=pu(o),p=hu(o),C=p.length,V=0;V<C;V++)l.call(void 0,p[V],d&&d[V],o)}var Ts=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function fu(o,l){if(o){o=o.split("&");for(var d=0;d<o.length;d++){var p=o[d].indexOf("="),C=null;if(0<=p){var V=o[d].substring(0,p);C=o[d].substring(p+1)}else V=o[d];l(V,C?decodeURIComponent(C.replace(/\+/g," ")):"")}}}function pe(o){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,o instanceof pe){this.h=o.h,ei(this,o.j),this.o=o.o,this.g=o.g,ni(this,o.s),this.l=o.l;var l=o.i,d=new cn;d.i=l.i,l.g&&(d.g=new Map(l.g),d.h=l.h),Rs(this,d),this.m=o.m}else o&&(l=String(o).match(Ts))?(this.h=!1,ei(this,l[1]||"",!0),this.o=an(l[2]||""),this.g=an(l[3]||"",!0),ni(this,l[4]),this.l=an(l[5]||"",!0),Rs(this,l[6]||"",!0),this.m=an(l[7]||"")):(this.h=!1,this.i=new cn(null,this.h))}pe.prototype.toString=function(){var o=[],l=this.j;l&&o.push(ln(l,Cs,!0),":");var d=this.g;return(d||l=="file")&&(o.push("//"),(l=this.o)&&o.push(ln(l,Cs,!0),"@"),o.push(encodeURIComponent(String(d)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.s,d!=null&&o.push(":",String(d))),(d=this.l)&&(this.g&&d.charAt(0)!="/"&&o.push("/"),o.push(ln(d,d.charAt(0)=="/"?yu:gu,!0))),(d=this.i.toString())&&o.push("?",d),(d=this.m)&&o.push("#",ln(d,Au)),o.join("")};function $t(o){return new pe(o)}function ei(o,l,d){o.j=d?an(l,!0):l,o.j&&(o.j=o.j.replace(/:$/,""))}function ni(o,l){if(l){if(l=Number(l),isNaN(l)||0>l)throw Error("Bad port number "+l);o.s=l}else o.s=null}function Rs(o,l,d){l instanceof cn?(o.i=l,bu(o.i,o.h)):(d||(l=ln(l,vu)),o.i=new cn(l,o.h))}function Y(o,l,d){o.i.set(l,d)}function ii(o){return Y(o,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),o}function an(o,l){return o?l?decodeURI(o.replace(/%25/g,"%2525")):decodeURIComponent(o):""}function ln(o,l,d){return typeof o=="string"?(o=encodeURI(o).replace(l,mu),d&&(o=o.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),o):null}function mu(o){return o=o.charCodeAt(0),"%"+(o>>4&15).toString(16)+(o&15).toString(16)}var Cs=/[#\/\?@]/g,gu=/[#\?:]/g,yu=/[#\?]/g,vu=/[#\?@]/g,Au=/#/g;function cn(o,l){this.h=this.g=null,this.i=o||null,this.j=!!l}function te(o){o.g||(o.g=new Map,o.h=0,o.i&&fu(o.i,function(l,d){o.add(decodeURIComponent(l.replace(/\+/g," ")),d)}))}n=cn.prototype,n.add=function(o,l){te(this),this.i=null,o=Ce(this,o);var d=this.g.get(o);return d||this.g.set(o,d=[]),d.push(l),this.h+=1,this};function Ps(o,l){te(o),l=Ce(o,l),o.g.has(l)&&(o.i=null,o.h-=o.g.get(l).length,o.g.delete(l))}function Ss(o,l){return te(o),l=Ce(o,l),o.g.has(l)}n.forEach=function(o,l){te(this),this.g.forEach(function(d,p){d.forEach(function(C){o.call(l,C,p,this)},this)},this)},n.na=function(){te(this);const o=Array.from(this.g.values()),l=Array.from(this.g.keys()),d=[];for(let p=0;p<l.length;p++){const C=o[p];for(let V=0;V<C.length;V++)d.push(l[p])}return d},n.V=function(o){te(this);let l=[];if(typeof o=="string")Ss(this,o)&&(l=l.concat(this.g.get(Ce(this,o))));else{o=Array.from(this.g.values());for(let d=0;d<o.length;d++)l=l.concat(o[d])}return l},n.set=function(o,l){return te(this),this.i=null,o=Ce(this,o),Ss(this,o)&&(this.h-=this.g.get(o).length),this.g.set(o,[l]),this.h+=1,this},n.get=function(o,l){return o?(o=this.V(o),0<o.length?String(o[0]):l):l};function Vs(o,l,d){Ps(o,l),0<d.length&&(o.i=null,o.g.set(Ce(o,l),T(d)),o.h+=d.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const o=[],l=Array.from(this.g.keys());for(var d=0;d<l.length;d++){var p=l[d];const V=encodeURIComponent(String(p)),O=this.V(p);for(p=0;p<O.length;p++){var C=V;O[p]!==""&&(C+="="+encodeURIComponent(String(O[p]))),o.push(C)}}return this.i=o.join("&")};function Ce(o,l){return l=String(l),o.j&&(l=l.toLowerCase()),l}function bu(o,l){l&&!o.j&&(te(o),o.i=null,o.g.forEach(function(d,p){var C=p.toLowerCase();p!=C&&(Ps(this,p),Vs(this,C,d))},o)),o.j=l}function _u(o,l){const d=new on;if(c.Image){const p=new Image;p.onload=I(ee,d,"TestLoadImage: loaded",!0,l,p),p.onerror=I(ee,d,"TestLoadImage: error",!1,l,p),p.onabort=I(ee,d,"TestLoadImage: abort",!1,l,p),p.ontimeout=I(ee,d,"TestLoadImage: timeout",!1,l,p),c.setTimeout(function(){p.ontimeout&&p.ontimeout()},1e4),p.src=o}else l(!1)}function wu(o,l){const d=new on,p=new AbortController,C=setTimeout(()=>{p.abort(),ee(d,"TestPingServer: timeout",!1,l)},1e4);fetch(o,{signal:p.signal}).then(V=>{clearTimeout(C),V.ok?ee(d,"TestPingServer: ok",!0,l):ee(d,"TestPingServer: server error",!1,l)}).catch(()=>{clearTimeout(C),ee(d,"TestPingServer: error",!1,l)})}function ee(o,l,d,p,C){try{C&&(C.onload=null,C.onerror=null,C.onabort=null,C.ontimeout=null),p(d)}catch{}}function Eu(){this.g=new ou}function Iu(o,l,d){const p=d||"";try{xs(o,function(C,V){let O=C;h(C)&&(O=lr(C)),l.push(p+V+"="+encodeURIComponent(O))})}catch(C){throw l.push(p+"type="+encodeURIComponent("_badmap")),C}}function ri(o){this.l=o.Ub||null,this.j=o.eb||!1}k(ri,cr),ri.prototype.g=function(){return new oi(this.l,this.j)},ri.prototype.i=function(o){return function(){return o}}({});function oi(o,l){ft.call(this),this.D=o,this.o=l,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}k(oi,ft),n=oi.prototype,n.open=function(o,l){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=o,this.A=l,this.readyState=1,dn(this)},n.send=function(o){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const l={headers:this.u,method:this.B,credentials:this.m,cache:void 0};o&&(l.body=o),(this.D||c).fetch(new Request(this.A,l)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,un(this)),this.readyState=0},n.Sa=function(o){if(this.g&&(this.l=o,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=o.headers,this.readyState=2,dn(this)),this.g&&(this.readyState=3,dn(this),this.g)))if(this.responseType==="arraybuffer")o.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in o){if(this.j=o.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Ds(this)}else o.text().then(this.Ra.bind(this),this.ga.bind(this))};function Ds(o){o.j.read().then(o.Pa.bind(o)).catch(o.ga.bind(o))}n.Pa=function(o){if(this.g){if(this.o&&o.value)this.response.push(o.value);else if(!this.o){var l=o.value?o.value:new Uint8Array(0);(l=this.v.decode(l,{stream:!o.done}))&&(this.response=this.responseText+=l)}o.done?un(this):dn(this),this.readyState==3&&Ds(this)}},n.Ra=function(o){this.g&&(this.response=this.responseText=o,un(this))},n.Qa=function(o){this.g&&(this.response=o,un(this))},n.ga=function(){this.g&&un(this)};function un(o){o.readyState=4,o.l=null,o.j=null,o.v=null,dn(o)}n.setRequestHeader=function(o,l){this.u.append(o,l)},n.getResponseHeader=function(o){return this.h&&this.h.get(o.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const o=[],l=this.h.entries();for(var d=l.next();!d.done;)d=d.value,o.push(d[0]+": "+d[1]),d=l.next();return o.join(`\r
...
`}),l}function Ar(o,l,d){t:{for(p in d){var p=!1;break t}p=!0}p||(d=ks(d),typeof o=="string"?d!=null&&encodeURIComponent(String(d)):Y(o,l,d))}function it(o){ft.call(this),this.headers=new Map,this.o=o||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}k(it,ft);var xu=/^https?$/i,Tu=["POST","PUT"];n=it.prototype,n.Ha=function(o){this.J=o},n.ea=function(o,l,d,p){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+o);l=l?l.toUpperCase():"GET",this.D=o,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():hr.g(),this.v=this.o?ls(this.o):ls(hr),this.g.onreadystatechange=v(this.Ea,this);try{this.B=!0,this.g.open(l,String(o),!0),this.B=!1}catch(V){Ns(this,V);return}if(o=d||"",d=new Map(this.headers),p)if(Object.getPrototypeOf(p)===Object.prototype)for(var C in p)d.set(C,p[C]);else if(typeof p.keys=="function"&&typeof p.get=="function")for(const V of p.keys())d.set(V,p.get(V));else throw Error("Unknown input type for opt_headers: "+String(p));p=Array.from(d.keys()).find(V=>V.toLowerCase()=="content-type"),C=c.FormData&&o instanceof c.FormData,!(0<=Array.prototype.indexOf.call(Tu,l,void 0))||p||C||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[V,O]of d)this.g.setRequestHeader(V,O);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Ms(this),this.u=!0,this.g.send(o),this.u=!1}catch(V){Ns(this,V)}};function Ns(o,l){o.h=!1,o.g&&(o.j=!0,o.g.abort(),o.j=!1),o.l=l,o.m=5,Bs(o),si(o)}function Bs(o){o.A||(o.A=!0,_t(o,"complete"),_t(o,"error"))}n.abort=function(o){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=o||7,_t(this,"complete"),_t(this,"abort"),si(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),si(this,!0)),it.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?Ls(this):this.bb())},n.bb=function(){Ls(this)};function Ls(o){if(o.h&&typeof a<"u"&&(!o.v[1]||Wt(o)!=4||o.Z()!=2)){if(o.u&&Wt(o)==4)rs(o.Ea,0,o);else if(_t(o,"readystatechange"),Wt(o)==4){o.h=!1;try{const O=o.Z();t:switch(O){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var l=!0;break t;default:l=!1}var d;if(!(d=l)){var p;if(p=O===0){var C=String(o.D).match(Ts)[1]||null;!C&&c.self&&c.self.location&&(C=c.self.location.protocol.slice(0,-1)),p=!xu.test(C?C.toLowerCase():"")}d=p}if(d)_t(o,"complete"),_t(o,"success");else{o.m=6;try{var V=2<Wt(o)?o.g.statusText:""}catch{V=""}o.l=V+" ["+o.Z()+"]",Bs(o)}}finally{si(o)}}}}function si(o,l){if(o.g){Ms(o);const d=o.g,p=o.v[0]?()=>{}:null;o.g=null,o.v=null,l||_t(o,"ready");try{d.onreadystatechange=p}catch{}}}function Ms(o){o.I&&(c.clearTimeout(o.I),o.I=null)}n.isActive=function(){return!!this.g};function Wt(o){return o.g?o.g.readyState:0}n.Z=function(){try{return 2<Wt(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(o){if(this.g){var l=this.g.responseText;return o&&l.indexOf(o)==0&&(l=l.substring(o.length)),ru(l)}};function Os(o){try{if(!o.g)return null;if("response"in o.g)return o.g.response;switch(o.H){case"":case"text":return o.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in o.g)return o.g.mozResponseArrayBuffer}return null}catch{return null}}function Ru(o){const l={};o=(o.g&&2<=Wt(o)&&o.g.getAllResponseHeaders()||"").split(`\r
`);for(let p=0;p<o.length;p++){if(P(o[p]))continue;var d=E(o[p]);const C=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const V=l[C]||[];l[C]=V,V.push(d)}_(l,function(p){return p.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function hn(o,l,d){return d&&d.internalChannelParams&&d.internalChannelParams[o]||l}function Fs(o){this.Aa=0,this.i=[],this.j=new on,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=hn("failFast",!1,o),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=hn("baseRetryDelayMs",5e3,o),this.cb=hn("retryDelaySeedMs",1e4,o),this.Wa=hn("forwardChannelMaxRetries",2,o),this.wa=hn("forwardChannelRequestTimeoutMs",2e4,o),this.pa=o&&o.xmlHttpFactory||void 0,this.Xa=o&&o.Tb||void 0,this.Ca=o&&o.useFetchStreams||!1,this.L=void 0,this.J=o&&o.supportsCrossDomainXhr||!1,this.K="",this.h=new bs(o&&o.concurrentRequestLimit),this.Da=new Eu,this.P=o&&o.fastHandshake||!1,this.O=o&&o.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=o&&o.Rb||!1,o&&o.xa&&this.j.xa(),o&&o.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&o&&o.detectBufferingProxy||!1,this.ja=void 0,o&&o.longPollingTimeout&&0<o.longPollingTimeout&&(this.ja=o.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=Fs.prototype,n.la=8,n.G=1,n.connect=function(o,l,d,p){wt(0),this.W=o,this.H=l||{},d&&p!==void 0&&(this.H.OSID=d,this.H.OAID=p),this.F=this.X,this.I=Gs(this,null,this.W),li(this)};function br(o){if(zs(o),o.G==3){var l=o.U++,d=$t(o.I);if(Y(d,"SID",o.K),Y(d,"RID",l),Y(d,"TYPE","terminate"),pn(o,d),l=new Yt(o,o.j,l),l.L=2,l.v=ii($t(d)),d=!1,c.navigator&&c.navigator.sendBeacon)try{d=c.navigator.sendBeacon(l.v.toString(),"")}catch{}!d&&c.Image&&(new Image().src=l.v,d=!0),d||(l.g=Ks(l.j,null),l.g.ea(l.v)),l.F=Date.now(),ti(l)}Qs(o)}function ai(o){o.g&&(wr(o),o.g.cancel(),o.g=null)}function zs(o){ai(o),o.u&&(c.clearTimeout(o.u),o.u=null),ci(o),o.h.cancel(),o.s&&(typeof o.s=="number"&&c.clearTimeout(o.s),o.s=null)}function li(o){if(!_s(o.h)&&!o.s){o.s=!0;var l=o.Ga;Ut||Qn(),Jt||(Ut(),Jt=!0),Ze.add(l,o),o.B=0}}function Cu(o,l){return ws(o.h)>=o.h.j-(o.s?1:0)?!1:o.s?(o.i=l.D.concat(o.i),!0):o.G==1||o.G==2||o.B>=(o.Va?0:o.Wa)?!1:(o.s=rn(v(o.Ga,o,l),Ws(o,o.B)),o.B++,!0)}n.Ga=function(o){if(this.s)if(this.s=null,this.G==1){if(!o){this.U=Math.floor(1e5*Math.random()),o=this.U++;const C=new Yt(this,this.j,o);let V=this.o;if(this.S&&(V?(V=m(V),w(V,this.S)):V=this.S),this.m!==null||this.O||(C.H=V,V=null),this.P)t:{for(var l=0,d=0;d<this.i.length;d++){e:{var p=this.i[d];if("__data__"in p.map&&(p=p.map.__data__,typeof p=="string")){p=p.length;break e}p=void 0}if(p===void 0)break;if(l+=p,4096<l){l=d;break t}if(l===4096||d===this.i.length-1){l=d+1;break t}}l=1e3}else l=1e3;l=qs(this,C,l),d=$t(this.I),Y(d,"RID",o),Y(d,"CVER",22),this.D&&Y(d,"X-HTTP-Session-Id",this.D),pn(this,d),V&&(this.O?l="headers="+encodeURIComponent(String(ks(V)))+"&"+l:this.m&&Ar(d,this.m,V)),vr(this.h,C),this.Ua&&Y(d,"TYPE","init"),this.P?(Y(d,"$req",l),Y(d,"SID","null"),C.T=!0,fr(C,d,null)):fr(C,d,l),this.G=2}}else this.G==3&&(o?js(this,o):this.i.length==0||_s(this.h)||js(this))};function js(o,l){var d;l?d=l.l:d=o.U++;const p=$t(o.I);Y(p,"SID",o.K),Y(p,"RID",d),Y(p,"AID",o.T),pn(o,p),o.m&&o.o&&Ar(p,o.m,o.o),d=new Yt(o,o.j,d,o.B+1),o.m===null&&(d.H=o.o),l&&(o.i=l.D.concat(o.i)),l=qs(o,d,1e3),d.I=Math.round(.5*o.wa)+Math.round(.5*o.wa*Math.random()),vr(o.h,d),fr(d,p,l)}function pn(o,l){o.H&&D(o.H,function(d,p){Y(l,p,d)}),o.l&&xs({},function(d,p){Y(l,p,d)})}function qs(o,l,d){d=Math.min(o.i.length,d);var p=o.l?v(o.l.Na,o.l,o):null;t:{var C=o.i;let V=-1;for(;;){const O=["count="+d];V==-1?0<d?(V=C[0].g,O.push("ofs="+V)):V=0:O.push("ofs="+V);let Z=!0;for(let ct=0;ct<d;ct++){let G=C[ct].g;const mt=C[ct].map;if(G-=V,0>G)V=Math.max(0,C[ct].g-100),Z=!1;else try{Iu(mt,O,"req"+G+"_")}catch{p&&p(mt)}}if(Z){p=O.join("&");break t}}}return o=o.i.splice(0,d),l.D=o,p}function Hs(o){if(!o.g&&!o.u){o.Y=1;var l=o.Fa;Ut||Qn(),Jt||(Ut(),Jt=!0),Ze.add(l,o),o.v=0}}function _r(o){return o.g||o.u||3<=o.v?!1:(o.Y++,o.u=rn(v(o.Fa,o),Ws(o,o.v)),o.v++,!0)}n.Fa=function(){if(this.u=null,Us(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var o=2*this.R;this.j.info("BP detection timer enabled: "+o),this.A=rn(v(this.ab,this),o)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,wt(10),ai(this),Us(this))};function wr(o){o.A!=null&&(c.clearTimeout(o.A),o.A=null)}function Us(o){o.g=new Yt(o,o.j,"rpc",o.Y),o.m===null&&(o.g.H=o.o),o.g.O=0;var l=$t(o.qa);Y(l,"RID","rpc"),Y(l,"SID",o.K),Y(l,"AID",o.T),Y(l,"CI",o.F?"0":"1"),!o.F&&o.ja&&Y(l,"TO",o.ja),Y(l,"TYPE","xmlhttp"),pn(o,l),o.m&&o.o&&Ar(l,o.m,o.o),o.L&&(o.g.I=o.L);var d=o.g;o=o.ia,d.L=1,d.v=ii($t(l)),d.m=null,d.P=!0,ys(d,o)}n.Za=function(){this.C!=null&&(this.C=null,ai(this),_r(this),wt(19))};function ci(o){o.C!=null&&(c.clearTimeout(o.C),o.C=null)}function $s(o,l){var d=null;if(o.g==l){ci(o),wr(o),o.g=null;var p=2}else if(yr(o.h,l))d=l.D,Es(o.h,l),p=1;else return;if(o.G!=0){if(l.o)if(p==1){d=l.m?l.m.length:0,l=Date.now()-l.F;var C=o.B;p=Jn(),_t(p,new ps(p,d)),li(o)}else Hs(o);else if(C=l.s,C==3||C==0&&0<l.X||!(p==1&&Cu(o,l)||p==2&&_r(o)))switch(d&&0<d.length&&(l=o.h,l.i=l.i.concat(d)),C){case 1:fe(o,5);break;case 4:fe(o,10);break;case 3:fe(o,6);break;default:fe(o,2)}}}function Ws(o,l){let d=o.Ta+Math.floor(Math.random()*o.cb);return o.isActive()||(d*=2),d*l}function fe(o,l){if(o.j.info("Error code "+l),l==2){var d=v(o.fb,o),p=o.Xa;const C=!p;p=new pe(p||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||ei(p,"https"),ii(p),C?_u(p.toString(),d):wu(p.toString(),d)}else wt(2);o.G=0,o.l&&o.l.sa(l),Qs(o),zs(o)}n.fb=function(o){o?(this.j.info("Successfully pinged google.com"),wt(2)):(this.j.info("Failed to ping google.com"),wt(1))};function Qs(o){if(o.G=0,o.ka=[],o.l){const l=Is(o.h);(l.length!=0||o.i.length!=0)&&(g(o.ka,l),g(o.ka,o.i),o.h.i.length=0,T(o.i),o.i.length=0),o.l.ra()}}function Gs(o,l,d){var p=d instanceof pe?$t(d):new pe(d);if(p.g!="")l&&(p.g=l+"."+p.g),ni(p,p.s);else{var C=c.location;p=C.protocol,l=l?l+"."+C.hostname:C.hostname,C=+C.port;var V=new pe(null);p&&ei(V,p),l&&(V.g=l),C&&ni(V,C),d&&(V.l=d),p=V}return d=o.D,l=o.ya,d&&l&&Y(p,d,l),Y(p,"VER",o.la),pn(o,p),p}function Ks(o,l,d){if(l&&!o.J)throw Error("Can't create secondary domain capable XhrIo object.");return l=o.Ca&&!o.pa?new it(new ri({eb:d})):new it(o.pa),l.Ha(o.J),l}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function Xs(){}n=Xs.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function ui(){}ui.prototype.g=function(o,l){return new Ct(o,l)};function Ct(o,l){ft.call(this),this.g=new Fs(l),this.l=o,this.h=l&&l.messageUrlParams||null,o=l&&l.messageHeaders||null,l&&l.clientProtocolHeaderRequired&&(o?o["X-Client-Protocol"]="webchannel":o={"X-Client-Protocol":"webchannel"}),this.g.o=o,o=l&&l.initMessageHeaders||null,l&&l.messageContentType&&(o?o["X-WebChannel-Content-Type"]=l.messageContentType:o={"X-WebChannel-Content-Type":l.messageContentType}),l&&l.va&&(o?o["X-WebChannel-Client-Profile"]=l.va:o={"X-WebChannel-Client-Profile":l.va}),this.g.S=o,(o=l&&l.Sb)&&!P(o)&&(this.g.m=o),this.v=l&&l.supportsCrossDomainXhr||!1,this.u=l&&l.sendRawJson||!1,(l=l&&l.httpSessionIdParam)&&!P(l)&&(this.g.D=l,o=this.h,o!==null&&l in o&&(o=this.h,l in o&&delete o[l])),this.j=new Pe(this)}k(Ct,ft),Ct.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Ct.prototype.close=function(){br(this.g)},Ct.prototype.o=function(o){var l=this.g;if(typeof o=="string"){var d={};d.__data__=o,o=d}else this.u&&(d={},d.__data__=lr(o),o=d);l.i.push(new du(l.Ya++,o)),l.G==3&&li(l)},Ct.prototype.N=function(){this.g.l=null,delete this.j,br(this.g),delete this.g,Ct.aa.N.call(this)};function Js(o){ur.call(this),o.__headers__&&(this.headers=o.__headers__,this.statusCode=o.__status__,delete o.__headers__,delete o.__status__);var l=o.__sm__;if(l){t:{for(const d in l){o=d;break t}o=void 0}(this.i=o)&&(o=this.i,l=l!==null&&o in l?l[o]:void 0),this.data=l}else this.data=o}k(Js,ur);function Zs(){dr.call(this),this.status=1}k(Zs,dr);function Pe(o){this.g=o}k(Pe,Xs),Pe.prototype.ua=function(){_t(this.g,"a")},Pe.prototype.ta=function(o){_t(this.g,new Js(o))},Pe.prototype.sa=function(o){_t(this.g,new Zs)},Pe.prototype.ra=function(){_t(this.g,"b")},ui.prototype.createWebChannel=ui.prototype.g,Ct.prototype.send=Ct.prototype.o,Ct.prototype.open=Ct.prototype.m,Ct.prototype.close=Ct.prototype.close,vl=function(){return new ui},yl=function(){return Jn()},gl=de,qr={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Zn.NO_ERROR=0,Zn.TIMEOUT=8,Zn.HTTP_ERROR=6,yi=Zn,fs.COMPLETE="complete",ml=fs,cs.EventType=en,en.OPEN="a",en.CLOSE="b",en.ERROR="c",en.MESSAGE="d",ft.prototype.listen=ft.prototype.K,mn=cs,it.prototype.listenOnce=it.prototype.L,it.prototype.getLastError=it.prototype.Ka,it.prototype.getLastErrorCode=it.prototype.Ba,it.prototype.getStatus=it.prototype.Z,it.prototype.getResponseJson=it.prototype.Oa,it.prototype.getResponseText=it.prototype.oa,it.prototype.send=it.prototype.ea,it.prototype.setWithCredentials=it.prototype.Ha,fl=it}).apply(typeof hi<"u"?hi:typeof self<"u"?self:typeof window<"u"?window:{});const ua="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const be=new al("@firebase/firestore");function fn(){return be.logLevel}function z(n,...t){if(be.logLevel<=Q.DEBUG){const e=t.map(lo);be.debug(`Firestore (${We}): ${n}`,...e)}}function Kt(n,...t){if(be.logLevel<=Q.ERROR){const e=t.map(lo);be.error(`Firestore (${We}): ${n}`,...e)}}function Oe(n,...t){if(be.logLevel<=Q.WARN){const e=t.map(lo);be.warn(`Firestore (${We}): ${n}`,...e)}}function lo(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function q(n="Unexpected state"){const t=`FIRESTORE (${We}) INTERNAL ASSERTION FAILED: `+n;throw Kt(t),new Error(t)}function X(n,t){n||q()}function U(n,t){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const N={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class F extends $e{constructor(t,e){super(t,e),this.code=t,this.message=e,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bl{static newId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",e=Math.floor(256/t.length)*t.length;let i="";for(;i.length<20;){const r=fh(40);for(let s=0;s<r.length;++s)i.length<20&&r[s]<e&&(i+=t.charAt(r[s]%t.length))}return i}}function K(n,t){return n<t?-1:n>t?1:0}function Fe(n,t,e){return n.length===t.length&&n.every((i,r)=>e(i,t[r]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ah="The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";class bh{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(t){this.onCommittedListeners.push(t)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach(t=>t())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Nn(n){if(n.code!==N.FAILED_PRECONDITION||n.message!==Ah)throw n;z("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class L{constructor(t){this.nextCallback=null,this.catchCallback=null,this.result=void 0,this.error=void 0,this.isDone=!1,this.callbackAttached=!1,t(e=>{this.isDone=!0,this.result=e,this.nextCallback&&this.nextCallback(e)},e=>{this.isDone=!0,this.error=e,this.catchCallback&&this.catchCallback(e)})}catch(t){return this.next(void 0,t)}next(t,e){return this.callbackAttached&&q(),this.callbackAttached=!0,this.isDone?this.error?this.wrapFailure(e,this.error):this.wrapSuccess(t,this.result):new L((i,r)=>{this.nextCallback=s=>{this.wrapSuccess(t,s).next(i,r)},this.catchCallback=s=>{this.wrapFailure(e,s).next(i,r)}})}toPromise(){return new Promise((t,e)=>{this.next(t,e)})}wrapUserFunction(t){try{const e=t();return e instanceof L?e:L.resolve(e)}catch(e){return L.reject(e)}}wrapSuccess(t,e){return t?this.wrapUserFunction(()=>t(e)):L.resolve(e)}wrapFailure(t,e){return t?this.wrapUserFunction(()=>t(e)):L.reject(e)}static resolve(t){return new L((e,i)=>{e(t)})}static reject(t){return new L((e,i)=>{i(t)})}static waitFor(t){return new L((e,i)=>{let r=0,s=0,a=!1;t.forEach(c=>{++r,c.next(()=>{++s,a&&s===r&&e()},u=>i(u))}),a=!0,s===r&&e()})}static or(t){let e=L.resolve(!1);for(const i of t)e=e.next(r=>r?L.resolve(r):i());return e}static forEach(t,e){const i=[];return t.forEach((r,s)=>{i.push(e.call(this,r,s))}),this.waitFor(i)}static mapArray(t,e){return new L((i,r)=>{const s=t.length,a=new Array(s);let c=0;for(let u=0;u<s;u++){const h=u;e(t[h]).next(f=>{a[h]=f,++c,c===s&&i(a)},f=>r(f))}})}static doWhile(t,e){return new L((i,r)=>{const s=()=>{t()===!0?e().next(()=>{s()},r):i()};s()})}}function _h(n){const t=n.match(/Android ([\d.]+)/i),e=t?t[1].split(".").slice(0,2).join("."):"-1";return Number(e)}function Bn(n){return n.name==="IndexedDbTransactionError"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function da(n){let t=0;for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t++;return t}function Ee(n,t){for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t(e,n[e])}function _l(n){for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pt{constructor(t){this.binaryString=t}static fromBase64String(t){const e=function(r){try{return atob(r)}catch(s){throw typeof DOMException<"u"&&s instanceof DOMException?new wl("Invalid base64 string: "+s):s}}(t);return new pt(e)}static fromUint8Array(t){const e=function(r){let s="";for(let a=0;a<r.length;++a)s+=String.fromCharCode(r[a]);return s}(t);return new pt(e)}[Symbol.iterator](){let t=0;return{next:()=>t<this.binaryString.length?{value:this.binaryString.charCodeAt(t++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(e){return btoa(e)}(this.binaryString)}toUint8Array(){return function(e){const i=new Uint8Array(e.length);for(let r=0;r<e.length;r++)i[r]=e.charCodeAt(r);return i}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return K(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}pt.EMPTY_BYTE_STRING=new pt("");const Eh=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function ae(n){if(X(!!n),typeof n=="string"){let t=0;const e=Eh.exec(n);if(X(!!e),e[1]){let r=e[1];r=(r+"000000000").substr(0,9),t=Number(r)}const i=new Date(n);return{seconds:Math.floor(i.getTime()/1e3),nanos:t}}return{seconds:rt(n.seconds),nanos:rt(n.nanos)}}function rt(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function _e(n){return typeof n=="string"?pt.fromBase64String(n):pt.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ge{constructor(t,e){this.mapKeyFn=t,this.equalsFn=e,this.inner={},this.innerSize=0}get(t){const e=this.mapKeyFn(t),i=this.inner[e];if(i!==void 0){for(const[r,s]of i)if(this.equalsFn(r,t))return s}}has(t){return this.get(t)!==void 0}set(t,e){const i=this.mapKeyFn(t),r=this.inner[i];if(r===void 0)return this.inner[i]=[[t,e]],void this.innerSize++;for(let s=0;s<r.length;s++)if(this.equalsFn(r[s][0],t))return void(r[s]=[t,e]);r.push([t,e]),this.innerSize++}delete(t){const e=this.mapKeyFn(t),i=this.inner[e];if(i===void 0)return!1;for(let r=0;r<i.length;r++)if(this.equalsFn(i[r][0],t))return i.length===1?delete this.inner[e]:i.splice(r,1),this.innerSize--,!0;return!1}forEach(t){Ee(this.inner,(e,i)=>{for(const[r,s]of i)t(r,s)})}isEmpty(){return _l(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function go(n,t){if(n.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:xi(t)?"-0":t}}function Ll(n){return{integerValue:""+n}}function Wh(n,t){return wh(t)?Ll(t):go(n,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vp{constructor(t,e,i,r){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=i,this.indexManager=r}getDocument(t,e){let i=null;return this.documentOverlayCache.getOverlay(t,e).next(r=>(i=r,this.remoteDocumentCache.getEntry(t,e))).next(r=>(i!==null&&wn(i.mutation,r,Pt.empty(),at.now()),r))}getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next(i=>this.getLocalViewOfDocuments(t,i,$()).next(()=>i))}getLocalViewOfDocuments(t,e,i=$()){const r=ge();return this.populateOverlays(t,r,e).next(()=>this.computeViews(t,e,r,i).next(s=>{let a=gn();return s.forEach((c,u)=>{a=a.insert(c,u.overlayedDocument)}),a}))}getOverlayedDocuments(t,e){const i=ge();return this.populateOverlays(t,i,e).next(()=>this.computeViews(t,e,i,$()))}populateOverlays(t,e,i){const r=[];return i.forEach(s=>{e.has(s)||r.push(s)}),this.documentOverlayCache.getOverlays(t,r).next(s=>{s.forEach((a,c)=>{e.set(a,c)})})}computeViews(t,e,i,r){let s=Xt();const a=_n(),c=function(){return _n()}();return e.forEach((u,h)=>{const f=i.get(h.key);r.has(h.key)&&(f===void 0||f.mutation instanceof ce)?s=s.insert(h.key,h):f!==void 0?(a.set(h.key,f.mutation.getFieldMask()),wn(f.mutation,h,f.mutation.getFieldMask(),at.now())):a.set(h.key,Pt.empty())}),this.recalculateAndSaveOverlays(t,s).next(u=>(u.forEach((h,f)=>a.set(h,f)),e.forEach((h,f)=>{var y;return c.set(h,new Sp(f,(y=a.get(h))!==null&&y!==void 0?y:null))}),c))}recalculateAndSaveOverlays(t,e){const i=_n();let r=new nt((a,c)=>a-c),s=$();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next(a=>{for(const c of a)c.keys().forEach(u=>{const h=e.get(u);if(h===null)return;let f=i.get(u)||Pt.empty();f=c.applyToLocalView(h,f),i.set(u,f);const y=(r.get(c.batchId)||$()).add(u);r=r.insert(c.batchId,y)})}).next(()=>{const a=[],c=r.getReverseIterator();for(;c.hasNext();){const u=c.getNext(),h=u.key,f=u.value,y=Bl();f.forEach(v=>{if(!s.has(v)){const I=jl(e.get(v),i.get(v));I!==null&&y.set(v,I),s=s.add(v)}}),a.push(this.documentOverlayCache.saveOverlays(t,h,y))}return L.waitFor(a)}).next(()=>i)}recalculateAndSaveOverlaysForDocumentKeys(t,e){return this.remoteDocumentCache.getEntries(t,e).next(i=>this.recalculateAndSaveOverlays(t,i))}getDocumentsMatchingQuery(t,e,i,r){return function(a){return j.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0}(e)?this.getDocumentsMatchingDocumentQuery(t,e.path):Sl(e)?this.getDocumentsMatchingCollectionGroupQuery(t,e,i,r):this.getDocumentsMatchingCollectionQuery(t,e,i,r)}getNextDocuments(t,e,i,r){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,i,r).next(s=>{const a=r-s.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,i.largestBatchId,r-s.size):L.resolve(ge());let c=-1,u=s;return a.next(h=>L.forEach(h,(f,y)=>(c<y.largestBatchId&&(c=y.largestBatchId),s.get(f)?L.resolve():this.remoteDocumentCache.getEntry(t,f).next(v=>{u=u.insert(f,v)}))).next(()=>this.populateOverlays(t,h,s)).next(()=>this.computeViews(t,u,h,$())).next(f=>({batchId:c,changes:Nl(f)})))})}getDocumentsMatchingDocumentQuery(t,e){return this.getDocument(t,new j(e)).next(i=>{let r=gn();return i.isFoundDocument()&&(r=r.insert(i.key,i)),r})}getDocumentsMatchingCollectionGroupQuery(t,e,i,r){const s=e.collectionGroup;let a=gn();return this.indexManager.getCollectionParents(t,s).next(c=>L.forEach(c,u=>{const h=function(y,v){return new Qe(v,null,y.explicitOrderBy.slice(),y.filters.slice(),y.limit,y.limitType,y.startAt,y.endAt)}(e,u.child(s));return this.getDocumentsMatchingCollectionQuery(t,h,i,r).next(f=>{f.forEach((y,v)=>{a=a.insert(y,v)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(t,e,i,r){let s;return this.documentOverlayCache.getOverlaysForCollection(t,e.path,i.largestBatchId).next(a=>(s=a,this.remoteDocumentCache.getDocumentsMatchingQuery(t,e,i,s,r))).next(a=>{s.forEach((u,h)=>{const f=h.getKey();a.get(f)===null&&(a=a.insert(f,At.newInvalidDocument(f)))});let c=gn();return a.forEach((u,h)=>{const f=s.get(u);f!==void 0&&wn(f.mutation,h,Pt.empty(),at.now()),zi(e,h)&&(c=c.insert(u,h))}),c})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kp{constructor(){this.overlays=new nt(j.comparator),this.Ir=new Map}getOverlay(t,e){return L.resolve(this.overlays.get(e))}getOverlays(t,e){const i=ge();return L.forEach(e,r=>this.getOverlay(t,r).next(s=>{s!==null&&i.set(r,s)})).next(()=>i)}saveOverlays(t,e,i){return i.forEach((r,s)=>{this.ht(t,e,s)}),L.resolve()}removeOverlaysForBatchId(t,e,i){const r=this.Ir.get(i);return r!==void 0&&(r.forEach(s=>this.overlays=this.overlays.remove(s)),this.Ir.delete(i)),L.resolve()}getOverlaysForCollection(t,e,i){const r=ge(),s=e.length+1,a=new j(e.child("")),c=this.overlays.getIteratorFrom(a);for(;c.hasNext();){const u=c.getNext().value,h=u.getKey();if(!e.isPrefixOf(h.path))break;h.path.length===s&&u.largestBatchId>i&&r.set(u.getKey(),u)}return L.resolve(r)}getOverlaysForCollectionGroup(t,e,i,r){let s=new nt((h,f)=>h-f);const a=this.overlays.getIterator();for(;a.hasNext();){const h=a.getNext().value;if(h.getKey().getCollectionGroup()===e&&h.largestBatchId>i){let f=s.get(h.largestBatchId);f===null&&(f=ge(),s=s.insert(h.largestBatchId,f)),f.set(h.getKey(),h)}}const c=ge(),u=s.getIterator();for(;u.hasNext()&&(u.getNext().value.forEach((h,f)=>c.set(h,f)),!(c.size()>=r)););return L.resolve(c)}ht(t,e,i){const r=this.overlays.get(i.key);if(r!==null){const a=this.Ir.get(r.largestBatchId).delete(i.key);this.Ir.set(r.largestBatchId,a)}this.overlays=this.overlays.insert(i.key,new np(e,i));let s=this.Ir.get(e);s===void 0&&(s=$(),this.Ir.set(e,s)),this.Ir.set(e,s.add(i.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Np{constructor(){this.sessionToken=pt.EMPTY_BYTE_STRING}getSessionToken(t){return L.resolve(this.sessionToken)}setSessionToken(t,e){return this.sessionToken=e,L.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bo{constructor(){this.Tr=new ht(lt.Er),this.dr=new ht(lt.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(t,e){const i=new lt(t,e);this.Tr=this.Tr.add(i),this.dr=this.dr.add(i)}Rr(t,e){t.forEach(i=>this.addReference(i,e))}removeReference(t,e){this.Vr(new lt(t,e))}mr(t,e){t.forEach(i=>this.removeReference(i,e))}gr(t){const e=new j(new tt([])),i=new lt(e,t),r=new lt(e,t+1),s=[];return this.dr.forEachInRange([i,r],a=>{this.Vr(a),s.push(a.key)}),s}pr(){this.Tr.forEach(t=>this.Vr(t))}Vr(t){this.Tr=this.Tr.delete(t),this.dr=this.dr.delete(t)}yr(t){const e=new j(new tt([])),i=new lt(e,t),r=new lt(e,t+1);let s=$();return this.dr.forEachInRange([i,r],a=>{s=s.add(a.key)}),s}containsKey(t){const e=new lt(t,0),i=this.Tr.firstAfterOrEqual(e);return i!==null&&t.isEqual(i.key)}}class lt{constructor(t,e){this.key=t,this.wr=e}static Er(t,e){return j.comparator(t.key,e.key)||K(t.wr,e.wr)}static Ar(t,e){return K(t.wr,e.wr)||j.comparator(t.key,e.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bp{constructor(t,e){this.indexManager=t,this.referenceDelegate=e,this.mutationQueue=[],this.Sr=1,this.br=new ht(lt.Er)}checkEmpty(t){return L.resolve(this.mutationQueue.length===0)}addMutationBatch(t,e,i,r){const s=this.Sr;this.Sr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const a=new ep(s,e,i,r);this.mutationQueue.push(a);for(const c of r)this.br=this.br.add(new lt(c.key,s)),this.indexManager.addToCollectionParentIndex(t,c.key.path.popLast());return L.resolve(a)}lookupMutationBatch(t,e){return L.resolve(this.Dr(e))}getNextMutationBatchAfterBatchId(t,e){const i=e+1,r=this.vr(i),s=r<0?0:r;return L.resolve(this.mutationQueue.length>s?this.mutationQueue[s]:null)}getHighestUnacknowledgedBatchId(){return L.resolve(this.mutationQueue.length===0?-1:this.Sr-1)}getAllMutationBatches(t){return L.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(t,e){const i=new lt(e,0),r=new lt(e,Number.POSITIVE_INFINITY),s=[];return this.br.forEachInRange([i,r],a=>{const c=this.Dr(a.wr);s.push(c)}),L.resolve(s)}getAllMutationBatchesAffectingDocumentKeys(t,e){let i=new ht(K);return e.forEach(r=>{const s=new lt(r,0),a=new lt(r,Number.POSITIVE_INFINITY);this.br.forEachInRange([s,a],c=>{i=i.add(c.wr)})}),L.resolve(this.Cr(i))}getAllMutationBatchesAffectingQuery(t,e){const i=e.path,r=i.length+1;let s=i;j.isDocumentKey(s)||(s=s.child(""));const a=new lt(new j(s),0);let c=new ht(K);return this.br.forEachWhile(u=>{const h=u.key.path;return!!i.isPrefixOf(h)&&(h.length===r&&(c=c.add(u.wr)),!0)},a),L.resolve(this.Cr(c))}Cr(t){const e=[];return t.forEach(i=>{const r=this.Dr(i);r!==null&&e.push(r)}),e}removeMutationBatch(t,e){X(this.Fr(e.batchId,"removed")===0),this.mutationQueue.shift();let i=this.br;return L.forEach(e.mutations,r=>{const s=new lt(r.key,e.batchId);return i=i.delete(s),this.referenceDelegate.markPotentiallyOrphaned(t,r.key)}).next(()=>{this.br=i})}On(t){}containsKey(t,e){const i=new lt(e,0),r=this.br.firstAfterOrEqual(i);return L.resolve(e.isEqual(r&&r.key))}performConsistencyCheck(t){return this.mutationQueue.length,L.resolve()}Fr(t,e){return this.vr(t)}vr(t){return this.mutationQueue.length===0?0:t-this.mutationQueue[0].batchId}Dr(t){const e=this.vr(t);return e<0||e>=this.mutationQueue.length?null:this.mutationQueue[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lp{constructor(t){this.Mr=t,this.docs=function(){return new nt(j.comparator)}(),this.size=0}setIndexManager(t){this.indexManager=t}addEntry(t,e){const i=e.key,r=this.docs.get(i),s=r?r.size:0,a=this.Mr(e);return this.docs=this.docs.insert(i,{document:e.mutableCopy(),size:a}),this.size+=a-s,this.indexManager.addToCollectionParentIndex(t,i.path.popLast())}removeEntry(t){const e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){const i=this.docs.get(e);return L.resolve(i?i.document.mutableCopy():At.newInvalidDocument(e))}getEntries(t,e){let i=Xt();return e.forEach(r=>{const s=this.docs.get(r);i=i.insert(r,s?s.document.mutableCopy():At.newInvalidDocument(r))}),L.resolve(i)}getDocumentsMatchingQuery(t,e,i,r){let s=Xt();const a=e.path,c=new j(a.child("")),u=this.docs.getIteratorFrom(c);for(;u.hasNext();){const{key:h,value:{document:f}}=u.getNext();if(!a.isPrefixOf(h.path))break;h.path.length>a.length+1||vh(yh(f),i)<=0||(r.has(f.key)||zi(e,f))&&(s=s.insert(f.key,f.mutableCopy()))}return L.resolve(s)}getAllFromCollectionGroup(t,e,i,r){q()}Or(t,e){return L.forEach(this.docs,i=>e(i))}newChangeBuffer(t){return new Mp(this)}getSize(t){return L.resolve(this.size)}}class Mp extends Pp{constructor(t){super(),this.cr=t}applyChanges(t){const e=[];return this.changes.forEach((i,r)=>{r.isValidDocument()?e.push(this.cr.addEntry(t,r)):this.cr.removeEntry(i)}),L.waitFor(e)}getFromCache(t,e){return this.cr.getEntry(t,e)}getAllFromCache(t,e){return this.cr.getEntries(t,e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fp{constructor(t,e){this.qr={},this.overlays={},this.Qr=new co(0),this.Kr=!1,this.Kr=!0,this.$r=new Np,this.referenceDelegate=t(this),this.Ur=new Op(this),this.indexManager=new Rp,this.remoteDocumentCache=function(r){return new Lp(r)}(i=>this.referenceDelegate.Wr(i)),this.serializer=new xp(e),this.Gr=new Dp(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(t){return this.indexManager}getDocumentOverlayCache(t){let e=this.overlays[t.toKey()];return e||(e=new kp,this.overlays[t.toKey()]=e),e}getMutationQueue(t,e){let i=this.qr[t.toKey()];return i||(i=new Bp(e,this.referenceDelegate),this.qr[t.toKey()]=i),i}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(t,e,i){z("MemoryPersistence","Starting transaction:",t);const r=new zp(this.Qr.next());return this.referenceDelegate.zr(),i(r).next(s=>this.referenceDelegate.jr(r).next(()=>s)).toPromise().then(s=>(r.raiseOnCommittedEvent(),s))}Hr(t,e){return L.or(Object.values(this.qr).map(i=>()=>i.containsKey(t,e)))}}class zp extends bh{constructor(t){super(),this.currentSequenceNumber=t}}class _o{constructor(t){this.persistence=t,this.Jr=new bo,this.Yr=null}static Zr(t){return new _o(t)}get Xr(){if(this.Yr)return this.Yr;throw q()}addReference(t,e,i){return this.Jr.addReference(i,e),this.Xr.delete(i.toString()),L.resolve()}removeReference(t,e,i){return this.Jr.removeReference(i,e),this.Xr.add(i.toString()),L.resolve()}markPotentiallyOrphaned(t,e){return this.Xr.add(e.toString()),L.resolve()}removeTarget(t,e){this.Jr.gr(e.targetId).forEach(r=>this.Xr.add(r.toString()));const i=this.persistence.getTargetCache();return i.getMatchingKeysForTargetId(t,e.targetId).next(r=>{r.forEach(s=>this.Xr.add(s.toString()))}).next(()=>i.removeTargetData(t,e))}zr(){this.Yr=new Set}jr(t){const e=this.persistence.getRemoteDocumentCache().newChangeBuffer();return L.forEach(this.Xr,i=>{const r=j.fromPath(i);return this.ei(t,r).next(s=>{s||e.removeEntry(r,H.min())})}).next(()=>(this.Yr=null,e.apply(t)))}updateLimboDocument(t,e){return this.ei(t,e).next(i=>{i?this.Xr.delete(e.toString()):this.Xr.add(e.toString())})}Wr(t){return 0}ei(t,e){return L.or([()=>L.resolve(this.Jr.containsKey(e)),()=>this.persistence.getTargetCache().containsKey(t,e),()=>this.persistence.Hr(t,e)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wo{constructor(t,e,i,r){this.targetId=t,this.fromCache=e,this.$i=i,this.Ui=r}static Wi(t,e){let i=$(),r=$();for(const s of e.docChanges)switch(s.type){case 0:i=i.add(s.doc.key);break;case 1:r=r.add(s.doc.key)}return new wo(t,e.fromCache,i,r)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qp{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return Hu()?8:_h(ju())>0?6:4}()}initialize(t,e){this.Ji=t,this.indexManager=e,this.Gi=!0}getDocumentsMatchingQuery(t,e,i,r){const s={result:null};return this.Yi(t,e).next(a=>{s.result=a}).next(()=>{if(!s.result)return this.Zi(t,e,r,i).next(a=>{s.result=a})}).next(()=>{if(s.result)return;const a=new jp;return this.Xi(t,e,a).next(c=>{if(s.result=c,this.zi)return this.es(t,e,a,c.size)})}).next(()=>s.result)}es(t,e,i,r){return i.documentReadCount<this.ji?(fn()<=Q.DEBUG&&z("QueryEngine","SDK will not create cache indexes for query:",ke(e),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),L.resolve()):(fn()<=Q.DEBUG&&z("QueryEngine","Query:",ke(e),"scans",i.documentReadCount,"local documents and returns",r,"documents as results."),i.documentReadCount>this.Hi*r?(fn()<=Q.DEBUG&&z("QueryEngine","The SDK decides to create cache indexes for query:",ke(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,Ot(e))):L.resolve())}Yi(t,e){if(_a(e))return L.resolve(null);let i=Ot(e);return this.indexManager.getIndexType(t,i).next(r=>r===0?null:(e.limit!==null&&r===1&&(e=Gr(e,null,"F"),i=Ot(e)),this.indexManager.getDocumentsMatchingTarget(t,i).next(s=>{const a=$(...s);return this.Ji.getDocuments(t,a).next(c=>this.indexManager.getMinOffset(t,i).next(u=>{const h=this.ts(e,c);return this.ns(e,h,a,u.readTime)?this.Yi(t,Gr(e,null,"F")):this.rs(t,h,e,u)}))})))}Zi(t,e,i,r){return _a(e)||r.isEqual(H.min())?L.resolve(null):this.Ji.getDocuments(t,i).next(s=>{const a=this.ts(e,s);return this.ns(e,a,i,r)?L.resolve(null):(fn()<=Q.DEBUG&&z("QueryEngine","Re-using previous result from %s to execute query: %s",r.toString(),ke(e)),this.rs(t,a,e,gh(r,-1)).next(c=>c))})}ts(t,e){let i=new ht(Dl(t));return e.forEach((r,s)=>{zi(t,s)&&(i=i.add(s))}),i}ns(t,e,i,r){if(t.limit===null)return!1;if(i.size!==e.size)return!0;const s=t.limitType==="F"?e.last():e.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(r)>0)}Xi(t,e,i){return fn()<=Q.DEBUG&&z("QueryEngine","Using full collection scan to execute query:",ke(e)),this.Ji.getDocumentsMatchingQuery(t,e,se.min(),i)}rs(t,e,i,r){return this.Ji.getDocumentsMatchingQuery(t,i,r).next(s=>(e.forEach(a=>{s=s.insert(a.key,a)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hp{constructor(t,e,i,r){this.persistence=t,this.ss=e,this.serializer=r,this.os=new nt(K),this._s=new Ge(s=>fo(s),mo),this.us=new Map,this.cs=t.getRemoteDocumentCache(),this.Ur=t.getTargetCache(),this.Gr=t.getBundleCache(),this.ls(i)}ls(t){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(t),this.indexManager=this.persistence.getIndexManager(t),this.mutationQueue=this.persistence.getMutationQueue(t,this.indexManager),this.localDocuments=new Vp(this.cs,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.cs.setIndexManager(this.indexManager),this.ss.initialize(this.localDocuments,this.indexManager)}collectGarbage(t){return this.persistence.runTransaction("Collect garbage","readwrite-primary",e=>t.collect(e,this.os))}}function Up(n,t,e,i){return new Hp(n,t,e,i)}async function Yl(n,t){const e=U(n);return await e.persistence.runTransaction("Handle user change","readonly",i=>{let r;return e.mutationQueue.getAllMutationBatches(i).next(s=>(r=s,e.ls(t),e.mutationQueue.getAllMutationBatches(i))).next(s=>{const a=[],c=[];let u=$();for(const h of r){a.push(h.batchId);for(const f of h.mutations)u=u.add(f.key)}for(const h of s){c.push(h.batchId);for(const f of h.mutations)u=u.add(f.key)}return e.localDocuments.getDocuments(i,u).next(h=>({hs:h,removedBatchIds:a,addedBatchIds:c}))})})}function $p(n,t){const e=U(n);return e.persistence.runTransaction("Acknowledge batch","readwrite-primary",i=>{const r=t.batch.keys(),s=e.cs.newChangeBuffer({trackRemovals:!0});return function(c,u,h,f){const y=h.batch,v=y.keys();let I=L.resolve();return v.forEach(k=>{I=I.next(()=>f.getEntry(u,k)).next(T=>{const g=h.docVersions.get(k);X(g!==null),T.version.compareTo(g)<0&&(y.applyToRemoteDocument(T,h),T.isValidDocument()&&(T.setReadTime(h.commitVersion),f.addEntry(T)))})}),I.next(()=>c.mutationQueue.removeMutationBatch(u,y))}(e,i,t,s).next(()=>s.apply(i)).next(()=>e.mutationQueue.performConsistencyCheck(i)).next(()=>e.documentOverlayCache.removeOverlaysForBatchId(i,r,t.batch.batchId)).next(()=>e.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(i,function(c){let u=$();for(let h=0;h<c.mutationResults.length;++h)c.mutationResults[h].transformResults.length>0&&(u=u.add(c.batch.mutations[h].key));return u}(t))).next(()=>e.localDocuments.getDocuments(i,r))})}function tc(n){const t=U(n);return t.persistence.runTransaction("Get last remote snapshot version","readonly",e=>t.Ur.getLastRemoteSnapshotVersion(e))}function Wp(n,t){const e=U(n),i=t.snapshotVersion;let r=e.os;return e.persistence.runTransaction("Apply remote event","readwrite-primary",s=>{const a=e.cs.newChangeBuffer({trackRemovals:!0});r=e.os;const c=[];t.targetChanges.forEach((f,y)=>{const v=r.get(y);if(!v)return;c.push(e.Ur.removeMatchingKeys(s,f.removedDocuments,y).next(()=>e.Ur.addMatchingKeys(s,f.addedDocuments,y)));let I=v.withSequenceNumber(s.currentSequenceNumber);t.targetMismatches.get(y)!==null?I=I.withResumeToken(pt.EMPTY_BYTE_STRING,H.min()).withLastLimboFreeSnapshotVersion(H.min()):f.resumeToken.approximateByteSize()>0&&(I=I.withResumeToken(f.resumeToken,i)),r=r.insert(y,I),function(T,g,x){return T.resumeToken.approximateByteSize()===0||g.snapshotVersion.toMicroseconds()-T.snapshotVersion.toMicroseconds()>=3e8?!0:x.addedDocuments.size+x.modifiedDocuments.size+x.removedDocuments.size>0}(v,I,f)&&c.push(e.Ur.updateTargetData(s,I))});let u=Xt(),h=$();if(t.documentUpdates.forEach(f=>{t.resolvedLimboDocuments.has(f)&&c.push(e.persistence.referenceDelegate.updateLimboDocument(s,f))}),c.push(Qp(s,a,t.documentUpdates).next(f=>{u=f.Ps,h=f.Is})),!i.isEqual(H.min())){const f=e.Ur.getLastRemoteSnapshotVersion(s).next(y=>e.Ur.setTargetsMetadata(s,s.currentSequenceNumber,i));c.push(f)}return L.waitFor(c).next(()=>a.apply(s)).next(()=>e.localDocuments.getLocalViewOfDocuments(s,u,h)).next(()=>u)}).then(s=>(e.os=r,s))}function Qp(n,t,e){let i=$(),r=$();return e.forEach(s=>i=i.add(s)),t.getEntries(n,i).next(s=>{let a=Xt();return e.forEach((c,u)=>{const h=s.get(c);u.isFoundDocument()!==h.isFoundDocument()&&(r=r.add(c)),u.isNoDocument()&&u.version.isEqual(H.min())?(t.removeEntry(c,u.readTime),a=a.insert(c,u)):!h.isValidDocument()||u.version.compareTo(h.version)>0||u.version.compareTo(h.version)===0&&h.hasPendingWrites?(t.addEntry(u),a=a.insert(c,u)):z("LocalStore","Ignoring outdated watch update for ",c,". Current version:",h.version," Watch version:",u.version)}),{Ps:a,Is:r}})}function Gp(n,t){const e=U(n);return e.persistence.runTransaction("Get next mutation batch","readonly",i=>(t===void 0&&(t=-1),e.mutationQueue.getNextMutationBatchAfterBatchId(i,t)))}function Kp(n,t){const e=U(n);return e.persistence.runTransaction("Allocate target","readwrite",i=>{let r;return e.Ur.getTargetData(i,t).next(s=>s?(r=s,L.resolve(r)):e.Ur.allocateTargetId(i).next(a=>(r=new ne(t,a,"TargetPurposeListen",i.currentSequenceNumber),e.Ur.addTargetData(i,r).next(()=>r))))}).then(i=>{const r=e.os.get(i.targetId);return(r===null||i.snapshotVersion.compareTo(r.snapshotVersion)>0)&&(e.os=e.os.insert(i.targetId,i),e._s.set(t,i.targetId)),i})}async function Yr(n,t,e){const i=U(n),r=i.os.get(t),s=e?"readwrite":"readwrite-primary";try{e||await i.persistence.runTransaction("Release target",s,a=>i.persistence.referenceDelegate.removeTarget(a,r))}catch(a){if(!Bn(a))throw a;z("LocalStore",`Failed to update sequence numbers for target ${t}: ${a}`)}i.os=i.os.remove(t),i._s.delete(r.target)}function Da(n,t,e){const i=U(n);let r=H.min(),s=$();return i.persistence.runTransaction("Execute query","readwrite",a=>function(u,h,f){const y=U(u),v=y._s.get(f);return v!==void 0?L.resolve(y.os.get(v)):y.Ur.getTargetData(h,f)}(i,a,Ot(t)).next(c=>{if(c)return r=c.lastLimboFreeSnapshotVersion,i.Ur.getMatchingKeysForTargetId(a,c.targetId).next(u=>{s=u})}).next(()=>i.ss.getDocumentsMatchingQuery(a,t,e?r:H.min(),e?s:$())).next(c=>(Xp(i,Fh(t),c),{documents:c,Ts:s})))}function Xp(n,t,e){let i=n.us.get(t)||H.min();e.forEach((r,s)=>{s.readTime.compareTo(i)>0&&(i=s.readTime)}),n.us.set(t,i)}class ka{constructor(){this.activeTargetIds=$h()}fs(t){this.activeTargetIds=this.activeTargetIds.add(t)}gs(t){this.activeTargetIds=this.activeTargetIds.delete(t)}Vs(){const t={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(t)}}class Jp{constructor(){this.so=new ka,this.oo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(t){}updateMutationState(t,e,i){}addLocalQueryTarget(t,e=!0){return e&&this.so.fs(t),this.oo[t]||"not-current"}updateQueryState(t,e,i){this.oo[t]=e}removeLocalQueryTarget(t){this.so.gs(t)}isLocalQueryTarget(t){return this.so.activeTargetIds.has(t)}clearQueryState(t){delete this.oo[t]}getAllActiveQueryTargets(){return this.so.activeTargetIds}isActiveQueryTarget(t){return this.so.activeTargetIds.has(t)}start(){return this.so=new ka,Promise.resolve()}handleUserChange(t,e,i){}setOnlineState(t){}shutdown(){}writeSequenceNumber(t){}notifyBundleLoaded(t){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yt="WebChannelConnection";class ef extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const i=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Do=i+"://"+e.host,this.vo=`projects/${r}/databases/${s}`,this.Co=this.databaseId.database==="(default)"?`project_id=${r}`:`project_id=${r}&database_id=${s}`}get Fo(){return!1}Mo(e,i,r,s,a){const c=Pr(),u=this.xo(e,i.toUriEncodedString());z("RestConnection",`Sending RPC '${e}' ${c}:`,u,r);const h={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(h,s,a),this.No(e,u,h,r).then(f=>(z("RestConnection",`Received RPC '${e}' ${c}: `,f),f),f=>{throw Oe("RestConnection",`RPC '${e}' ${c} failed with error: `,f,"url: ",u,"request:",r),f})}Lo(e,i,r,s,a,c){return this.Mo(e,i,r,s,a)}Oo(e,i,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+We}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),i&&i.headers.forEach((s,a)=>e[a]=s),r&&r.headers.forEach((s,a)=>e[a]=s)}xo(e,i){const r=Yp[e];return`${this.Do}/v1/${i}:${r}`}terminate(){}}{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}No(t,e,i,r){const s=Pr();return new Promise((a,c)=>{const u=new fl;u.setWithCredentials(!0),u.listenOnce(ml.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case yi.NO_ERROR:const f=u.getResponseJson();z(yt,`XHR for RPC '${t}' ${s} received:`,JSON.stringify(f)),a(f);break;case yi.TIMEOUT:z(yt,`RPC '${t}' ${s} timed out`),c(new F(N.DEADLINE_EXCEEDED,"Request time out"));break;case yi.HTTP_ERROR:const y=u.getStatus();if(z(yt,`RPC '${t}' ${s} failed with status:`,y,"response text:",u.getResponseText()),y>0){let v=u.getResponseJson();Array.isArray(v)&&(v=v[0]);const I=v==null?void 0:v.error;if(I&&I.status&&I.message){const k=function(g){const x=g.toLowerCase().replace(/_/g,"-");return Object.values(N).indexOf(x)>=0?x:N.UNKNOWN}(I.status);c(new F(k,I.message))}else c(new F(N.UNKNOWN,"Server responded with status "+u.getStatus()))}else c(new F(N.UNAVAILABLE,"Connection failed."));break;default:q()}}finally{z(yt,`RPC '${t}' ${s} completed.`)}});const h=JSON.stringify(r);z(yt,`RPC '${t}' ${s} sending request:`,r),u.send(e,"POST",h,i,15)})}Bo(t,e,i){const r=Pr(),s=[this.Do,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=vl(),c=yl(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Oo(u.initMessageHeaders,e,i),u.encodeInitMessageHeaders=!0;const f=s.join("");z(yt,`Creating RPC '${t}' stream ${r}: ${f}`,u);const y=a.createWebChannel(f,u);let v=!1,I=!1;const k=new tf({Io:g=>{I?z(yt,`Not sending because RPC '${t}' stream ${r} is closed:`,g):(v||(z(yt,`Opening RPC '${t}' stream ${r} transport.`),y.open(),v=!0),z(yt,`RPC '${t}' stream ${r} sending:`,g),y.send(g))},To:()=>y.close()}),T=(g,x,P)=>{g.listen(x,B=>{try{P(B)}catch(S){setTimeout(()=>{throw S},0)}})};return T(y,mn.EventType.OPEN,()=>{I||(z(yt,`RPC '${t}' stream ${r} transport opened.`),k.yo())}),T(y,mn.EventType.CLOSE,()=>{I||(I=!0,z(yt,`RPC '${t}' stream ${r} transport closed`),k.So())}),T(y,mn.EventType.ERROR,g=>{I||(I=!0,Oe(yt,`RPC '${t}' stream ${r} transport errored:`,g),k.So(new F(N.UNAVAILABLE,"The operation could not be completed")))}),T(y,mn.EventType.MESSAGE,g=>{var x;if(!I){const P=g.data[0];X(!!P);const B=P,S=B.error||((x=B[0])===null||x===void 0?void 0:x.error);if(S){z(yt,`RPC '${t}' stream ${r} received error:`,S);const M=S.status;let D=function(A){const w=ot[A];if(w!==void 0)return Hl(w)}(M),_=S.message;D===void 0&&(D=N.INTERNAL,_="Unknown error status: "+M+" with message "+S.message),I=!0,k.So(new F(D,_)),y.close()}else z(yt,`RPC '${t}' stream ${r} received:`,P),k.bo(P)}}),T(c,gl.STAT_EVENT,g=>{g.stat===qr.PROXY?z(yt,`RPC '${t}' stream ${r} detected buffering proxy`):g.stat===qr.NOPROXY&&z(yt,`RPC '${t}' stream ${r} detected no buffering proxy`)}),setTimeout(()=>{k.wo()},0),k}}function Sr(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $i(n){return new dp(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class of extends class{}{constructor(t,e,i,r){super(),this.authCredentials=t,this.appCheckCredentials=e,this.connection=i,this.serializer=r,this.y_=!1}w_(){if(this.y_)throw new F(N.FAILED_PRECONDITION,"The client has already been terminated.")}Mo(t,e,i,r){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([s,a])=>this.connection.Mo(t,Xr(e,i),r,s,a)).catch(s=>{throw s.name==="FirebaseError"?(s.code===N.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),s):new F(N.UNKNOWN,s.toString())})}Lo(t,e,i,r,s){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([a,c])=>this.connection.Lo(t,Xr(e,i),r,a,c,s)).catch(a=>{throw a.name==="FirebaseError"?(a.code===N.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),a):new F(N.UNKNOWN,a.toString())})}terminate(){this.y_=!0,this.connection.terminate()}}class sf{constructor(t,e){this.asyncQueue=t,this.onlineStateHandler=e,this.state="Unknown",this.S_=0,this.b_=null,this.D_=!0}v_(){this.S_===0&&(this.C_("Unknown"),this.b_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.b_=null,this.F_("Backend didn't respond within 10 seconds."),this.C_("Offline"),Promise.resolve())))}M_(t){this.state==="Online"?this.C_("Unknown"):(this.S_++,this.S_>=1&&(this.x_(),this.F_(`Connection failed 1 times. Most recent error: ${t.toString()}`),this.C_("Offline")))}set(t){this.x_(),this.S_=0,t==="Online"&&(this.D_=!1),this.C_(t)}C_(t){t!==this.state&&(this.state=t,this.onlineStateHandler(t))}F_(t){const e=`Could not reach Cloud Firestore backend. ${t}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cc{constructor(t){this.key=t}}class uc{constructor(t){this.key=t}}class Ef{constructor(t,e){this.query=t,this.Ta=e,this.Ea=null,this.hasCachedResults=!1,this.current=!1,this.da=$(),this.mutatedKeys=$(),this.Aa=Dl(t),this.Ra=new Me(this.Aa)}get Va(){return this.Ta}ma(t,e){const i=e?e.fa:new La,r=e?e.Ra:this.Ra;let s=e?e.mutatedKeys:this.mutatedKeys,a=r,c=!1;const u=this.query.limitType==="F"&&r.size===this.query.limit?r.last():null,h=this.query.limitType==="L"&&r.size===this.query.limit?r.first():null;if(t.inorderTraversal((f,y)=>{const v=r.get(f),I=zi(this.query,y)?y:null,k=!!v&&this.mutatedKeys.has(v.key),T=!!I&&(I.hasLocalMutations||this.mutatedKeys.has(I.key)&&I.hasCommittedMutations);let g=!1;v&&I?v.data.isEqual(I.data)?k!==T&&(i.track({type:3,doc:I}),g=!0):this.ga(v,I)||(i.track({type:2,doc:I}),g=!0,(u&&this.Aa(I,u)>0||h&&this.Aa(I,h)<0)&&(c=!0)):!v&&I?(i.track({type:0,doc:I}),g=!0):v&&!I&&(i.track({type:1,doc:v}),g=!0,(u||h)&&(c=!0)),g&&(I?(a=a.add(I),s=T?s.add(f):s.delete(f)):(a=a.delete(f),s=s.delete(f)))}),this.query.limit!==null)for(;a.size>this.query.limit;){const f=this.query.limitType==="F"?a.last():a.first();a=a.delete(f.key),s=s.delete(f.key),i.track({type:1,doc:f})}return{Ra:a,fa:i,ns:c,mutatedKeys:s}}ga(t,e){return t.hasLocalMutations&&e.hasCommittedMutations&&!e.hasLocalMutations}applyChanges(t,e,i,r){const s=this.Ra;this.Ra=t.Ra,this.mutatedKeys=t.mutatedKeys;const a=t.fa.G_();a.sort((f,y)=>function(I,k){const T=g=>{switch(g){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return q()}};return T(I)-T(k)}(f.type,y.type)||this.Aa(f.doc,y.doc)),this.pa(i),r=r!=null&&r;const c=e&&!r?this.ya():[],u=this.da.size===0&&this.current&&!r?1:0,h=u!==this.Ea;return this.Ea=u,a.length!==0||h?{snapshot:new He(this.query,t.Ra,s,a,t.mutatedKeys,u===0,h,!1,!!i&&i.resumeToken.approximateByteSize()>0),wa:c}:{wa:c}}Z_(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({Ra:this.Ra,fa:new La,mutatedKeys:this.mutatedKeys,ns:!1},!1)):{wa:[]}}Sa(t){return!this.Ta.has(t)&&!!this.Ra.has(t)&&!this.Ra.get(t).hasLocalMutations}pa(t){t&&(t.addedDocuments.forEach(e=>this.Ta=this.Ta.add(e)),t.modifiedDocuments.forEach(e=>{}),t.removedDocuments.forEach(e=>this.Ta=this.Ta.delete(e)),this.current=t.current)}ya(){if(!this.current)return[];const t=this.da;this.da=$(),this.Ra.forEach(i=>{this.Sa(i.key)&&(this.da=this.da.add(i.key))});const e=[];return t.forEach(i=>{this.da.has(i)||e.push(new uc(i))}),this.da.forEach(i=>{t.has(i)||e.push(new cc(i))}),e}ba(t){this.Ta=t.Ts,this.da=$();const e=this.ma(t.documents);return this.applyChanges(e,!0)}Da(){return He.fromInitialDocuments(this.query,this.Ra,this.mutatedKeys,this.Ea===0,this.hasCachedResults)}}class If{constructor(t,e,i){this.query=t,this.targetId=e,this.view=i}}class xf{constructor(t){this.key=t,this.va=!1}}class Tf{constructor(t,e,i,r,s,a){this.localStore=t,this.remoteStore=e,this.eventManager=i,this.sharedClientState=r,this.currentUser=s,this.maxConcurrentLimboResolutions=a,this.Ca={},this.Fa=new Ge(c=>Vl(c),Fi),this.Ma=new Map,this.xa=new Set,this.Oa=new nt(j.comparator),this.Na=new Map,this.La=new bo,this.Ba={},this.ka=new Map,this.qa=qe.kn(),this.onlineState="Unknown",this.Qa=void 0}get isPrimaryClient(){return this.Qa===!0}}async function Rf(n,t,e=!0){const i=gc(n);let r;const s=i.Fa.get(t);return s?(i.sharedClientState.addLocalQueryTarget(s.targetId),r=s.view.Da()):r=await dc(i,t,e,!0),r}async function Cf(n,t){const e=gc(n);await dc(e,t,!0,!1)}async function dc(n,t,e,i){const r=await Kp(n.localStore,Ot(t)),s=r.targetId,a=n.sharedClientState.addLocalQueryTarget(s,e);let c;return i&&(c=await Pf(n,t,s,a==="current",r.resumeToken)),n.isPrimaryClient&&e&&ic(n.remoteStore,r),c}async function Pf(n,t,e,i,r){n.Ka=(y,v,I)=>async function(T,g,x,P){let B=g.view.ma(x);B.ns&&(B=await Da(T.localStore,g.query,!1).then(({documents:_})=>g.view.ma(_,B)));const S=P&&P.targetChanges.get(g.targetId),M=P&&P.targetMismatches.get(g.targetId)!=null,D=g.view.applyChanges(B,T.isPrimaryClient,S,M);return za(T,g.targetId,D.wa),D.snapshot}(n,y,v,I);const s=await Da(n.localStore,t,!0),a=new Ef(t,s.Ts),c=a.ma(s.documents),u=Mn.createSynthesizedTargetChangeForCurrentChange(e,i&&n.onlineState!=="Offline",r),h=a.applyChanges(c,n.isPrimaryClient,u);za(n,e,h.wa);const f=new If(t,e,a);return n.Fa.set(t,f),n.Ma.has(e)?n.Ma.get(e).push(t):n.Ma.set(e,[t]),h.snapshot}async function Sf(n,t,e){const i=U(n),r=i.Fa.get(t),s=i.Ma.get(r.targetId);if(s.length>1)return i.Ma.set(r.targetId,s.filter(a=>!Fi(a,t))),void i.Fa.delete(t);i.isPrimaryClient?(i.sharedClientState.removeLocalQueryTarget(r.targetId),i.sharedClientState.isActiveQueryTarget(r.targetId)||await Yr(i.localStore,r.targetId,!1).then(()=>{i.sharedClientState.clearQueryState(r.targetId),e&&Eo(i.remoteStore,r.targetId),eo(i,r.targetId)}).catch(Nn)):(eo(i,r.targetId),await Yr(i.localStore,r.targetId,!0))}async function Vf(n,t){const e=U(n),i=e.Fa.get(t),r=e.Ma.get(i.targetId);e.isPrimaryClient&&r.length===1&&(e.sharedClientState.removeLocalQueryTarget(i.targetId),Eo(e.remoteStore,i.targetId))}async function Df(n,t,e){const i=Ff(n);try{const r=await function(a,c){const u=U(a),h=at.now(),f=c.reduce((I,k)=>I.add(k.key),$());let y,v;return u.persistence.runTransaction("Locally write mutations","readwrite",I=>{let k=Xt(),T=$();return u.cs.getEntries(I,f).next(g=>{k=g,k.forEach((x,P)=>{P.isValidDocument()||(T=T.add(x))})}).next(()=>u.localDocuments.getOverlayedDocuments(I,k)).next(g=>{y=g;const x=[];for(const P of c){const B=Yh(P,y.get(P.key).overlayedDocument);B!=null&&x.push(new ce(P.key,B,El(B.value.mapValue),Et.exists(!0)))}return u.mutationQueue.addMutationBatch(I,h,x,c)}).next(g=>{v=g;const x=g.applyToLocalDocumentSet(y,T);return u.documentOverlayCache.saveOverlays(I,g.batchId,x)})}).then(()=>({batchId:v.batchId,changes:Nl(y)}))}(i.localStore,t);i.sharedClientState.addPendingMutation(r.batchId),function(a,c,u){let h=a.Ba[a.currentUser.toKey()];h||(h=new nt(K)),h=h.insert(c,u),a.Ba[a.currentUser.toKey()]=h}(i,r.batchId,e),await Fn(i,r.changes),await Qi(i.remoteStore)}catch(r){const s=Co(r,"Failed to persist write");e.reject(s)}}async function hc(n,t){const e=U(n);try{const i=await Wp(e.localStore,t);t.targetChanges.forEach((r,s)=>{const a=e.Na.get(s);a&&(X(r.addedDocuments.size+r.modifiedDocuments.size+r.removedDocuments.size<=1),r.addedDocuments.size>0?a.va=!0:r.modifiedDocuments.size>0?X(a.va):r.removedDocuments.size>0&&(X(a.va),a.va=!1))}),await Fn(e,i,t)}catch(i){await Nn(i)}}function Fa(n,t,e){const i=U(n);if(i.isPrimaryClient&&e===0||!i.isPrimaryClient&&e===1){const r=[];i.Fa.forEach((s,a)=>{const c=a.view.Z_(t);c.snapshot&&r.push(c.snapshot)}),function(a,c){const u=U(a);u.onlineState=c;let h=!1;u.queries.forEach((f,y)=>{for(const v of y.j_)v.Z_(c)&&(h=!0)}),h&&Vo(u)}(i.eventManager,t),r.length&&i.Ca.d_(r),i.onlineState=t,i.isPrimaryClient&&i.sharedClientState.setOnlineState(t)}}async function kf(n,t,e){const i=U(n);i.sharedClientState.updateQueryState(t,"rejected",e);const r=i.Na.get(t),s=r&&r.key;if(s){let a=new nt(j.comparator);a=a.insert(s,At.newNoDocument(s,H.min()));const c=$().add(s),u=new Ui(H.min(),new Map,new nt(K),a,c);await hc(i,u),i.Oa=i.Oa.remove(s),i.Na.delete(t),ko(i)}else await Yr(i.localStore,t,!1).then(()=>eo(i,t,e)).catch(Nn)}async function Nf(n,t){const e=U(n),i=t.batch.batchId;try{const r=await $p(e.localStore,t);fc(e,i,null),pc(e,i),e.sharedClientState.updateMutationState(i,"acknowledged"),await Fn(e,r)}catch(r){await Nn(r)}}async function Bf(n,t,e){const i=U(n);try{const r=await function(a,c){const u=U(a);return u.persistence.runTransaction("Reject batch","readwrite-primary",h=>{let f;return u.mutationQueue.lookupMutationBatch(h,c).next(y=>(X(y!==null),f=y.keys(),u.mutationQueue.removeMutationBatch(h,y))).next(()=>u.mutationQueue.performConsistencyCheck(h)).next(()=>u.documentOverlayCache.removeOverlaysForBatchId(h,f,c)).next(()=>u.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(h,f)).next(()=>u.localDocuments.getDocuments(h,f))})}(i.localStore,t);fc(i,t,e),pc(i,t),i.sharedClientState.updateMutationState(t,"rejected",e),await Fn(i,r)}catch(r){await Nn(r)}}function pc(n,t){(n.ka.get(t)||[]).forEach(e=>{e.resolve()}),n.ka.delete(t)}function fc(n,t,e){const i=U(n);let r=i.Ba[i.currentUser.toKey()];if(r){const s=r.get(t);s&&(e?s.reject(e):s.resolve(),r=r.remove(t)),i.Ba[i.currentUser.toKey()]=r}}function eo(n,t,e=null){n.sharedClientState.removeLocalQueryTarget(t);for(const i of n.Ma.get(t))n.Fa.delete(i),e&&n.Ca.$a(i,e);n.Ma.delete(t),n.isPrimaryClient&&n.La.gr(t).forEach(i=>{n.La.containsKey(i)||mc(n,i)})}function mc(n,t){n.xa.delete(t.path.canonicalString());const e=n.Oa.get(t);e!==null&&(Eo(n.remoteStore,e),n.Oa=n.Oa.remove(t),n.Na.delete(e),ko(n))}function za(n,t,e){for(const i of e)i instanceof cc?(n.La.addReference(i.key,t),Lf(n,i)):i instanceof uc?(z("SyncEngine","Document no longer in limbo: "+i.key),n.La.removeReference(i.key,t),n.La.containsKey(i.key)||mc(n,i.key)):q()}function Lf(n,t){const e=t.key,i=e.path.canonicalString();n.Oa.get(e)||n.xa.has(i)||(z("SyncEngine","New document in limbo: "+e),n.xa.add(i),ko(n))}function ko(n){for(;n.xa.size>0&&n.Oa.size<n.maxConcurrentLimboResolutions;){const t=n.xa.values().next().value;n.xa.delete(t);const e=new j(tt.fromString(t)),i=n.qa.next();n.Na.set(i,new xf(e)),n.Oa=n.Oa.insert(e,i),ic(n.remoteStore,new ne(Ot(Oi(e.path)),i,"TargetPurposeLimboResolution",co.oe))}}async function Fn(n,t,e){const i=U(n),r=[],s=[],a=[];i.Fa.isEmpty()||(i.Fa.forEach((c,u)=>{a.push(i.Ka(u,t,e).then(h=>{var f;if((h||e)&&i.isPrimaryClient){const y=h?!h.fromCache:(f=e==null?void 0:e.targetChanges.get(u.targetId))===null||f===void 0?void 0:f.current;i.sharedClientState.updateQueryState(u.targetId,y?"current":"not-current")}if(h){r.push(h);const y=wo.Wi(u.targetId,h);s.push(y)}}))}),await Promise.all(a),i.Ca.d_(r),await async function(u,h){const f=U(u);try{await f.persistence.runTransaction("notifyLocalViewChanges","readwrite",y=>L.forEach(h,v=>L.forEach(v.$i,I=>f.persistence.referenceDelegate.addReference(y,v.targetId,I)).next(()=>L.forEach(v.Ui,I=>f.persistence.referenceDelegate.removeReference(y,v.targetId,I)))))}catch(y){if(!Bn(y))throw y;z("LocalStore","Failed to update sequence numbers: "+y)}for(const y of h){const v=y.targetId;if(!y.fromCache){const I=f.os.get(v),k=I.snapshotVersion,T=I.withLastLimboFreeSnapshotVersion(k);f.os=f.os.insert(v,T)}}}(i.localStore,s))}async function Mf(n,t){const e=U(n);if(!e.currentUser.isEqual(t)){z("SyncEngine","User change. New user:",t.toKey());const i=await Yl(e.localStore,t);e.currentUser=t,function(s,a){s.ka.forEach(c=>{c.forEach(u=>{u.reject(new F(N.CANCELLED,a))})}),s.ka.clear()}(e,"'waitForPendingWrites' promise is rejected due to a user change."),e.sharedClientState.handleUserChange(t,i.removedBatchIds,i.addedBatchIds),await Fn(e,i.hs)}}function Of(n,t){const e=U(n),i=e.Na.get(t);if(i&&i.va)return $().add(i.key);{let r=$();const s=e.Ma.get(t);if(!s)return r;for(const a of s){const c=e.Fa.get(a);r=r.unionWith(c.view.Va)}return r}}function gc(n){const t=U(n);return t.remoteStore.remoteSyncer.applyRemoteEvent=hc.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=Of.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=kf.bind(null,t),t.Ca.d_=_f.bind(null,t.eventManager),t.Ca.$a=wf.bind(null,t.eventManager),t}function Ff(n){const t=U(n);return t.remoteStore.remoteSyncer.applySuccessfulWrite=Nf.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=Bf.bind(null,t),t}class Si{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=$i(t.databaseInfo.databaseId),this.sharedClientState=this.Wa(t),this.persistence=this.Ga(t),await this.persistence.start(),this.localStore=this.za(t),this.gcScheduler=this.ja(t,this.localStore),this.indexBackfillerScheduler=this.Ha(t,this.localStore)}ja(t,e){return null}Ha(t,e){return null}za(t){return Up(this.persistence,new qp,t.initialUser,this.serializer)}Ga(t){return new Fp(_o.Zr,this.serializer)}Wa(t){return new Jp}async terminate(){var t,e;(t=this.gcScheduler)===null||t===void 0||t.stop(),(e=this.indexBackfillerScheduler)===null||e===void 0||e.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Si.provider={build:()=>new Si};class no{async initialize(t,e){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(e),this.remoteStore=this.createRemoteStore(e),this.eventManager=this.createEventManager(e),this.syncEngine=this.createSyncEngine(e,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=i=>Fa(this.syncEngine,i,1),this.remoteStore.remoteSyncer.handleCredentialChange=Mf.bind(null,this.syncEngine),await vf(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return function(){return new bf}()}createDatastore(t){const e=$i(t.databaseInfo.databaseId),i=function(s){return new ef(s)}(t.databaseInfo);return function(s,a,c,u){return new of(s,a,c,u)}(t.authCredentials,t.appCheckCredentials,i,e)}createRemoteStore(t){return function(i,r,s,a,c){return new af(i,r,s,a,c)}(this.localStore,this.datastore,t.asyncQueue,e=>Fa(this.syncEngine,e,0),function(){return Na.D()?new Na:new Zp}())}createSyncEngine(t,e){return function(r,s,a,c,u,h,f){const y=new Tf(r,s,a,c,u,h);return f&&(y.Qa=!0),y}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,e)}async terminate(){var t,e;await async function(r){const s=U(r);z("RemoteStore","RemoteStore shutting down."),s.L_.add(5),await On(s),s.k_.shutdown(),s.q_.set("Unknown")}(this.remoteStore),(t=this.datastore)===null||t===void 0||t.terminate(),(e=this.eventManager)===null||e===void 0||e.terminate()}}no.provider={build:()=>new no};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $a{constructor(t){var e,i;if(t.host===void 0){if(t.ssl!==void 0)throw new F(N.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host="firestore.googleapis.com",this.ssl=!0}else this.host=t.host,this.ssl=(e=t.ssl)===null||e===void 0||e;if(this.credentials=t.credentials,this.ignoreUndefinedProperties=!!t.ignoreUndefinedProperties,this.localCache=t.localCache,t.cacheSizeBytes===void 0)this.cacheSizeBytes=41943040;else{if(t.cacheSizeBytes!==-1&&t.cacheSizeBytes<1048576)throw new F(N.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=t.cacheSizeBytes}$f("experimentalForceLongPolling",t.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",t.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!t.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:t.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!t.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=vc((i=t.experimentalLongPollingOptions)!==null&&i!==void 0?i:{}),function(s){if(s.timeoutSeconds!==void 0){if(isNaN(s.timeoutSeconds))throw new F(N.INVALID_ARGUMENT,`invalid long polling timeout: ${s.timeoutSeconds} (must not be NaN)`);if(s.timeoutSeconds<5)throw new F(N.INVALID_ARGUMENT,`invalid long polling timeout: ${s.timeoutSeconds} (minimum allowed value is 5)`);if(s.timeoutSeconds>30)throw new F(N.INVALID_ARGUMENT,`invalid long polling timeout: ${s.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!t.useFetchStreams}isEqual(t){return this.host===t.host&&this.ssl===t.ssl&&this.credentials===t.credentials&&this.cacheSizeBytes===t.cacheSizeBytes&&this.experimentalForceLongPolling===t.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===t.experimentalAutoDetectLongPolling&&function(i,r){return i.timeoutSeconds===r.timeoutSeconds}(this.experimentalLongPollingOptions,t.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===t.ignoreUndefinedProperties&&this.useFetchStreams===t.useFetchStreams}}class Ki{constructor(t,e,i,r){this._authCredentials=t,this._appCheckCredentials=e,this._databaseId=i,this._app=r,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new $a({}),this._settingsFrozen=!1,this._terminateTask="notTerminated"}get app(){if(!this._app)throw new F(N.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(t){if(this._settingsFrozen)throw new F(N.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new $a(t),t.credentials!==void 0&&(this._authCredentials=function(i){if(!i)return new ah;switch(i.type){case"firstParty":return new dh(i.sessionIndex||"0",i.iamToken||null,i.authTokenFactory||null);case"provider":return i.client;default:throw new F(N.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(t.credentials))}_getSettings(){return this._settings}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(e){const i=qa.get(e);i&&(z("ComponentProvider","Removing Datastore"),qa.delete(e),i.terminate())}(this),Promise.resolve()}}function Wf(n,t,e,i={}){var r;const s=(n=It(n,Ki))._getSettings(),a=`${t}:${e}`;if(s.host!=="firestore.googleapis.com"&&s.host!==a&&Oe("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),n._setSettings(Object.assign(Object.assign({},s),{host:a,ssl:!1})),i.mockUserToken){let c,u;if(typeof i.mockUserToken=="string")c=i.mockUserToken,u=vt.MOCK_USER;else{c=zu(i.mockUserToken,(r=n._app)===null||r===void 0?void 0:r.options.projectId);const h=i.mockUserToken.sub||i.mockUserToken.user_id;if(!h)throw new F(N.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");u=new vt(h)}n._authCredentials=new lh(new Al(c,u))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ue{constructor(t,e,i){this.converter=e,this._query=i,this.type="query",this.firestore=t}withConverter(t){return new ue(this.firestore,t,this._query)}}class bt{constructor(t,e,i){this.converter=e,this._key=i,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new oe(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new bt(this.firestore,t,this._key)}}class oe extends ue{constructor(t,e,i){super(t,e,Oi(i)),this._path=i,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new bt(this.firestore,null,new j(t))}withConverter(t){return new oe(this.firestore,t,this._path)}}function Tt(n,t,...e){if(n=Nt(n),Ac("collection","path",t),n instanceof Ki){const i=tt.fromString(t,...e);return Ua(i),new oe(n,null,i)}{if(!(n instanceof bt||n instanceof oe))throw new F(N.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=n._path.child(tt.fromString(t,...e));return Ua(i),new oe(n.firestore,null,i)}}function qt(n,t,...e){if(n=Nt(n),arguments.length===1&&(t=bl.newId()),Ac("doc","path",t),n instanceof Ki){const i=tt.fromString(t,...e);return Ha(i),new bt(n,null,new j(i))}{if(!(n instanceof bt||n instanceof oe))throw new F(N.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=n._path.child(tt.fromString(t,...e));return Ha(i),new bt(n.firestore,n instanceof oe?n.converter:null,new j(i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jn{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new F(N.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new dt(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bo{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new F(N.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new F(N.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return K(this._lat,t._lat)||K(this._long,t._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kf=/^__.*__$/;class Xf{constructor(t,e,i){this.data=t,this.fieldMask=e,this.fieldTransforms=i}toMutation(t,e){return this.fieldMask!==null?new ce(t,this.data,this.fieldMask,e,this.fieldTransforms):new Ln(t,this.data,e,this.fieldTransforms)}}class bc{constructor(t,e,i){this.data=t,this.fieldMask=e,this.fieldTransforms=i}toMutation(t,e){return new ce(t,this.data,this.fieldMask,e,this.fieldTransforms)}}function _c(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw q()}}class Mo{constructor(t,e,i,r,s,a){this.settings=t,this.databaseId=e,this.serializer=i,this.ignoreUndefinedProperties=r,s===void 0&&this.vu(),this.fieldTransforms=s||[],this.fieldMask=a||[]}get path(){return this.settings.path}get Cu(){return this.settings.Cu}Fu(t){return new Mo(Object.assign(Object.assign({},this.settings),t),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Mu(t){var e;const i=(e=this.path)===null||e===void 0?void 0:e.child(t),r=this.Fu({path:i,xu:!1});return r.Ou(t),r}Nu(t){var e;const i=(e=this.path)===null||e===void 0?void 0:e.child(t),r=this.Fu({path:i,xu:!1});return r.vu(),r}Lu(t){return this.Fu({path:void 0,xu:!0})}Bu(t){return Di(t,this.settings.methodName,this.settings.ku||!1,this.path,this.settings.qu)}contains(t){return this.fieldMask.find(e=>t.isPrefixOf(e))!==void 0||this.fieldTransforms.find(e=>t.isPrefixOf(e.field))!==void 0}vu(){if(this.path)for(let t=0;t<this.path.length;t++)this.Ou(this.path.get(t))}Ou(t){if(t.length===0)throw this.Bu("Document fields must not be empty");if(_c(this.Cu)&&Kf.test(t))throw this.Bu('Document fields cannot begin and end with "__"')}}class Jf{constructor(t,e,i){this.databaseId=t,this.ignoreUndefinedProperties=e,this.serializer=i||$i(t)}Qu(t,e,i,r=!1){return new Mo({Cu:t,methodName:e,qu:i,path:dt.emptyPath(),xu:!1,ku:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function qn(n){const t=n._freezeSettings(),e=$i(n._databaseId);return new Jf(n._databaseId,!!t.ignoreUndefinedProperties,e)}function Oo(n,t,e,i,r,s={}){const a=n.Qu(s.merge||s.mergeFields?2:0,t,e,r);zo("Data must be an object, but it was:",a,i);const c=Ic(i,a);let u,h;if(s.merge)u=new Pt(a.fieldMask),h=a.fieldTransforms;else if(s.mergeFields){const f=[];for(const y of s.mergeFields){const v=io(t,y,e);if(!a.contains(v))throw new F(N.INVALID_ARGUMENT,`Field '${v}' is specified in your field mask but missing from your input data.`);Tc(f,v)||f.push(v)}u=new Pt(f),h=a.fieldTransforms.filter(y=>u.covers(y.field))}else u=null,h=a.fieldTransforms;return new Xf(new xt(c),u,h)}class Ji extends Xi{_toFieldTransform(t){if(t.Cu!==2)throw t.Cu===1?t.Bu(`${this._methodName}() can only appear at the top level of your update data`):t.Bu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return t.fieldMask.push(t.path),null}isEqual(t){return t instanceof Ji}}class Fo extends Xi{_toFieldTransform(t){return new Kh(t.path,new Sn)}isEqual(t){return t instanceof Fo}}function wc(n,t,e,i){const r=n.Qu(1,t,e);zo("Data must be an object, but it was:",r,i);const s=[],a=xt.empty();Ee(i,(u,h)=>{const f=jo(t,u,e);h=Nt(h);const y=r.Nu(f);if(h instanceof Ji)s.push(f);else{const v=Hn(h,y);v!=null&&(s.push(f),a.set(f,v))}});const c=new Pt(s);return new bc(a,c,r.fieldTransforms)}function Ec(n,t,e,i,r,s){const a=n.Qu(1,t,e),c=[io(t,i,e)],u=[r];if(s.length%2!=0)throw new F(N.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let v=0;v<s.length;v+=2)c.push(io(t,s[v])),u.push(s[v+1]);const h=[],f=xt.empty();for(let v=c.length-1;v>=0;--v)if(!Tc(h,c[v])){const I=c[v];let k=u[v];k=Nt(k);const T=a.Nu(I);if(k instanceof Ji)h.push(I);else{const g=Hn(k,T);g!=null&&(h.push(I),f.set(I,g))}}const y=new Pt(h);return new bc(f,y,a.fieldTransforms)}function Zf(n,t,e,i=!1){return Hn(e,n.Qu(i?4:3,t))}function Hn(n,t){if(xc(n=Nt(n)))return zo("Unsupported field value:",t,n),Ic(n,t);if(n instanceof Xi)return function(i,r){if(!_c(r.Cu))throw r.Bu(`${i._methodName}() can only be used with update() and set()`);if(!r.path)throw r.Bu(`${i._methodName}() is not currently supported inside arrays`);const s=i._toFieldTransform(r);s&&r.fieldTransforms.push(s)}(n,t),null;if(n===void 0&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),n instanceof Array){if(t.settings.xu&&t.Cu!==4)throw t.Bu("Nested arrays are not supported");return function(i,r){const s=[];let a=0;for(const c of i){let u=Hn(c,r.Lu(a));u==null&&(u={nullValue:"NULL_VALUE"}),s.push(u),a++}return{arrayValue:{values:s}}}(n,t)}return function(i,r){if((i=Nt(i))===null)return{nullValue:"NULL_VALUE"};if(typeof i=="number")return Wh(r.serializer,i);if(typeof i=="boolean")return{booleanValue:i};if(typeof i=="string")return{stringValue:i};if(i instanceof Date){const s=at.fromDate(i);return{timestampValue:Ci(r.serializer,s)}}if(i instanceof at){const s=new at(i.seconds,1e3*Math.floor(i.nanoseconds/1e3));return{timestampValue:Ci(r.serializer,s)}}if(i instanceof Bo)return{geoPointValue:{latitude:i.latitude,longitude:i.longitude}};if(i instanceof Ue)return{bytesValue:Wl(r.serializer,i._byteString)};if(i instanceof bt){const s=r.databaseId,a=i.firestore._databaseId;if(!a.isEqual(s))throw r.Bu(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${s.projectId}/${s.database}`);return{referenceValue:Ao(i.firestore._databaseId||r.databaseId,i._key.path)}}if(i instanceof Lo)return function(a,c){return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:a.toArray().map(u=>{if(typeof u!="number")throw c.Bu("VectorValues must only contain numeric values.");return go(c.serializer,u)})}}}}}}(i,r);throw r.Bu(`Unsupported field value: ${Gi(i)}`)}(n,t)}function Ic(n,t){const e={};return _l(n)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):Ee(n,(i,r)=>{const s=Hn(r,t.Mu(i));s!=null&&(e[i]=s)}),{mapValue:{fields:e}}}function xc(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof at||n instanceof Bo||n instanceof Ue||n instanceof bt||n instanceof Xi||n instanceof Lo)}function zo(n,t,e){if(!xc(e)||!function(r){return typeof r=="object"&&r!==null&&(Object.getPrototypeOf(r)===Object.prototype||Object.getPrototypeOf(r)===null)}(e)){const i=Gi(e);throw i==="an object"?t.Bu(n+" a custom object"):t.Bu(n+" "+i)}}function io(n,t,e){if((t=Nt(t))instanceof jn)return t._internalPath;if(typeof t=="string")return jo(n,t);throw Di("Field path arguments must be of type string or ",n,!1,void 0,e)}const Yf=new RegExp("[~\\*/\\[\\]]");function jo(n,t,e){if(t.search(Yf)>=0)throw Di(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,e);try{return new jn(...t.split("."))._internalPath}catch{throw Di(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,e)}}function Di(n,t,e,i,r){const s=i&&!i.isEmpty(),a=r!==void 0;let c=`Function ${t}() called with invalid data`;e&&(c+=" (via `toFirestore()`)"),c+=". ";let u="";return(s||a)&&(u+=" (found",s&&(u+=` in field ${i}`),a&&(u+=` in document ${r}`),u+=")"),new F(N.INVALID_ARGUMENT,c+n+u)}function Tc(n,t){return n.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cc(n){if(n.limitType==="L"&&n.explicitOrderBy.length===0)throw new F(N.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Ho{}class Pc extends Ho{}function Zi(n,t,...e){let i=[];t instanceof Ho&&i.push(t),i=i.concat(e),function(s){const a=s.filter(u=>u instanceof $o).length,c=s.filter(u=>u instanceof Uo).length;if(a>1||a>0&&c>0)throw new F(N.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(i);for(const r of i)n=r._apply(n);return n}class Uo extends Pc{constructor(t,e,i){super(),this._field=t,this._op=e,this._value=i,this.type="where"}static _create(t,e,i){return new Uo(t,e,i)}_apply(t){const e=this._parse(t);return Sc(t._query,e),new ue(t.firestore,t.converter,Qr(t._query,e))}_parse(t){const e=qn(t.firestore);return function(s,a,c,u,h,f,y){let v;if(h.isKeyField()){if(f==="array-contains"||f==="array-contains-any")throw new F(N.INVALID_ARGUMENT,`Invalid Query. You can't perform '${f}' queries on documentId().`);if(f==="in"||f==="not-in"){Ka(y,f);const I=[];for(const k of y)I.push(Ga(u,s,k));v={arrayValue:{values:I}}}else v=Ga(u,s,y)}else f!=="in"&&f!=="not-in"&&f!=="array-contains-any"||Ka(y,f),v=Zf(c,a,y,f==="in"||f==="not-in");return st.create(h,f,v)}(t._query,"where",e,t.firestore._databaseId,this._field,this._op,this._value)}}class $o extends Ho{constructor(t,e){super(),this.type=t,this._queryConstraints=e}static _create(t,e){return new $o(t,e)}_parse(t){const e=this._queryConstraints.map(i=>i._parse(t)).filter(i=>i.getFilters().length>0);return e.length===1?e[0]:Mt.create(e,this._getOperator())}_apply(t){const e=this._parse(t);return e.getFilters().length===0?t:(function(r,s){let a=r;const c=s.getFlattenedFilters();for(const u of c)Sc(a,u),a=Qr(a,u)}(t._query,e),new ue(t.firestore,t.converter,Qr(t._query,e)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}}class Wo extends Pc{constructor(t,e){super(),this._field=t,this._direction=e,this.type="orderBy"}static _create(t,e){return new Wo(t,e)}_apply(t){const e=function(r,s,a){if(r.startAt!==null)throw new F(N.INVALID_ARGUMENT,"Invalid query. You must not call startAt() or startAfter() before calling orderBy().");if(r.endAt!==null)throw new F(N.INVALID_ARGUMENT,"Invalid query. You must not call endAt() or endBefore() before calling orderBy().");return new Pn(s,a)}(t._query,this._field,this._direction);return new ue(t.firestore,t.converter,function(r,s){const a=r.explicitOrderBy.concat([s]);return new Qe(r.path,r.collectionGroup,a,r.filters.slice(),r.limit,r.limitType,r.startAt,r.endAt)}(t._query,e))}}function Yi(n,t="asc"){const e=t,i=qo("orderBy",n);return Wo._create(i,e)}function Ga(n,t,e){if(typeof(e=Nt(e))=="string"){if(e==="")throw new F(N.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!Sl(t)&&e.indexOf("/")!==-1)throw new F(N.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${e}' contains a '/' character.`);const i=t.path.child(tt.fromString(e));if(!j.isDocumentKey(i))throw new F(N.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${i}' is not because it has an odd number of segments (${i.length}).`);return ma(n,new j(i))}if(e instanceof bt)return ma(n,e._key);throw new F(N.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Gi(e)}.`)}function Ka(n,t){if(!Array.isArray(n)||n.length===0)throw new F(N.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${t.toString()}' filters.`)}function Sc(n,t){const e=function(r,s){for(const a of r)for(const c of a.getFlattenedFilters())if(s.indexOf(c.op)>=0)return c.op;return null}(n.filters,function(r){switch(r){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(t.op));if(e!==null)throw e===t.op?new F(N.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${t.op.toString()}' filter.`):new F(N.INVALID_ARGUMENT,`Invalid query. You cannot use '${t.op.toString()}' filters with '${e.toString()}' filters.`)}class em{convertValue(t,e="none"){switch(we(t)){case 0:return null;case 1:return t.booleanValue;case 2:return rt(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,e);case 5:return t.stringValue;case 6:return this.convertBytes(_e(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,e);case 11:return this.convertObject(t.mapValue,e);case 10:return this.convertVectorValue(t.mapValue);default:throw q()}}convertObject(t,e){return this.convertObjectMap(t.fields,e)}convertObjectMap(t,e="none"){const i={};return Ee(t,(r,s)=>{i[r]=this.convertValue(s,e)}),i}convertVectorValue(t){var e,i,r;const s=(r=(i=(e=t.fields)===null||e===void 0?void 0:e.value.arrayValue)===null||i===void 0?void 0:i.values)===null||r===void 0?void 0:r.map(a=>rt(a.doubleValue));return new Lo(s)}convertGeoPoint(t){return new Bo(rt(t.latitude),rt(t.longitude))}convertArray(t,e){return(t.values||[]).map(i=>this.convertValue(i,e))}convertServerTimestamp(t,e){switch(e){case"previous":const i=ho(t);return i==null?null:this.convertValue(i,e);case"estimate":return this.convertTimestamp(Tn(t));default:return null}}convertTimestamp(t){const e=ae(t);return new at(e.seconds,e.nanos)}convertDocumentKey(t,e){const i=tt.fromString(t);X(Zl(i));const r=new Rn(i.get(1),i.get(3)),s=new j(i.popFirst(5));return r.isEqual(e)||Kt(`Document ${s} contains a document reference within a different database (${r.projectId}/${r.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qo(n,t,e){let i;return i=n?e&&(e.merge||e.mergeFields)?n.toFirestore(t,e):n.toFirestore(t):t,i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vn{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class Vc extends Rc{constructor(t,e,i,r,s,a){super(t,e,i,r,a),this._firestore=t,this._firestoreImpl=t,this.metadata=s}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new _i(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const i=this._document.data.field(qo("DocumentSnapshot.get",t));if(i!==null)return this._userDataWriter.convertValue(i,e.serverTimestamps)}}}class _i extends Vc{data(t={}){return super.data(t)}}class Dc{constructor(t,e,i,r){this._firestore=t,this._userDataWriter=e,this._snapshot=r,this.metadata=new vn(r.hasPendingWrites,r.fromCache),this.query=i}get docs(){const t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(t,e){this._snapshot.docs.forEach(i=>{t.call(e,new _i(this._firestore,this._userDataWriter,i.key,i,new vn(this._snapshot.mutatedKeys.has(i.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new F(N.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(r,s){if(r._snapshot.oldDocs.isEmpty()){let a=0;return r._snapshot.docChanges.map(c=>{const u=new _i(r._firestore,r._userDataWriter,c.doc.key,c.doc,new vn(r._snapshot.mutatedKeys.has(c.doc.key),r._snapshot.fromCache),r.query.converter);return c.doc,{type:"added",doc:u,oldIndex:-1,newIndex:a++}})}{let a=r._snapshot.oldDocs;return r._snapshot.docChanges.filter(c=>s||c.type!==3).map(c=>{const u=new _i(r._firestore,r._userDataWriter,c.doc.key,c.doc,new vn(r._snapshot.mutatedKeys.has(c.doc.key),r._snapshot.fromCache),r.query.converter);let h=-1,f=-1;return c.type!==0&&(h=a.indexOf(c.doc.key),a=a.delete(c.doc.key)),c.type!==1&&(a=a.add(c.doc),f=a.indexOf(c.doc.key)),{type:nm(c.type),doc:u,oldIndex:h,newIndex:f}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}}function nm(n){switch(n){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return q()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kc(n){n=It(n,bt);const t=It(n.firestore,jt);return Hf(zn(t),n._key).then(e=>Lc(t,n,e))}class Go extends em{constructor(t){super(),this.firestore=t}convertBytes(t){return new Ue(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new bt(this.firestore,null,e)}}function Un(n){n=It(n,ue);const t=It(n.firestore,jt),e=zn(t),i=new Go(t);return Cc(n._query),Uf(e,n._query).then(r=>new Dc(t,i,n,r))}function Xa(n,t,e){n=It(n,bt);const i=It(n.firestore,jt),r=Qo(n.converter,t,e);return $n(i,[Oo(qn(i),"setDoc",n._key,r,n.converter!==null,e).toMutation(n._key,Et.none())])}function Xe(n,t,e,...i){n=It(n,bt);const r=It(n.firestore,jt),s=qn(r);let a;return a=typeof(t=Nt(t))=="string"||t instanceof jn?Ec(s,"updateDoc",n._key,t,e,i):wc(s,"updateDoc",n._key,t),$n(r,[a.toMutation(n._key,Et.exists(!0))])}function Nc(n){return $n(It(n.firestore,jt),[new Hi(n._key,Et.none())])}function Bc(n,t){const e=It(n.firestore,jt),i=qt(n),r=Qo(n.converter,t);return $n(e,[Oo(qn(n.firestore),"addDoc",i._key,r,n.converter!==null,{}).toMutation(i._key,Et.exists(!1))]).then(()=>i)}function Je(n,...t){var e,i,r;n=Nt(n);let s={includeMetadataChanges:!1,source:"default"},a=0;typeof t[a]!="object"||Qa(t[a])||(s=t[a],a++);const c={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(Qa(t[a])){const y=t[a];t[a]=(e=y.next)===null||e===void 0?void 0:e.bind(y),t[a+1]=(i=y.error)===null||i===void 0?void 0:i.bind(y),t[a+2]=(r=y.complete)===null||r===void 0?void 0:r.bind(y)}let u,h,f;if(n instanceof bt)h=It(n.firestore,jt),f=Oi(n._key.path),u={next:y=>{t[a]&&t[a](Lc(h,n,y))},error:t[a+1],complete:t[a+2]};else{const y=It(n,ue);h=It(y.firestore,jt),f=y._query;const v=new Go(h);u={next:I=>{t[a]&&t[a](new Dc(h,v,y,I))},error:t[a+1],complete:t[a+2]},Cc(n._query)}return function(v,I,k,T){const g=new No(T),x=new Do(I,g,k);return v.asyncQueue.enqueueAndForget(async()=>Po(await Vi(v),x)),()=>{g.Za(),v.asyncQueue.enqueueAndForget(async()=>So(await Vi(v),x))}}(zn(h),f,c,u)}function $n(n,t){return function(i,r){const s=new Qt;return i.asyncQueue.enqueueAndForget(async()=>Df(await qf(i),r,s)),s.promise}(zn(n),t)}function Lc(n,t,e){const i=e.docs.get(t._key),r=new Go(n);return new Vc(n,r,t._key,i,new vn(e.hasPendingWrites,e.fromCache),t.converter)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class im{constructor(t,e){this._firestore=t,this._commitHandler=e,this._mutations=[],this._committed=!1,this._dataReader=qn(t)}set(t,e,i){this._verifyNotCommitted();const r=Dr(t,this._firestore),s=Qo(r.converter,e,i),a=Oo(this._dataReader,"WriteBatch.set",r._key,s,r.converter!==null,i);return this._mutations.push(a.toMutation(r._key,Et.none())),this}update(t,e,i,...r){this._verifyNotCommitted();const s=Dr(t,this._firestore);let a;return a=typeof(e=Nt(e))=="string"||e instanceof jn?Ec(this._dataReader,"WriteBatch.update",s._key,e,i,r):wc(this._dataReader,"WriteBatch.update",s._key,e),this._mutations.push(a.toMutation(s._key,Et.exists(!0))),this}delete(t){this._verifyNotCommitted();const e=Dr(t,this._firestore);return this._mutations=this._mutations.concat(new Hi(e._key,Et.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new F(N.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function Dr(n,t){if((n=Nt(n)).firestore!==t)throw new F(N.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return n}function Mc(){return new Fo("serverTimestamp")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function Ko(n){return zn(n=It(n,jt)),new im(n,t=>$n(n,t))}(function(t,e=!0){(function(r){We=r})(Gd),Ii(new En("firestore",(i,{instanceIdentifier:r,options:s})=>{const a=i.getProvider("app").getImmediate(),c=new jt(new ch(i.getProvider("auth-internal")),new ph(i.getProvider("app-check-internal")),function(h,f){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new F(N.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Rn(h.options.projectId,f)}(a,r),a);return s=Object.assign({useFetchStreams:e},s),c._setSettings(s),c},"PUBLIC").setMultipleInstances(!0)),Le(ua,"4.7.3",t),Le(ua,"4.7.3","esm2017")})();const rm={apiKey:"AIzaSyCs0qf02HaIv0-aAe7wVntfosDL1SjdOws",authDomain:"feria-vinos-sucovi-2027.firebaseapp.com",databaseURL:"https://feria-vinos-sucovi-2027-default-rtdb.firebaseio.com",projectId:"feria-vinos-sucovi-2027",storageBucket:"feria-vinos-sucovi-2027.firebasestorage.app",messagingSenderId:"1686119758",appId:"1:1686119758:web:2c3c6d96e36f1276052a1f",measurementId:"G-VRMTQ3SS7E"},om=ul(rm),et=Qf(om),Ae=[{id:0,key:"368813",nombre:"Sucovi",region:"Pruebas / Bebidas",pass:"stand00"},{id:1,key:"d48429",nombre:"Alta Vista",region:"Mendoza",pass:"stand01"},{id:2,key:"ba356c",nombre:"Andillian",region:"Mendoza",pass:"stand02"},{id:3,key:"451e62",nombre:"Ante Nada",region:"Mendoza",pass:"stand03"},{id:4,key:"835c2d",nombre:"Bodega Benegas",region:"Mendoza",pass:"stand04"},{id:5,key:"e45a28",nombre:"Bianchi",region:"San Rafael",pass:"stand05"},{id:6,key:"12ac1c",nombre:"Catena Zapata",region:"Luján de Cuyo",pass:"stand06"},{id:7,key:"18abc3",nombre:"Bodegas Bórbore",region:"Mendoza (1936)",pass:"stand07"},{id:8,key:"452b71",nombre:"Fábula Wines",region:"Mendoza",pass:"stand08"},{id:9,key:"0c55a5",nombre:"Finca Iral",region:"Mendoza",pass:"stand09"},{id:10,key:"5cb108",nombre:"Giménez Riili",region:"Mendoza",pass:"stand10"},{id:11,key:"27f372",nombre:"Jorge Rubio",region:"Mendoza",pass:"stand11"},{id:12,key:"a9d27f",nombre:"La Coste de los Andes",region:"Mendoza",pass:"stand12"},{id:13,key:"b5be6e",nombre:"Las Perdices",region:"Mendoza",pass:"stand13"},{id:14,key:"7da93b",nombre:"Lorenzo de Agrelo",region:"Mendoza",pass:"stand14"},{id:15,key:"f52ab4",nombre:"Pannunzio Wines",region:"Mendoza",pass:"stand15"},{id:16,key:"a32dd6",nombre:"Bodega Patritti",region:"Mendoza",pass:"stand16"},{id:17,key:"175358",nombre:"Rosell Boher",region:"Mendoza",pass:"stand17"},{id:18,key:"4a2b00",nombre:"Valle de la Puerta",region:"La Rioja",pass:"stand18"}];async function ki(n){return await Bc(Tt(et,"invitados"),{...n,creadoEn:Mc()})}async function ye(n,t){await Xe(qt(et,"invitados",n),t)}function Wn(n){return Je(Zi(Tt(et,"invitados"),Yi("creadoEn","desc")),t=>n(t.docs.map(e=>({fireId:e.id,...e.data()}))))}async function Ni(n){const e=(await Un(Tt(et,"invitados"))).docs.find(i=>i.data().token===n);return e?{fireId:e.id,...e.data()}:null}async function sm(n){const e=(await Un(Tt(et,"invitados"))).docs.find(i=>i.data().codigo===n);return e?{fireId:e.id,...e.data()}:null}async function Oc(n,t,e,i,r){const s=qt(et,"carritos",n,"items",String(t)),a=await kc(s);if(a.exists()){const c=a.data(),u=c.items||[],h=u.findIndex(f=>f.key===i.key);h>=0?u[h]=i:u.push(i),await Xa(s,{standId:t,standNombre:e,items:u,retiro:r||c.retiro||"stand"})}else await Xa(s,{standId:t,standNombre:e,items:[i],retiro:r||"stand"})}async function Xo(n,t,e){await Xe(qt(et,"carritos",n,"items",String(t)),{retiro:e})}async function Bi(n,t,e){const i=qt(et,"carritos",n,"items",String(t)),r=await kc(i);if(!r.exists())return;const s=(r.data().items||[]).filter(a=>a.key!==e);s.length?await Xe(i,{items:s}):await Nc(i)}async function ro(n){return(await Un(Tt(et,"carritos",n,"items"))).docs.map(e=>({standId:e.id,...e.data()}))}function Jo(n,t){return Je(Tt(et,"carritos",n,"items"),e=>t(e.docs.map(i=>({standDocId:i.id,...i.data()}))))}async function Fc(n){const t=await Un(Tt(et,"carritos",n,"items")),e=Ko(et);t.docs.forEach(i=>e.delete(i.ref)),await e.commit()}async function zc(n,t){const e=Ko(et),i=[];return t.forEach(r=>{const s=qt(Tt(et,"pedidos"));i.push(s),e.set(s,{invFireId:n.fireId,invNombre:n.nombre+" "+n.apellido,invCodigo:n.codigo,standId:r.standId,standNombre:r.standNombre,items:r.items||[],total:(r.items||[]).reduce((a,c)=>a+(c.sub||0),0),retiro:r.retiro||"stand",estado:"pagado",creadoEn:Mc()})}),await e.commit(),i.map(r=>r.id)}function tr(n){return Je(Zi(Tt(et,"pedidos"),Yi("creadoEn","desc")),t=>n(t.docs.map(e=>({fireId:e.id,...e.data()}))))}function jc(n,t){return Je(Zi(Tt(et,"pedidos"),Yi("creadoEn","desc")),e=>t(e.docs.map(i=>({fireId:i.id,...i.data()})).filter(i=>Number(i.standId)===Number(n))))}function qc(n,t){return Je(Zi(Tt(et,"pedidos"),Yi("creadoEn","desc")),e=>t(e.docs.map(i=>({fireId:i.id,...i.data()})).filter(i=>i.invFireId===n)))}async function Hc(n){await Xe(qt(et,"pedidos",n),{estado:"entregado"})}async function Uc(n,t){const e={pendiente:"pagado",pagado:"listo",listo:"entregado"};e[t]&&await Xe(qt(et,"pedidos",n),{estado:e[t]})}function Zo(n,t){return Je(Tt(et,"bodegas",String(n),"vinos"),e=>t(e.docs.map(i=>({fireId:i.id,...i.data()}))))}async function $c(n,t){return await Bc(Tt(et,"bodegas",String(n),"vinos"),t)}async function Wc(n,t,e){await Xe(qt(et,"bodegas",String(n),"vinos",t),e)}async function Qc(n,t){await Nc(qt(et,"bodegas",String(n),"vinos",t))}async function Gc(){const n=["invitados","pedidos"];for(const t of n){const e=await Un(Tt(et,t)),i=Ko(et);e.docs.forEach(r=>i.delete(r.ref)),await i.commit()}}const Li=Object.freeze(Object.defineProperty({__proto__:null,BODEGAS:Ae,actualizarInvitado:ye,actualizarRetiroStand:Xo,actualizarVino:Wc,agregarAlCarrito:Oc,avanzarEstado:Uc,buscarInvitadoPorCodigo:sm,buscarInvitadoPorToken:Ni,crearInvitado:ki,crearPedidosDesdeCarrito:zc,eliminarItemCarrito:Bi,eliminarVino:Qc,escucharCarrito:Jo,escucharInvitados:Wn,escucharPedidos:tr,escucharPedidosPorInvitado:qc,escucharPedidosPorStand:jc,escucharVinos:Zo,guardarVino:$c,leerCarrito:ro,limpiarDatosPrueba:Gc,marcarEntregado:Hc,vaciarCarrito:Fc},Symbol.toStringTag,{value:"Module"})),am="modulepreload",lm=function(n){return"/"+n},Ja={},kn=function(t,e,i){let r=Promise.resolve();if(e&&e.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),c=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(e.map(u=>{if(u=lm(u),u in Ja)return;Ja[u]=!0;const h=u.endsWith(".css"),f=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${f}`))return;const y=document.createElement("link");if(y.rel=h?"stylesheet":am,h||(y.as="script"),y.crossOrigin="",y.href=u,c&&y.setAttribute("nonce",c),document.head.appendChild(y),h)return new Promise((v,I)=>{y.addEventListener("load",v),y.addEventListener("error",()=>I(new Error(`Unable to preload CSS for ${u}`)))})}))}function s(a){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=a,window.dispatchEvent(c),!c.defaultPrevented)throw a}return r.then(a=>{for(const c of a||[])c.status==="rejected"&&s(c.reason);return t().catch(s)})},Yo="data:image/png;base64,";function kt({title:n,sub:t="",backHref:e="",backLabel:i="← Panel",actions:r=[]}={}){return`
  ...
  `,document.head.appendChild(n)}async function cm(){window.qrcode||await new Promise((n,t)=>{const e=document.createElement("script");e.src="https://cdn.jsdelivr.net/npm/qrcode-generator@1.4.4/qrcode.min.js",e.onload=n,e.onerror=t,document.head.appendChild(e)})}async function Za(n,t,e){await cm();const i=document.getElementById(n);if(i)try{const r=qrcode(0,"M");r.addData(String(t)),r.make();const s=r.getModuleCount(),a=e/s;i.width=e,i.height=e;const c=i.getContext("2d");c.fillStyle="#fff",c.fillRect(0,0,e,e),c.fillStyle="#000";for(let u=0;u<s;u++)for(let h=0;h<s;h++)r.isDark(u,h)&&c.fillRect(h*a,u*a,a,a)}catch(r){console.error("QR error:",r)}}const gi=n=>Number(n).toLocaleString("es-AR"),Ya=()=>Math.random().toString(36).slice(2,10).toUpperCase(),tl=n=>"INV-"+String(n).padStart(4,"0");function el(n){return{pendiente:'<span class="badge b-pend">Pendiente</span>',pagado:'<span class="badge b-pago">Bono pagado</span>',ingresado:'<span class="badge b-ingr">Ingresó</span>',invalidado:'<span class="badge b-inv">Invalidado</span>'}[n]||""}const um={pendiente:"Pendiente",pagado:"Pagado",listo:"Listo",entregado:"Entregado"},dm={pendiente:"b-pend",pagado:"b-pago",listo:"b-list",entregado:"b-entr"};function hm(n){Ht();let t=[],e=[],i="inv",r=null;n.innerHTML=kt({title:"Sucovi 2027",sub:"20 jun 2026 · 19:30 hs · Roma 656, Olivos"})+`
    ...
    <div id="modal-wa" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;
      ...
      <div class="card" style="width:100%;max-width:380px;max-height:90vh;overflow-y:auto">
    ...
    </div>`,Wn(T=>{t=T,i==="inv"&&s(),i==="res"&&y()}),tr(T=>{e=T,i==="ped"&&h(),i==="res"&&y()}),window._aTab=(T,g)=>{var P;i=T,document.querySelectorAll(".nav button").forEach(B=>B.classList.remove("on")),g.classList.add("on");const x={inv:s,reg:a,excel:c,ped:h,stands:f,res:y,config:v};(P=x[T])==null||P.call(x)};function s(){const T=document.getElementById("tab-content");document.getElementById("buscar-inv")||(T.innerHTML=`
        ...
        <div class="card" id="lista-inv"></div>`),window._fInv=()=>{var S,M;const g=(((S=document.getElementById("buscar-inv"))==null?void 0:S.value)||"").toLowerCase(),x=((M=document.getElementById("fil-est"))==null?void 0:M.value)||"",P=t.filter(D=>(D.nombre+" "+D.apellido+" "+(D.codigo||"")+" "+(D.familia||"")).toLowerCase().includes(g)&&(!x||D.estado===x)),B=document.getElementById("lista-inv");if(B){if(!P.length){B.innerHTML='<div class="empty">Sin resultados</div>';return}B.innerHTML=P.map(D=>{var _,m;return`
        <div class="row" style="${D.estado==="invalidado"?"opacity:.5":""}">
          <div class="avatar">${((_=D.nombre)==null?void 0:_[0])||"?"}${((m=D.apellido)==null?void 0:m[0])||""}</div>
        ...
        </div>`}).join("")}},window._fInv()}window._invalidar=async(T,g)=>{confirm(`¿Invalidar a ${g}?`)&&await ye(T,{estado:"invalidado"})},window._reactivar=async T=>await ye(T,{estado:"pendiente"});function a(){document.getElementById("tab-content").innerHTML=`
      ...
      </div>`}window._registrar=async()=>{const T=document.getElementById("rn").value.trim(),g=document.getElementById("ra").value.trim(),x=document.getElementById("rt").value.trim(),P=document.querySelector('input[name="rp"]:checked').value,B=document.getElementById("reg-msg");if(!T||!g||!x){B.innerHTML='<span style="color:#A32D2D">Nombre, apellido y WhatsApp son obligatorios.</span>';return}B.innerHTML='<span style="color:#888">Guardando...</span>';try{const S=tl(t.length+1),M=Ya(),D=await ki({nombre:T,apellido:g,tel:x,...document.getElementById("re").value.trim()&&{email:document.getElementById("re").value.trim()},...document.getElementById("rf").value.trim()&&{familia:document.getElementById("rf").value.trim()},...document.getElementById("rc").value.trim()&&{comentarios:document.getElementById("rc").value.trim()},estado:P,codigo:S,token:M});B.innerHTML=`<span style="color:#3B6D11">✓ ${T} ${g} (${S})</span>`,["rn","ra","rt","re","rf","rc"].forEach(_=>{const m=document.getElementById(_);m&&(m.value="")}),P==="pagado"&&setTimeout(()=>window._abrirWA(D.id),600)}catch(S){B.innerHTML=`<span style="color:#A32D2D">Error: ${S.message}</span>`}};function c(){document.getElementById("tab-content").innerHTML=`
      <div class="card" style="max-width:540px">
      ...
      </div>`}let u=[];window._procesarExcel=async T=>{const g=T.files[0];if(!g)return;const x=document.getElementById("excel-preview");x.innerHTML='<p style="font-size:12px;color:#888">Procesando...</p>';try{const P=await kn(()=>import("https://cdn.sheetjs.com/xlsx-0.20.0/package/xlsx.mjs"),[]),B=await g.arrayBuffer(),S=P.read(B),M=S.Sheets[S.SheetNames[0]],D=P.utils.sheet_to_json(M,{header:1}),_=typeof D[0][0]=="string"&&D[0][0].toLowerCase().includes("nombre")?1:0;u=D.slice(_).filter(m=>m[0]&&m[1]&&m[2]).map(m=>({nombre:String(m[0]||"").trim(),apellido:String(m[1]||"").trim(),tel:String(m[2]||"").trim(),...m[3]?{email:String(m[3]).trim()}:{},...m[4]?{familia:String(m[4]).trim()}:{},...m[5]?{comentarios:String(m[5]).trim()}:{},estado:String(m[6]||"").toUpperCase()==="SI"?"pagado":"pendiente"})),x.innerHTML=`
        ...
        </div>`,document.getElementById("btn-importar").style.display="block"}catch(P){x.innerHTML=`<p style="color:#A32D2D;font-size:12px">Error al leer el archivo: ${P.message}</p>`}},window._importarExcel=async()=>{if(!u.length)return;const T=document.getElementById("btn-importar"),g=document.getElementById("excel-msg");T.disabled=!0,T.textContent="Importando...",g.innerHTML='<span style="color:#888">Procesando...</span>';let x=0,P=0;const B=t.length;for(let S=0;S<u.length;S++)try{const M=u[S];await ki({...M,codigo:tl(B+S+1),token:Ya()}),x++}catch{P++}g.innerHTML=`<span style="color:#3B6D11">✓ ${x} invitados importados${P?` (${P} errores)`:""}</span>`,T.style.display="none",u=[]};function h(){const T=document.getElementById("tab-content");if(!e.length){T.innerHTML='<div class="empty">Sin pedidos aún 🍷</div>';return}T.innerHTML=e.map(g=>{var x;return`
      <div class="card" style="margin-bottom:8px;display:flex;align-items:center;gap:8px;flex-wrap:wrap">
        <span style="font-size:13px;font-weight:500;color:#6B1C1C;min-width:52px">#${(x=g.fireId)==null?void 0:x.slice(-4).toUpperCase()}</span>
        <div style="flex:1;min-width:90px">
          <div style="font-size:12px;font-weight:500">${g.invNombre||""}</div>
          <div style="font-size:11px;color:#888">${g.standNombre}${g.retiro==="envio"?' · <span style="color:#5A1E99">Envío</span>':""}</div>
        </div>
        <span style="font-size:12px;color:#666;flex:2;min-width:100px">${(g.items||[]).map(P=>P.desc).join(" · ")}</span>
        <span style="font-size:14px;font-weight:500">$${gi(g.total||0)}</span>
        <span class="badge ${dm[g.estado]}">${um[g.estado]}</span>
      </div>`}).join("")}function f(){const T=window.location.origin;document.getElementById("tab-content").innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(175px,1fr));gap:10px">
        ${Ae.map(g=>`
          <div class="card" style="text-align:center">
            <div style="font-size:11px;color:#aaa;margin-bottom:2px">Stand #${g.id}</div>
            <div style="font-size:13px;font-weight:600;color:#6B1C1C;margin-bottom:2px">${g.nombre}</div>
            <div style="font-size:11px;color:#aaa;margin-bottom:8px">${g.region}</div>
            <canvas id="qr-s${g.id}" width="110" height="110" style="display:block;margin:0 auto 6px;border-radius:4px"></canvas>
            <div style="font-size:10px;color:#aaa;margin-bottom:8px;word-break:break-all">${T}/stand/${g.id}</div>
            <div style="display:flex;flex-direction:column;gap:5px">
              <a href="${T}/stand/${g.id}" target="_blank" class="btn btn-v" style="font-size:11px;padding:5px;text-decoration:none">Vista cliente</a>
              <div style="display:flex;gap:4px">
                <a href="${T}/panel/${g.id}?key=${g.key}" target="_blank" class="btn btn-b" style="font-size:11px;padding:5px;text-decoration:none;flex:1;justify-content:center">Panel</a>
                <button class="btn" style="font-size:11px;padding:5px;color:#185FA5;border-color:#185FA5"
                  onclick="navigator.clipboard?.writeText('${T}/panel/${g.id}?key=${g.key}').then(()=>{this.textContent='✓';setTimeout(()=>this.textContent='📋',1500)}).catch(()=>{})">📋</button>
              </div>
              <div style="display:flex;gap:4px">
                <a href="${T}/bodega/${g.id}/vinos?key=${g.key}" target="_blank" class="btn" style="font-size:11px;padding:5px;text-decoration:none;color:#3A7D44;border-color:#3A7D44;flex:1;justify-content:center">Vinos</a>
                <button class="btn" style="font-size:11px;padding:5px;color:#3A7D44;border-color:#3A7D44"
                  onclick="navigator.clipboard?.writeText('${T}/bodega/${g.id}/vinos?key=${g.key}').then(()=>{this.textContent='✓';setTimeout(()=>this.textContent='📋',1500)}).catch(()=>{})">📋</button>
              </div>
              <div style="font-size:10px;color:#aaa;margin-top:2px">Pass: <strong>${g.pass}</strong></div>
            </div>
          </div>`).join("")}
      </div>`,Ae.forEach(g=>setTimeout(()=>Za("qr-s"+g.id,`${T}/stand/${g.id}`,110),50))}function y(){const T=t.filter(M=>M.estado==="pagado").length,g=t.filter(M=>M.estado==="ingresado").length,x=(T+g)*35e3,P=e.reduce((M,D)=>M+(D.total||0),0),B={};e.forEach(M=>{B[M.standId]||(B[M.standId]={n:M.standNombre,t:0,c:0}),B[M.standId].t+=M.total||0,B[M.standId].c++});const S=Object.values(B).sort((M,D)=>D.t-M.t);document.getElementById("tab-content").innerHTML=`
      <div class="stats">
        ${[[t.filter(M=>M.estado!=="invalidado").length,"Invitados"],[T+g,"Con bono"],["$"+gi(x),"Bonos"],[e.length,"Pedidos"],["$"+gi(P),"Ventas"],[e.filter(M=>M.retiro==="envio").length,"Envíos"]].map(([M,D])=>`<div class="stat"><div class="v" style="font-size:${String(M).length>7?"13px":"20px"}">${M}</div><div class="l">${D}</div></div>`).join("")}
      </div>
      <div class="card">
      ...
      </div>`}function v(){document.getElementById("tab-content").innerHTML=`
      <div class="card" style="max-width:480px;margin-bottom:14px">
        ...
        ${[["Registro público (para compartir con invitados)","/registro"],["Panel de caja","/caja"],["Control de puerta","/puerta"],["Logística / envíos","/logistica"]].map(([T,g])=>`
          <div style="display:flex;justify-content:space-between;align-items:center;padding:6px 0;border-bottom:.5px solid #e0d5c8;font-size:12px">
            <span>${T}</span>
            <a href="${g}" target="_blank" class="btn" style="padding:3px 8px;font-size:11px;color:#6B1C1C;border-color:#6B1C1C">Abrir</a>
          </div>`).join("")}
      </div>
...
Esta acción no se puede deshacer.`)||!confirm("Segunda confirmación: ¿borrar todos los datos de prueba?"))return;const T=document.getElementById("limpiar-msg");T.innerHTML='<span style="color:#888">Borrando...</span>';try{await Gc(),T.innerHTML='<span style="color:#3B6D11">✓ Datos borrados correctamente</span>'}catch(g){T.innerHTML=`<span style="color:#A32D2D">Error: ${g.message}</span>`}},window._abrirWA=T=>{const g=t.find(M=>M.fireId===T);if(!g)return;r=T,document.getElementById("mw-tit").textContent=g.nombre+" "+g.apellido,document.getElementById("mw-cod").textContent=g.codigo||"",document.getElementById("mw-bdg").innerHTML=el(g.estado);const x=window.location.origin,P=`${x}/acceso?inv=${g.token}`;document.getElementById("mw-link").textContent=P;const B=g.estado==="pagado"?`Hola ${g.nombre}! 🍷
...
_Personal e intransferible. Un solo uso en la entrada._`:`Hola ${g.nombre}! 🍷
...
Consultas: José Pannunzio +54 9 11 5400-1313`;document.getElementById("mw-msg").textContent=B;const S=document.getElementById("mw-btn-p");g.estado==="pendiente"?(S.textContent="✓ Marcar como pagado",S.disabled=!1,S.style.display="block"):S.style.display="none",Za("mw-canvas",g.codigo||g.fireId,80),document.getElementById("modal-wa").style.display="flex"},window._descargarQR=async T=>{const g=t.find(J=>J.fireId===T);if(!g)return;window.qrcode||await new Promise((J,Rt)=>{const Bt=document.createElement("script");Bt.src="https://cdn.jsdelivr.net/npm/qrcode-generator@1.4.4/qrcode.min.js",Bt.onload=J,Bt.onerror=Rt,document.head.appendChild(Bt)});const P=window.location.origin+"/acceso?inv="+g.token,B=document.createElement("canvas"),S=600,M=800;B.width=S,B.height=M;const D=B.getContext("2d"),_=D.createLinearGradient(0,0,0,M);_.addColorStop(0,"#1A3A5C"),_.addColorStop(.55,"#2C5F8A"),_.addColorStop(1,"#3A7D44"),D.fillStyle=_,D.fillRect(0,0,S,M),D.fillStyle="#C9A96E",D.fillRect(0,M-4,S,4),D.fillStyle="rgba(255,255,255,0.7)",D.font="500 18px system-ui, -apple-system, sans-serif",D.textAlign="center",D.fillText("SUCOVI 2027 · FERIA DE VINOS & DEGUSTACIÓN",S/2,54),D.fillStyle="#ffffff",D.font="500 38px system-ui, -apple-system, sans-serif",D.fillText(g.nombre+" "+g.apellido,S/2,110),D.fillStyle="rgba(255,255,255,0.75)",D.font="400 22px system-ui, -apple-system, sans-serif",D.fillText(g.codigo,S/2,146),D.fillStyle="#3A7D44";const m=200,A=34,w=S/2-m/2,E=164;I(D,w,E,m,A,17),D.fill(),D.fillStyle="#ffffff",D.font="500 15px system-ui, -apple-system, sans-serif",D.fillText("✅ Bono confirmado",S/2,E+23);const R=320,b=340,St=S/2-R/2,Vt=220;D.fillStyle="#ffffff",I(D,St,Vt,R,b,16),D.fill();const xe=qrcode(0,"M");xe.addData(P),xe.make();const Ut=xe.getModuleCount(),Jt=240,Ze=St+(R-Jt)/2,Qn=Vt+24,Te=Jt/Ut;D.fillStyle="#000000";for(let J=0;J<Ut;J++)for(let Rt=0;Rt<Ut;Rt++)xe.isDark(J,Rt)&&D.fillRect(Ze+Rt*Te,Qn+J*Te,Te,Te);D.fillStyle="#1A3A5C",D.font="500 26px system-ui, -apple-system, sans-serif",D.fillText(g.codigo,S/2,Vt+b-44),D.fillStyle="#888",D.font="400 14px system-ui, -apple-system, sans-serif",D.fillText("Mostrá este QR en la entrada",S/2,Vt+b-20),D.fillStyle="rgba(255,255,255,0.85)",D.font="400 18px system-ui, -apple-system, sans-serif",D.fillText("Sáb 20 jun 2026  ·  19:30 hs",S/2,Vt+b+50),D.fillText("Roma 656, Olivos",S/2,Vt+b+80),D.fillStyle="rgba(255,255,255,0.5)",D.font="400 13px system-ui, -apple-system, sans-serif",D.fillText("Personal e intransferible · Un solo uso en la entrada",S/2,M-24),await new Promise(J=>{const Rt=new Image;Rt.onload=()=>{const Ye=S-70-20,Zt=M-70-20;D.save(),D.beginPath(),D.arc(Ye+70/2,Zt+70/2,70/2+3,0,Math.PI*2),D.fillStyle="rgba(255,255,255,0.25)",D.fill(),D.beginPath(),D.arc(Ye+70/2,Zt+70/2,70/2,0,Math.PI*2),D.clip(),D.drawImage(Rt,Ye,Zt,70,70),D.restore(),J()},Rt.onerror=J,Rt.src=Yo});const Dt=document.createElement("a");Dt.download="QR-"+g.codigo+".png",Dt.href=B.toDataURL("image/png"),Dt.click()};function I(T,g,x,P,B,S){T.beginPath(),T.moveTo(g+S,x),T.lineTo(g+P-S,x),T.quadraticCurveTo(g+P,x,g+P,x+S),T.lineTo(g+P,x+B-S),T.quadraticCurveTo(g+P,x+B,g+P-S,x+B),T.lineTo(g+S,x+B),T.quadraticCurveTo(g,x+B,g,x+B-S),T.lineTo(g,x+S),T.quadraticCurveTo(g,x,g+S,x),T.closePath()}let k=null;window._editarInv=T=>{const g=t.find(x=>x.fireId===T);g&&(k=T,document.getElementById("edit-nom").value=g.nombre||"",document.getElementById("edit-ape").value=g.apellido||"",document.getElementById("edit-tel").value=g.tel||"",document.getElementById("edit-email").value=g.email||"",document.getElementById("edit-familia").value=g.familia||"",document.getElementById("edit-comentarios").value=g.comentarios||"",document.getElementById("edit-estado").value=g.estado||"pendiente",document.getElementById("edit-msg").innerHTML="",document.getElementById("modal-edit").style.display="flex")},window._guardarEdit=async()=>{const T=document.getElementById("edit-msg"),g=document.getElementById("edit-nom").value.trim(),x=document.getElementById("edit-ape").value.trim(),P=document.getElementById("edit-tel").value.trim();if(!g||!x||!P){T.innerHTML='<span style="color:#C0392B">Nombre, apellido y WhatsApp son obligatorios.</span>';return}T.innerHTML='<span style="color:#888">Guardando...</span>';const B={nombre:g,apellido:x,tel:P,estado:document.getElementById("edit-estado").value,...document.getElementById("edit-email").value.trim()&&{email:document.getElementById("edit-email").value.trim()},...document.getElementById("edit-familia").value.trim()&&{familia:document.getElementById("edit-familia").value.trim()},...document.getElementById("edit-comentarios").value.trim()&&{comentarios:document.getElementById("edit-comentarios").value.trim()}};try{await ye(k,B),T.innerHTML='<span style="color:#3A7D44">✓ Guardado correctamente</span>',setTimeout(()=>window._cerrarEdit(),1200)}catch(S){T.innerHTML=`<span style="color:#C0392B">Error: ${S.message}</span>`}},window._cerrarEdit=()=>{document.getElementById("modal-edit").style.display="none",k=null},window._pagarM=async()=>{const T=t.find(g=>g.fireId===r);!T||T.estado!=="pendiente"||await ye(T.fireId,{estado:"pagado"})},window._copWA=()=>{var x;(x=navigator.clipboard)==null||x.writeText(document.getElementById("mw-msg").textContent).catch(()=>{});const T=document.querySelector("#modal-wa .btn-g"),g=T.innerHTML;T.innerHTML="✓ ¡Copiado!",setTimeout(()=>T.innerHTML=g,2e3)},window._cModal=()=>{document.getElementById("modal-wa").style.display="none",r=null},s()}const Ve=n=>Number(n).toLocaleString("es-AR");async function pm(){window.jsQR||await new Promise((n,t)=>{const e=document.createElement("script");e.src="https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.js",e.onload=n,e.onerror=t,document.head.appendChild(e)})}function fm(n){Ht();let t=[],e=[],i="cobrar",r=null,s=[],a=null,c=!1;n.innerHTML=kt({title:"💰 Caja central",sub:"Sucovi 2027 · Roma 656, Olivos",backHref:"/admin"})+`
    <div class="nav">
    ...
    <div id="scan-overlay" class="scan-overlay" style="display:none">
    ...
    </div>`,Wn(g=>{t=g,i==="cobrar"&&!r&&f()}),tr(g=>{e=g,i!=="cobrar"&&u()}),window._cajaVista=(g,x)=>{i=g,r=null,document.querySelectorAll(".nav button").forEach(P=>P.classList.remove("on")),x.classList.add("on"),u()};function u(){i==="cobrar"&&y(),i==="pedidos"&&k(),i==="logistica"&&T()}let h={};async function f(){const g=t.filter(P=>P.estado!=="invalidado"),x=await Promise.all(g.map(async P=>{try{const S=(await ro(P.fireId)).filter(_=>{var m;return(m=_.items)==null?void 0:m.length});if(!S.length)return null;const M=S.reduce((_,m)=>_+(m.items||[]).reduce((A,w)=>A+(w.sub||0),0),0),D=S.reduce((_,m)=>_+(m.items||[]).length,0);return{fireId:P.fireId,total:M,cant:D,stands:S.length}}catch{return null}}));h={},x.filter(Boolean).forEach(P=>{h[P.fireId]=P}),v()}function y(){const g=document.getElementById("caja-content");if(r){I();return}g.innerHTML=`
      ...
      <div id="resultados-busqueda">
      ...
      </div>`,t.length&&f()}function v(){var B;const g=document.getElementById("resultados-busqueda");if(!g)return;const x=(((B=document.getElementById("buscar-caja"))==null?void 0:B.value)||"").toLowerCase().trim();let P=t.filter(S=>S.estado!=="invalidado");if(x?P=P.filter(S=>(S.codigo||"").toLowerCase().includes(x)||(S.nombre+" "+S.apellido).toLowerCase().includes(x)):P=P.filter(S=>h[S.fireId]),!P.length){g.innerHTML=x?'<div class="empty">Sin resultados</div>':'<div class="empty" style="padding:24px">Sin carritos activos — nadie ha agregado vinos todavía 🍷</div>';return}g.innerHTML=(x?"":`<p style="font-size:11px;color:#888;margin-bottom:8px;font-weight:500">CARRITOS ACTIVOS (${P.length})</p>`)+P.map(S=>{const M=h[S.fireId];return`
        ...
        </div>`}).join("")}window._buscarInv=(g=!1)=>{var B;const x=(((B=document.getElementById("buscar-caja"))==null?void 0:B.value)||"").toLowerCase().trim();if(!x){v();return}const P=t.filter(S=>S.estado!=="invalidado"&&((S.codigo||"").toLowerCase().includes(x)||(S.nombre+" "+S.apellido).toLowerCase().includes(x)));if(g&&P.length===1){window._seleccionarInv(P[0].fireId);return}v()},window._seleccionarInv=async g=>{r=t.find(x=>x.fireId===g),r&&(s=await ro(g),I())};async function I(){const g=document.getElementById("caja-content");if(!g)return;const x=r,P=s.filter(M=>{var D;return(D=M.items)==null?void 0:D.length}),B=P.reduce((M,D)=>M+(D.items||[]).reduce((_,m)=>_+(m.sub||0),0),0),S=e.filter(M=>M.invFireId===x.fireId);g.innerHTML=`
      ...
      ${P.length?`
        ${P.map(M=>`
          <div class="card" style="margin-bottom:10px">
            ...
            <div style="display:flex;justify-content:space-between;font-size:13px;
              ...
              <span>Subtotal</span>
              <span>$${Ve((M.items||[]).reduce((D,_)=>D+(_.sub||0),0))}</span>
            </div>
          </div>`).join("")}
        <div class="card" style="margin-bottom:14px">
          <div style="display:flex;justify-content:space-between;font-size:20px;font-weight:500">
            <span>TOTAL</span><span style="color:#1A3A5C">$${Ve(B)}</span>
          </div>
        ...
        <button class="btn btn-g" style="width:100%;padding:14px;font-size:16px"
          ...
          ✓ Cobrar $${Ve(B)} y generar vouchers
        </button>
    ...
    `}window._imprimirVouchers=()=>{const{inv:g,items:x}=window._lastCobrado||{};if(!g||!x)return;const P=S=>Number(S).toLocaleString("es-AR"),B=window.open("","_blank");B.document.write(`<!DOCTYPE html><html><head>
      <meta charset="utf-8">
      <title>Vouchers - ${g.nombre} ${g.apellido}</title>
      <style>
      ...
      <div class="voucher">
        <div class="header">
          <div>
            ...
            <div class="stand">🍷 ${S.standNombre}</div>
            <div class="inv">${g.nombre} ${g.apellido} · ${g.codigo}</div>
          </div>
          <div style="text-align:right">
            <div class="badge">✅ PAGADO</div>
            <div style="font-size:10px;color:#888;margin-top:4px">Stand #${S.standId}</div>
          </div>
        </div>
        ${(S.items||[]).map(M=>`
          <div class="item"><span>${M.desc}</span><strong>$${P(M.sub)}</strong></div>
        `).join("")}
        <div class="total">
          <span>Total</span>
          <span>$${P((S.items||[]).reduce((M,D)=>M+(D.sub||0),0))}</span>
        </div>
      </div>`).join("")}
    <script>window.print(); window.close();<\/script>
    </body></html>`),B.document.close()},window._enviarVouchersWA=()=>{var m;const{inv:g,items:x}=window._lastCobrado||{};if(!g||!x)return;const P=A=>Number(A).toLocaleString("es-AR"),B=x.map(A=>{const w=(A.items||[]).reduce((R,b)=>R+(b.sub||0),0),E=(A.items||[]).map(R=>`  • ${R.desc}: $${P(R.sub)}`).join(`
`);return`🍷 *${A.standNombre}* (Stand #${A.standId})
${E}
  Total: $${P(w)}`}).join(`

`),S=x.reduce((A,w)=>A+(w.items||[]).reduce((E,R)=>E+(R.sub||0),0),0),M=`Hola ${g.nombre}! 🍷
...
_Sáb 20 jun 2026 · Roma 656, Olivos_`,_="https://wa.me/54"+((m=g.tel)==null?void 0:m.replace(/\D/g,""))+"?text="+encodeURIComponent(M);window.open(_,"_blank")},window._volverCobrar=()=>{r=null,s=[],y()},window._cobrar=async()=>{const g=r,x=s.filter(S=>{var M;return(M=S.items)==null?void 0:M.length});if(!x.length)return;const P=document.querySelector("#caja-content .btn-g");P&&(P.disabled=!0,P.textContent="Procesando...");const B=document.getElementById("cobro-msg");try{await zc(g,x),await Fc(g.fireId),B.innerHTML=`<span style="color:#065F46;font-size:14px;font-weight:500">
        ✅ ¡Cobrado! ${x.length} voucher${x.length>1?"s":""} generado${x.length>1?"s":""}.
      </span>`,P&&(P.style.display="none");const S=document.getElementById("voucher-actions");S&&(S.style.display="flex"),window._lastCobrado={inv:g,items:x}}catch(S){B.innerHTML=`<span style="color:#C0392B">Error: ${S.message}</span>`,P&&(P.disabled=!1,P.textContent="Reintentar")}};function k(){const g=document.getElementById("caja-content"),x=e.filter(S=>S.retiro!=="envio"),P={pagado:"Pagado",listo:"Listo",entregado:"Entregado"},B={pagado:"b-pago",listo:"b-list",entregado:"b-entr"};if(!x.length){g.innerHTML='<div class="empty">Sin pedidos aún</div>';return}g.innerHTML=x.map(S=>{var M;return`
      <div class="card" style="margin-bottom:8px;display:flex;align-items:center;gap:8px;flex-wrap:wrap">
        ...
        <span class="badge ${B[S.estado]||"b-pago"}">${P[S.estado]||S.estado}</span>
      </div>`}).join("")}function T(){const g=document.getElementById("caja-content"),x=e.filter(P=>P.retiro==="envio");if(!x.length){g.innerHTML='<div class="empty">Sin envíos</div>';return}g.innerHTML=x.map(P=>{var B;return`
      <div class="card" style="margin-bottom:10px;border-left:3px solid #7C3AED">
        <div style="display:flex;justify-content:space-between;margin-bottom:6px">
          <span style="font-size:15px;font-weight:500;color:#1A3A5C">
            #${(B=P.fireId)==null?void 0:B.slice(-4).toUpperCase()}
          </span>
          <span class="badge b-envi">🚚 Envío</span>
        </div>
        <div style="font-size:13px;font-weight:500;margin-bottom:4px">${P.invNombre||""}</div>
        <div style="font-size:12px;color:#666;margin-bottom:6px">
          ${P.standNombre} · ${(P.items||[]).map(S=>S.desc).join(" · ")}
        </div>
        <div style="font-size:15px;font-weight:500">$${Ve(P.total||0)}</div>
      </div>`}).join("")}window._abrirScanner=async()=>{document.getElementById("scan-overlay").style.display="flex";const g=document.getElementById("scan-status");g&&(g.textContent="Cargando escáner...");try{await pm(),a=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}});const x=document.getElementById("scan-video");x.srcObject=a,c=!0,g&&(g.textContent="Buscando QR...");const P=document.createElement("canvas"),B=P.getContext("2d",{willReadFrequently:!0}),S=()=>{if(c){if(x.readyState===x.HAVE_ENOUGH_DATA&&x.videoWidth>0){P.width=x.videoWidth,P.height=x.videoHeight,B.drawImage(x,0,0);const M=B.getImageData(0,0,P.width,P.height),D=window.jsQR(M.data,M.width,M.height,{inversionAttempts:"dontInvert"});if(D&&D.data){const _=D.data;window._cerrarScanner();const m=_.match(/INV-\d+/),A=_.match(/inv=([A-Z0-9]+)/i);if(m){const w=document.getElementById("buscar-caja");w&&(w.value=m[0],window._buscarInv(!0))}else A&&kn(async()=>{const{buscarInvitadoPorToken:w}=await Promise.resolve().then(()=>Li);return{buscarInvitadoPorToken:w}},void 0).then(({buscarInvitadoPorToken:w})=>w(A[1]).then(E=>{E&&window._seleccionarInv(E.fireId)}));return}}c&&requestAnimationFrame(S)}};x.addEventListener("loadeddata",()=>requestAnimationFrame(S))}catch{g&&(g.textContent="No se pudo acceder a la cámara. Ingresá el código manualmente.")}},window._cerrarScanner=()=>{c=!1,a&&(a.getTracks().forEach(x=>x.stop()),a=null);const g=document.getElementById("scan-overlay");g&&(g.style.display="none")},y()}const kr=n=>Number(n).toLocaleString("es-AR");function mm(n,t,e){if(Ht(),!e||e.estado==="invalidado"){n.innerHTML=kt({title:"🍷 "+t.nombre,sub:"Stand #"+t.id+" · Sucovi 2027"})+`
    ...
    </button>`,Zo(t.id,u=>{i=u,a()}),Jo(e.fireId,u=>{var k,T,g;const h=u.find(x=>Number(x.standId)===t.id),f=u.reduce((x,P)=>x+(P.items||[]).reduce((B,S)=>B+(S.sub||0),0),0),y=u.reduce((x,P)=>x+(P.items||[]).length,0),v=document.getElementById("cart-fab"),I=document.getElementById("cart-fab-txt");v&&y>0?(v.style.display="flex",I.textContent=`Ver carrito · $${kr(f)}`):v&&(v.style.display="none"),h&&((k=h.items)!=null&&k.length)?(r=h.retiro||"stand",(T=document.getElementById("rb-stand"))==null||T.classList.toggle("sel",r==="stand"),(g=document.getElementById("rb-envio"))==null||g.classList.toggle("sel",r==="envio"),document.getElementById("retiro-box").style.display="block",document.getElementById("stand-resumen").style.display="block",document.getElementById("stand-resumen-lines").innerHTML=h.items.map(x=>`
        ...
        ${(h.unidades||[]).map((y,v)=>`
          <div class="qty-row">
            <span class="qty-label">
              ${y.u} — <span style="color:#6B1C1C;font-weight:600">$${kr(y.p)}</span>
            </span>
            <button class="qty-btn" onclick="window._agregar(${f},${v},-1)">−</button>
            <span id="qv${f}_${v}" style="font-size:14px;font-weight:500;min-width:20px;text-align:center">0</span>
            <button class="qty-btn" onclick="window._agregar(${f},${v},1)">+</button>
          </div>`).join("")}
      </div>`).join("")}}const c={};window._agregar=async(u,h,f)=>{const y=i[u];if(!y)return;const v=(y.unidades||[])[h];if(!v)return;const I=`${u}_${h}`;c[I]=Math.max(0,(c[I]||0)+f);const k=document.getElementById(`qv${u}_${h}`);if(k&&(k.textContent=c[I]),c[I]===0)await Bi(e.fireId,t.id,I);else{const T={key:I,desc:`${y.nombre} — ${v.u} ×${c[I]}`,sub:v.p*c[I],vinoNombre:y.nombre,unidad:v.u,precio:v.p,qty:c[I]};await Oc(e.fireId,t.id,t.nombre,T,r),document.getElementById("retiro-box").style.display="block";const g=document.getElementById("add-msg");g.textContent=`✓ ${y.nombre} (${v.u}) agregado al carrito`,setTimeout(()=>{g.textContent=""},2e3)}},window._sRet=async u=>{r=u,document.getElementById("rb-stand").classList.toggle("sel",u==="stand"),document.getElementById("rb-envio").classList.toggle("sel",u==="envio"),document.getElementById("envio-form").style.display=u==="envio"?"block":"none",await Xo(e.fireId,t.id,u)},window._quitarItem=async u=>{await Bi(e.fireId,t.id,u);const[h,f]=u.split("_").map(Number);c[u]=0;const y=document.getElementById(`qv${h}_${f}`);y&&(y.textContent=0)}}window._scannerStop=null;async function gm(){window.jsQR||await new Promise((n,t)=>{const e=document.createElement("script");e.src="https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.js",e.onload=n,e.onerror=t,document.head.appendChild(e)})}window._initScanner=async function(n,t,e){const i=e?document.getElementById(e):null;i&&(i.textContent="Iniciando cámara...");try{await gm();const r=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}}),s=document.getElementById(n);if(!s){r.getTracks().forEach(f=>f.stop());return}s.srcObject=r;const a=document.createElement("canvas"),c=a.getContext("2d",{willReadFrequently:!0});let u=!0;window._scannerStop=()=>{u=!1,r.getTracks().forEach(f=>f.stop()),window._scannerStop=null},i&&(i.textContent="Buscando QR...");const h=()=>{var f;if(u){if(s.readyState===s.HAVE_ENOUGH_DATA&&s.videoWidth>0){a.width=s.videoWidth,a.height=s.videoHeight,c.drawImage(s,0,0);const y=c.getImageData(0,0,a.width,a.height),v=window.jsQR(y.data,y.width,y.height,{inversionAttempts:"dontInvert"});if(v&&v.data){(f=window._scannerStop)==null||f.call(window),t(v.data);return}}requestAnimationFrame(h)}};s.addEventListener("loadeddata",()=>requestAnimationFrame(h))}catch{i&&(i.textContent="No se pudo acceder a la cámara. Ingresá el código manualmente.")}};const Nr=n=>Number(n).toLocaleString("es-AR");function Kc(n,t){if(Ht(),!sessionStorage.getItem("stand-auth-"+t.id)){n.innerHTML=`
    ...
    <div id="voucher-modal" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;
    ...
    </div>`;let r="pendientes";window._setTab=(u,h)=>{["tab-pedidos","tab-carta","tab-resumen"].forEach(f=>{const y=document.getElementById(f);y&&(y.style.borderBottomColor="transparent",y.style.color="#888",y.style.fontWeight="400")}),h.style.borderBottomColor="#5BA4CF",h.style.color="#5BA4CF",h.style.fontWeight="600",["pedidos","carta","resumen"].forEach(f=>{const y=document.getElementById("tab-content-"+f);y&&(y.style.display=f===u?"block":"none")}),u==="carta"&&a(),u==="resumen"&&c()},window._setSF=(u,h)=>{r=u,["sf-pend","sf-entr","sf-all"].forEach(f=>{const y=document.getElementById(f);y&&(y.style.background="#fff",y.style.color="#333",y.style.borderColor="#ccc")}),u==="pendientes"?(h.style.background="#EAF3DE",h.style.color="#3B6D11",h.style.borderColor="#3B6D11"):u==="entregados"?(h.style.background="#D1FAE5",h.style.color="#065F46",h.style.borderColor="#3A7D44"):(h.style.background="#1A3A5C",h.style.color="#fff",h.style.borderColor="#1A3A5C"),s()},jc(t.id,u=>{i=u,s()});function s(){const u=document.getElementById("sp-pedidos");if(!u)return;let h=i;if(r==="pendientes"?h=i.filter(v=>v.estado==="pagado"):r==="entregados"&&(h=i.filter(v=>v.estado==="entregado")),!h.length){const v={pendientes:"Sin pedidos listos para retirar 🎉",entregados:"Todavía no se entregó nada",todos:"Sin pedidos"};u.innerHTML=`<div class="empty">${v[r]||"Sin pedidos"}</div>`;return}const f={pagado:"Listo para retirar",entregado:"Entregado"},y={pagado:"b-pago",entregado:"b-entr"};u.innerHTML=h.map(v=>{var I;return`
      <div class="card" style="margin-bottom:10px;border-left:3px solid ${v.estado==="entregado"?"#aaa":"#3B6D11"}">
        <div style="display:flex;justify-content:space-between;margin-bottom:6px">
          <div>
            <span style="font-size:18px;font-weight:500;color:#6B1C1C">
              #${(I=v.fireId)==null?void 0:I.slice(-4).toUpperCase()}
            </span>
            <span style="font-size:13px;font-weight:500;margin-left:8px">${v.invNombre||""}</span>
          </div>
          <span class="badge ${y[v.estado]||"b-pago"}">${f[v.estado]||v.estado}</span>
        </div>
        <div style="font-size:12px;color:#555;margin-bottom:8px;line-height:1.7">
          ${(v.items||[]).map(k=>`${k.desc} — <strong>$${Nr(k.sub)}</strong>`).join("<br>")}
        </div>
        <div style="display:flex;justify-content:space-between;align-items:center;
          border-top:.5px solid #e0d5c8;padding-top:8px">
          <span style="font-size:16px;font-weight:500">$${Nr(v.total||0)}</span>
          ${v.estado==="pagado"?`<button class="btn btn-g" onclick="window._entregarPedido('${v.fireId}')">
                ✓ Marcar entregado
               </button>`:'<span style="font-size:12px;color:#aaa">✓ Entregado</span>'}
        </div>
      </div>`}).join("")}function a(){const u=document.getElementById("sp-carta");u&&(u.innerHTML='<div class="empty" style="padding:16px">Cargando...</div>',kn(()=>Promise.resolve().then(()=>Li),void 0).then,kn(async()=>{const{escucharVinos:h}=await Promise.resolve().then(()=>Li);return{escucharVinos:h}},void 0).then(({escucharVinos:h})=>{h(t.id,f=>{if(!f.length){u.innerHTML='<div class="empty">Sin vinos cargados todavía</div>';return}const y=v=>Number(v).toLocaleString("es-AR");u.innerHTML=f.map(v=>`
          ...
          </div>`).join("")})}).catch(()=>{u.innerHTML='<div class="empty">Error cargando carta</div>'}))}function c(){const u=document.getElementById("sp-resumen");if(!u)return;const h=x=>Number(x).toLocaleString("es-AR"),f=i.filter(x=>x.estado==="entregado"),y=i.filter(x=>x.estado==="pagado"),v=f.reduce((x,P)=>x+(P.total||0),0),I=y.reduce((x,P)=>x+(P.total||0),0),k=i.reduce((x,P)=>x+(P.total||0),0),T={};f.forEach(x=>{(x.items||[]).forEach(P=>{const B=P.vinoNombre+" — "+P.unidad;T[B]||(T[B]={cant:0,total:0}),T[B].cant+=P.qty||1,T[B].total+=P.sub||0})});const g=Object.entries(T).sort((x,P)=>P[1].total-x[1].total);u.innerHTML=`
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-bottom:14px">
        <div class="stat"><div class="v" style="color:#3A7D44">$${h(v)}</div><div class="l">Entregado</div></div>
        <div class="stat"><div class="v" style="color:#D97706">$${h(I)}</div><div class="l">Por entregar</div></div>
        <div class="stat"><div class="v">$${h(k)}</div><div class="l">Total vendido</div></div>
      </div>
      <div class="card">
      ...
      </div>`}window._entregarPedido=async u=>{await Hc(u)},window._abrirScannerStand=async()=>{document.getElementById("scan-overlay-stand").style.display="flex",await window._initScanner("scan-video-stand",I=>{window._cerrarScannerStand();const k=i.find(T=>I.includes(T.fireId));k&&u(k)},"scan-status-stand");function u(I){const k=I.estado==="pagado",T=document.getElementById("voucher-modal");document.getElementById("voucher-modal-content").innerHTML=`
      <div style="text-align:center;margin-bottom:12px">
        <div style="font-size:32px">${k?"✅":"⏳"}</div>
        <h3 style="font-size:16px;font-weight:500;color:${k?"#3B6D11":"#854F0B"};margin-top:6px">
          ${k?"PAGADO — Entregar":"PENDIENTE — No entregar"}
        </h3>
      </div>
      <div style="font-size:14px;font-weight:500;margin-bottom:4px">${I.invNombre||""}</div>
      <div style="font-size:13px;color:#666;margin-bottom:10px">
        ${(I.items||[]).map(g=>g.desc).join("<br>")}
      </div>
      <div style="font-size:16px;font-weight:500;margin-bottom:12px">$${Nr(I.total||0)}</div>
      ${k?`
        <button class="btn btn-g" style="width:100%;padding:10px;margin-bottom:8px"
          onclick="window._entregarPedido('${I.fireId}');document.getElementById('voucher-modal').style.display='none'">
          ✓ Confirmar entrega
        </button>`:""}
      <button class="btn" style="width:100%"
        onclick="document.getElementById('voucher-modal').style.display='none'">Cerrar</button>`,T.style.display="flex"}let h=null,f=!1;window._abrirScannerInvitado=async()=>{document.getElementById("scan-overlay-inv").style.display="flex";const I=document.getElementById("scan-status-inv");try{window.jsQR||await new Promise((P,B)=>{const S=document.createElement("script");S.src="https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.js",S.onload=P,S.onerror=B,document.head.appendChild(S)}),h=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}});const k=document.getElementById("scan-video-inv");k.srcObject=h,f=!0,I&&(I.textContent="Buscando QR del invitado...");const T=document.createElement("canvas"),g=T.getContext("2d",{willReadFrequently:!0}),x=()=>{if(f){if(k.readyState===k.HAVE_ENOUGH_DATA&&k.videoWidth>0){T.width=k.videoWidth,T.height=k.videoHeight,g.drawImage(k,0,0);const P=g.getImageData(0,0,T.width,T.height),B=window.jsQR(P.data,P.width,P.height,{inversionAttempts:"dontInvert"});if(B&&B.data){const S=B.data;window._cerrarScannerInvitado();const M=S.match(/inv=([A-Z0-9]+)/i),D=S.match(/INV-\d+/);M?window.location.href=`/stand/${t.id}?inv=`+M[1]:D&&I&&(I.textContent="Usá el link del invitado, no el código.");return}}f&&requestAnimationFrame(x)}};k.addEventListener("loadeddata",()=>requestAnimationFrame(x))}catch{I&&(I.textContent="No se pudo acceder a la cámara.")}};let y=null,v=!1;window._abrirScannerUnificado=async()=>{document.getElementById("scan-overlay-uni").style.display="flex";const I=document.getElementById("scan-status-uni");try{window.jsQR||await new Promise((P,B)=>{const S=document.createElement("script");S.src="https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.js",S.onload=P,S.onerror=B,document.head.appendChild(S)}),y=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}});const k=document.getElementById("scan-video-uni");k.srcObject=y,v=!0,I&&(I.textContent="Buscando QR...");const T=document.createElement("canvas"),g=T.getContext("2d",{willReadFrequently:!0}),x=()=>{if(v){if(k.readyState===k.HAVE_ENOUGH_DATA&&k.videoWidth>0){T.width=k.videoWidth,T.height=k.videoHeight,g.drawImage(k,0,0);const P=g.getImageData(0,0,T.width,T.height),B=window.jsQR(P.data,P.width,P.height,{inversionAttempts:"dontInvert"});if(B&&B.data){const S=B.data;window._cerrarScannerUni();const M=S.match(/inv=([A-Z0-9]+)/i),D=i.find(_=>S.includes(_.fireId));M?(I&&(I.textContent="Invitado detectado, abriendo menú..."),window.location.href="/stand/"+t.id+"?inv="+M[1]):D?u(D):(I&&(I.textContent="QR no reconocido — intentá de nuevo"),setTimeout(()=>window._abrirScannerUnificado(),1500));return}}v&&requestAnimationFrame(x)}};k.addEventListener("loadeddata",()=>requestAnimationFrame(x))}catch{I&&(I.textContent="No se pudo acceder a la cámara.")}},window._cerrarScannerUni=()=>{v=!1,y&&(y.getTracks().forEach(k=>k.stop()),y=null);const I=document.getElementById("scan-overlay-uni");I&&(I.style.display="none")},window._cerrarScannerInvitado=()=>{f=!1,h&&(h.getTracks().forEach(I=>I.stop()),h=null),document.getElementById("scan-overlay-inv").style.display="none"},window._cerrarScannerStand=()=>{var I;(I=window._scannerStop)==null||I.call(window),document.getElementById("scan-overlay-stand").style.display="none"}}}const ym=n=>Number(n).toLocaleString("es-AR");function Xc(n,t){if(Ht(),!sessionStorage.getItem("bodega-auth-"+t.id)){n.innerHTML=`
    ...
    <div style="max-width:600px;margin:0 auto;padding:14px">
      ...
      </div>`).join("")}});const s=["vn","vv","vc","vd","vb","v6","v12"],a=()=>{s.forEach(c=>{const u=document.getElementById(c);u&&(u.value="")})};window._guardarV=async()=>{const c=document.getElementById("vn").value.trim(),u=document.getElementById("vm");if(!c){u.innerHTML='<span style="color:#A32D2D">El nombre es requerido.</span>';return}const h=parseFloat(document.getElementById("vb").value),f=parseFloat(document.getElementById("v6").value),y=parseFloat(document.getElementById("v12").value),v=[];if(h&&v.push({u:"Botella",p:h}),f&&v.push({u:"Caja x6",p:f}),y&&v.push({u:"Caja x12",p:y}),!v.length){u.innerHTML='<span style="color:#A32D2D">Ingresá al menos un precio.</span>';return}const I={nombre:c,varietal:document.getElementById("vv").value.trim(),cosecha:document.getElementById("vc").value.trim(),descripcion:document.getElementById("vd").value.trim(),unidades:v};u.innerHTML='<span style="color:#888">Guardando...</span>';try{r?(await Wc(t.id,r,I),r=null):await $c(t.id,I),a(),document.getElementById("form-titulo").textContent="Agregar vino",document.getElementById("btn-cancelar-edit").style.display="none",u.innerHTML='<span style="color:#3B6D11">✓ Guardado correctamente</span>',setTimeout(()=>{const k=document.getElementById("vm");k&&(k.innerHTML="")},3e3)}catch(k){u.innerHTML=`<span style="color:#A32D2D">Error: ${k.message}</span>`}},window._editarV=c=>{const u=i.find(v=>v.fireId===c);if(!u)return;r=c,document.getElementById("form-titulo").textContent=`Editando: ${u.nombre}`,document.getElementById("vn").value=u.nombre||"",document.getElementById("vv").value=u.varietal||"",document.getElementById("vc").value=u.cosecha||"",document.getElementById("vd").value=u.descripcion||"";const h=(u.unidades||[]).find(v=>v.u==="Botella"),f=(u.unidades||[]).find(v=>v.u==="Caja x6"),y=(u.unidades||[]).find(v=>v.u==="Caja x12");document.getElementById("vb").value=(h==null?void 0:h.p)||"",document.getElementById("v6").value=(f==null?void 0:f.p)||"",document.getElementById("v12").value=(y==null?void 0:y.p)||"",document.getElementById("btn-cancelar-edit").style.display="block",window.scrollTo({top:0,behavior:"smooth"})},window._cancelarEdit=()=>{r=null,a(),document.getElementById("form-titulo").textContent="Agregar vino",document.getElementById("btn-cancelar-edit").style.display="none"},window._eliminarV=async c=>{const u=i.find(h=>h.fireId===c);confirm(`¿Eliminar "${u==null?void 0:u.nombre}"?`)&&await Qc(t.id,c)}}window._scannerStop=null;async function vm(){window.jsQR||await new Promise((n,t)=>{const e=document.createElement("script");e.src="https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.js",e.onload=n,e.onerror=t,document.head.appendChild(e)})}window._initScanner=async function(n,t,e){const i=e?document.getElementById(e):null;i&&(i.textContent="Iniciando cámara...");try{await vm();const r=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}}),s=document.getElementById(n);if(!s){r.getTracks().forEach(f=>f.stop());return}s.srcObject=r;const a=document.createElement("canvas"),c=a.getContext("2d",{willReadFrequently:!0});let u=!0;window._scannerStop=()=>{u=!1,r.getTracks().forEach(f=>f.stop()),window._scannerStop=null},i&&(i.textContent="Buscando QR...");const h=()=>{var f;if(u){if(s.readyState===s.HAVE_ENOUGH_DATA&&s.videoWidth>0){a.width=s.videoWidth,a.height=s.videoHeight,c.drawImage(s,0,0);const y=c.getImageData(0,0,a.width,a.height),v=window.jsQR(y.data,y.width,y.height,{inversionAttempts:"dontInvert"});if(v&&v.data){(f=window._scannerStop)==null||f.call(window),t(v.data);return}}requestAnimationFrame(h)}};s.addEventListener("loadeddata",()=>requestAnimationFrame(h))}catch{i&&(i.textContent="No se pudo acceder a la cámara. Ingresá el código manualmente.")}};function Am(n){Ht();let t=[],e=[];n.innerHTML=`
    <div class="hdr">
    ...
    <div id="scan-res"></div>
      ...
      <div id="scan-ult"></div>
    </div>`,Wn(r=>{t=r}),window._vPuerta=async()=>{const r=document.getElementById("scan-cod").value.trim().toUpperCase(),s=document.getElementById("scan-res");if(!r)return;const a=t.find(u=>u.codigo===r);if(!a){s.innerHTML=`<div class="result-err">
    ...
    <div class="wrap" id="log-lista"></div>`,tr(i=>{t=i,e()}),window._avzLog=async(i,r)=>{await Uc(i,r)};function e(){const i=document.getElementById("log-lista");if(!i)return;const r=t.filter(c=>c.retiro==="envio");if(!r.length){i.innerHTML='<div class="empty">🚚<br><br>Sin pedidos de envío</div>';return}const s=r.filter(c=>c.estado!=="entregado"),a=r.filter(c=>c.estado==="entregado");i.innerHTML=(s.length?`<p style="font-size:12px;font-weight:500;color:#5A1E99;margin-bottom:8px">Pendientes (${s.length})</p>`:"")+s.map(c=>{var u;return`
        <div class="card" style="margin-bottom:10px;border-left:3px solid #5A1E99">
          <div style="display:flex;justify-content:space-between;margin-bottom:6px">
            ...
            <span class="badge ${wm[c.estado]}">${_m[c.estado]}</span>
          </div>
          ...
          <div style="display:flex;justify-content:space-between;align-items:center">
            ...
            ${xm[c.estado]?`<button class="btn ${Im[c.estado]}" style="font-size:12px"
                  onclick="window._avzLog('${c.fireId}','${c.estado}')">${Em[c.estado]}</button>`:""}
          </div>
    ...
    </div>`,setTimeout(()=>Cm("qr-acc",e.codigo,160),50);let s=null,a=!1;window._abrirScannerAcceso=async()=>{const c=document.getElementById("scan-overlay-acc");c&&(c.style.display="flex");const u=document.getElementById("scan-status-acc");try{typeof loadJsQR=="function"?await loadJsQR():await new Promise((I,k)=>{if(window.jsQR){I();return}const T=document.createElement("script");T.src="https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.js",T.onload=I,T.onerror=k,document.head.appendChild(T)}),s=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}});const h=document.getElementById("scan-video-acc");h.srcObject=s,a=!0,u&&(u.textContent="Buscando QR del stand...");const f=document.createElement("canvas"),y=f.getContext("2d",{willReadFrequently:!0}),v=()=>{if(a){if(h.readyState===h.HAVE_ENOUGH_DATA&&h.videoWidth>0){f.width=h.videoWidth,f.height=h.videoHeight,y.drawImage(h,0,0);const I=y.getImageData(0,0,f.width,f.height),k=window.jsQR(I.data,I.width,I.height,{inversionAttempts:"dontInvert"});if(k&&k.data){const T=k.data;window._cerrarScannerAcceso();const g=T.match(/\/stand\/(\d+)/);g&&(window.location.href="/stand/"+g[1]+"?inv="+t);return}}a&&requestAnimationFrame(v)}};h.addEventListener("loadeddata",()=>requestAnimationFrame(v))}catch{u&&(u.textContent="No se pudo acceder a la cámara.")}},window._cerrarScannerAcceso=()=>{a=!1,s&&(s.getTracks().forEach(u=>u.stop()),s=null);const c=document.getElementById("scan-overlay-acc");c&&(c.style.display="none")},qc(e.fireId,c=>{const u=document.getElementById("vouchers-acc");if(u){if(!c.length){u.innerHTML="";return}u.innerHTML=`
      <p style="font-size:12px;font-weight:500;color:#6B1C1C;margin-bottom:8px;text-align:left">
        Mis vouchers de retiro
      </p>
      ${c.map(h=>{const f={pagado:"Listo para retirar",entregado:"Entregado"},y=h.estado==="pagado";return`
          <div style="background:${y?"#EAF3DE":"#f5f5f5"};border:.5px solid ${y?"#3B6D11":"#ddd"};
            ...
            <div style="display:flex;justify-content:space-between;margin-bottom:6px">
              ...
              <span class="badge ${y?"b-pago":"b-entr"}">${f[h.estado]||h.estado}</span>
            </div>
            <div style="font-size:12px;color:#555;margin-bottom:6px">
              ${(h.items||[]).map(v=>v.desc).join("<br>")}
            </div>
            <div style="font-size:14px;font-weight:500">$${Pm(h.total||0)}</div>
            ${y?`<p style="font-size:11px;color:#3B6D11;margin-top:6px">
    ...
    </div>`,window._autoRegistrar=async()=>{const i=document.getElementById("rn").value.trim(),r=document.getElementById("ra").value.trim(),s=document.getElementById("rt").value.trim(),a=document.getElementById("re").value.trim(),c=document.getElementById("rf").value.trim(),u=document.getElementById("rc").value.trim(),h=document.getElementById("reg-msg");if(!i||!r||!s){h.innerHTML='<span style="color:#A32D2D">Nombre, apellido y WhatsApp son obligatorios.</span>';return}h.innerHTML='<span style="color:#888">Registrando...</span>';try{const f=await kn(()=>Promise.resolve().then(()=>Li),void 0).then(v=>v.escucharInvitados),y="INV-"+String(t+1).padStart(4,"0");await ki({nombre:i,apellido:r,tel:s,...a&&{email:a},...c&&{familia:c},...u&&{comentarios:u},estado:"pendiente",codigo:y,token:Vm()}),document.getElementById("reg-form").innerHTML=`
