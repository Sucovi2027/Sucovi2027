...
*/var de,ol;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function t(b,m){function v(){}v.prototype=m.prototype,b.D=m.prototype,b.prototype=new v,b.prototype.constructor=b,b.C=function(I,w,T){for(var g=Array(arguments.length-2),Ft=2;Ft<arguments.length;Ft++)g[Ft-2]=arguments[Ft];return m.prototype[w].apply(I,g)}}function e(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}t(r,e),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(b,m,v){v||(v=0);var I=Array(16);if(typeof m=="string")for(var w=0;16>w;++w)I[w]=m.charCodeAt(v++)|m.charCodeAt(v++)<<8|m.charCodeAt(v++)<<16|m.charCodeAt(v++)<<24;else for(w=0;16>w;++w)I[w]=m[v++]|m[v++]<<8|m[v++]<<16|m[v++]<<24;m=b.g[0],v=b.g[1],w=b.g[2];var T=b.g[3],g=m+(T^v&(w^T))+I[0]+3614090360&4294967295;m=v+(g<<7&4294967295|g>>>25),g=T+(w^m&(v^w))+I[1]+3905402710&4294967295,T=m+(g<<12&4294967295|g>>>20),g=w+(v^T&(m^v))+I[2]+606105819&4294967295,w=T+(g<<17&4294967295|g>>>15),g=v+(m^w&(T^m))+I[3]+3250441966&4294967295,v=w+(g<<22&4294967295|g>>>10),g=m+(T^v&(w^T))+I[4]+4118548399&4294967295,m=v+(g<<7&4294967295|g>>>25),g=T+(w^m&(v^w))+I[5]+1200080426&4294967295,T=m+(g<<12&4294967295|g>>>20),g=w+(v^T&(m^v))+I[6]+2821735955&4294967295,w=T+(g<<17&4294967295|g>>>15),g=v+(m^w&(T^m))+I[7]+4249261313&4294967295,v=w+(g<<22&4294967295|g>>>10),g=m+(T^v&(w^T))+I[8]+1770035416&4294967295,m=v+(g<<7&4294967295|g>>>25),g=T+(w^m&(v^w))+I[9]+2336552879&4294967295,T=m+(g<<12&4294967295|g>>>20),g=w+(v^T&(m^v))+I[10]+4294925233&4294967295,w=T+(g<<17&4294967295|g>>>15),g=v+(m^w&(T^m))+I[11]+2304563134&4294967295,v=w+(g<<22&4294967295|g>>>10),g=m+(T^v&(w^T))+I[12]+1804603682&4294967295,m=v+(g<<7&4294967295|g>>>25),g=T+(w^m&(v^w))+I[13]+4254626195&4294967295,T=m+(g<<12&4294967295|g>>>20),g=w+(v^T&(m^v))+I[14]+2792965006&4294967295,w=T+(g<<17&4294967295|g>>>15),g=v+(m^w&(T^m))+I[15]+1236535329&4294967295,v=w+(g<<22&4294967295|g>>>10),g=m+(w^T&(v^w))+I[1]+4129170786&4294967295,m=v+(g<<5&4294967295|g>>>27),g=T+(v^w&(m^v))+I[6]+3225465664&4294967295,T=m+(g<<9&4294967295|g>>>23),g=w+(m^v&(T^m))+I[11]+643717713&4294967295,w=T+(g<<14&4294967295|g>>>18),g=v+(T^m&(w^T))+I[0]+3921069994&4294967295,v=w+(g<<20&4294967295|g>>>12),g=m+(w^T&(v^w))+I[5]+3593408605&4294967295,m=v+(g<<5&4294967295|g>>>27),g=T+(v^w&(m^v))+I[10]+38016083&4294967295,T=m+(g<<9&4294967295|g>>>23),g=w+(m^v&(T^m))+I[15]+3634488961&4294967295,w=T+(g<<14&4294967295|g>>>18),g=v+(T^m&(w^T))+I[4]+3889429448&4294967295,v=w+(g<<20&4294967295|g>>>12),g=m+(w^T&(v^w))+I[9]+568446438&4294967295,m=v+(g<<5&4294967295|g>>>27),g=T+(v^w&(m^v))+I[14]+3275163606&4294967295,T=m+(g<<9&4294967295|g>>>23),g=w+(m^v&(T^m))+I[3]+4107603335&4294967295,w=T+(g<<14&4294967295|g>>>18),g=v+(T^m&(w^T))+I[8]+1163531501&4294967295,v=w+(g<<20&4294967295|g>>>12),g=m+(w^T&(v^w))+I[13]+2850285829&4294967295,m=v+(g<<5&4294967295|g>>>27),g=T+(v^w&(m^v))+I[2]+4243563512&4294967295,T=m+(g<<9&4294967295|g>>>23),g=w+(m^v&(T^m))+I[7]+1735328473&4294967295,w=T+(g<<14&4294967295|g>>>18),g=v+(T^m&(w^T))+I[12]+2368359562&4294967295,v=w+(g<<20&4294967295|g>>>12),g=m+(v^w^T)+I[5]+4294588738&4294967295,m=v+(g<<4&4294967295|g>>>28),g=T+(m^v^w)+I[8]+2272392833&4294967295,T=m+(g<<11&4294967295|g>>>21),g=w+(T^m^v)+I[11]+1839030562&4294967295,w=T+(g<<16&4294967295|g>>>16),g=v+(w^T^m)+I[14]+4259657740&4294967295,v=w+(g<<23&4294967295|g>>>9),g=m+(v^w^T)+I[1]+2763975236&4294967295,m=v+(g<<4&4294967295|g>>>28),g=T+(m^v^w)+I[4]+1272893353&4294967295,T=m+(g<<11&4294967295|g>>>21),g=w+(T^m^v)+I[7]+4139469664&4294967295,w=T+(g<<16&4294967295|g>>>16),g=v+(w^T^m)+I[10]+3200236656&4294967295,v=w+(g<<23&4294967295|g>>>9),g=m+(v^w^T)+I[13]+681279174&4294967295,m=v+(g<<4&4294967295|g>>>28),g=T+(m^v^w)+I[0]+3936430074&4294967295,T=m+(g<<11&4294967295|g>>>21),g=w+(T^m^v)+I[3]+3572445317&4294967295,w=T+(g<<16&4294967295|g>>>16),g=v+(w^T^m)+I[6]+76029189&4294967295,v=w+(g<<23&4294967295|g>>>9),g=m+(v^w^T)+I[9]+3654602809&4294967295,m=v+(g<<4&4294967295|g>>>28),g=T+(m^v^w)+I[12]+3873151461&4294967295,T=m+(g<<11&4294967295|g>>>21),g=w+(T^m^v)+I[15]+530742520&4294967295,w=T+(g<<16&4294967295|g>>>16),g=v+(w^T^m)+I[2]+3299628645&4294967295,v=w+(g<<23&4294967295|g>>>9),g=m+(w^(v|~T))+I[0]+4096336452&4294967295,m=v+(g<<6&4294967295|g>>>26),g=T+(v^(m|~w))+I[7]+1126891415&4294967295,T=m+(g<<10&4294967295|g>>>22),g=w+(m^(T|~v))+I[14]+2878612391&4294967295,w=T+(g<<15&4294967295|g>>>17),g=v+(T^(w|~m))+I[5]+4237533241&4294967295,v=w+(g<<21&4294967295|g>>>11),g=m+(w^(v|~T))+I[12]+1700485571&4294967295,m=v+(g<<6&4294967295|g>>>26),g=T+(v^(m|~w))+I[3]+2399980690&4294967295,T=m+(g<<10&4294967295|g>>>22),g=w+(m^(T|~v))+I[10]+4293915773&4294967295,w=T+(g<<15&4294967295|g>>>17),g=v+(T^(w|~m))+I[1]+2240044497&4294967295,v=w+(g<<21&4294967295|g>>>11),g=m+(w^(v|~T))+I[8]+1873313359&4294967295,m=v+(g<<6&4294967295|g>>>26),g=T+(v^(m|~w))+I[15]+4264355552&4294967295,T=m+(g<<10&4294967295|g>>>22),g=w+(m^(T|~v))+I[6]+2734768916&4294967295,w=T+(g<<15&4294967295|g>>>17),g=v+(T^(w|~m))+I[13]+1309151649&4294967295,v=w+(g<<21&4294967295|g>>>11),g=m+(w^(v|~T))+I[4]+4149444226&4294967295,m=v+(g<<6&4294967295|g>>>26),g=T+(v^(m|~w))+I[11]+3174756917&4294967295,T=m+(g<<10&4294967295|g>>>22),g=w+(m^(T|~v))+I[2]+718787259&4294967295,w=T+(g<<15&4294967295|g>>>17),g=v+(T^(w|~m))+I[9]+3951481745&4294967295,b.g[0]=b.g[0]+m&4294967295,b.g[1]=b.g[1]+(w+(g<<21&4294967295|g>>>11))&4294967295,b.g[2]=b.g[2]+w&4294967295,b.g[3]=b.g[3]+T&4294967295}r.prototype.u=function(b,m){m===void 0&&(m=b.length);for(var v=m-this.blockSize,I=this.B,w=this.h,T=0;T<m;){if(w==0)for(;T<=v;)i(this,b,T),T+=this.blockSize;if(typeof b=="string"){for(;T<m;)if(I[w++]=b.charCodeAt(T++),w==this.blockSize){i(this,I),w=0;break}}else for(;T<m;)if(I[w++]=b[T++],w==this.blockSize){i(this,I),w=0;break}}this.h=w,this.o+=m},r.prototype.v=function(){var b=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);b[0]=128;for(var m=1;m<b.length-8;++m)b[m]=0;var v=8*this.o;for(m=b.length-8;m<b.length;++m)b[m]=v&255,v/=256;for(this.u(b),b=Array(16),m=v=0;4>m;++m)for(var I=0;32>I;I+=8)b[v++]=this.g[m]>>>I&255;return b};function o(b,m){var v=c;return Object.prototype.hasOwnProperty.call(v,b)?v[b]:v[b]=m(b)}function a(b,m){this.h=m;for(var v=[],I=!0,w=b.length-1;0<=w;w--){var T=b[w]|0;I&&T==m||(v[w]=T,I=!1)}this.g=v}var c={};function u(b){return-128<=b&&128>b?o(b,function(m){return new a([m|0],0>m?-1:0)}):new a([b|0],0>b?-1:0)}function h(b){if(isNaN(b)||!isFinite(b))return y;if(0>b)return P(h(-b));for(var m=[],v=1,I=0;b>=v;I++)m[I]=b/v|0,v*=4294967296;return new a(m,0)}function f(b,m){if(b.length==0)throw Error("number format error: empty string");if(m=m||10,2>m||36<m)throw Error("radix out of range: "+m);if(b.charAt(0)=="-")return P(f(b.substring(1),m));if(0<=b.indexOf("-"))throw Error('number format error: interior "-" character');for(var v=h(Math.pow(m,8)),I=y,w=0;w<b.length;w+=8){var T=Math.min(8,b.length-w),g=parseInt(b.substring(w,w+T),m);8>T?(T=h(Math.pow(m,T)),I=I.j(T).add(h(g))):(I=I.j(v),I=I.add(h(g)))}return I}var y=u(0),_=u(1),A=u(16777216);n=a.prototype,n.m=function(){if(C(this))return-P(this).m();for(var b=0,m=1,v=0;v<this.g.length;v++){var I=this.i(v);b+=(0<=I?I:4294967296+I)*m,m*=4294967296}return b},n.toString=function(b){if(b=b||10,2>b||36<b)throw Error("radix out of range: "+b);if(E(this))return"0";if(C(this))return"-"+P(this).toString(b);for(var m=h(Math.pow(b,6)),v=this,I="";;){var w=M(v,m).g;v=k(v,w.j(m));var T=((0<v.g.length?v.g[0]:v.h)>>>0).toString(b);if(v=w,E(v))return T+I;for(;6>T.length;)T="0"+T;I=T+I}},n.i=function(b){return 0>b?0:b<this.g.length?this.g[b]:this.h};function E(b){if(b.h!=0)return!1;for(var m=0;m<b.g.length;m++)if(b.g[m]!=0)return!1;return!0}function C(b){return b.h==-1}n.l=function(b){return b=k(this,b),C(b)?-1:E(b)?0:1};function P(b){for(var m=b.g.length,v=[],I=0;I<m;I++)v[I]=~b.g[I];return new a(v,~b.h).add(_)}n.abs=function(){return C(this)?P(this):this},n.add=function(b){for(var m=Math.max(this.g.length,b.g.length),v=[],I=0,w=0;w<=m;w++){var T=I+(this.i(w)&65535)+(b.i(w)&65535),g=(T>>>16)+(this.i(w)>>>16)+(b.i(w)>>>16);I=g>>>16,T&=65535,g&=65535,v[w]=g<<16|T}return new a(v,v[v.length-1]&-2147483648?-1:0)};function k(b,m){return b.add(P(m))}n.j=function(b){if(E(this)||E(b))return y;if(C(this))return C(b)?P(this).j(P(b)):P(P(this).j(b));if(C(b))return P(this.j(P(b)));if(0>this.l(A)&&0>b.l(A))return h(this.m()*b.m());for(var m=this.g.length+b.g.length,v=[],I=0;I<2*m;I++)v[I]=0;for(I=0;I<this.g.length;I++)for(var w=0;w<b.g.length;w++){var T=this.i(I)>>>16,g=this.i(I)&65535,Ft=b.i(w)>>>16,He=b.i(w)&65535;v[2*I+2*w]+=g*He,D(v,2*I+2*w),v[2*I+2*w+1]+=T*He,D(v,2*I+2*w+1),v[2*I+2*w+1]+=g*Ft,D(v,2*I+2*w+1),v[2*I+2*w+2]+=T*Ft,D(v,2*I+2*w+2)}for(I=0;I<m;I++)v[I]=v[2*I+1]<<16|v[2*I];for(I=m;I<2*m;I++)v[I]=0;return new a(v,0)};function D(b,m){for(;(b[m]&65535)!=b[m];)b[m+1]+=b[m]>>>16,b[m]&=65535,m++}function N(b,m){this.g=b,this.h=m}function M(b,m){if(E(m))throw Error("division by zero");if(E(b))return new N(y,y);if(C(b))return m=M(P(b),m),new N(P(m.g),P(m.h));if(C(m))return m=M(b,P(m)),new N(P(m.g),m.h);if(30<b.g.length){if(C(b)||C(m))throw Error("slowDivide_ only works with positive integers.");for(var v=_,I=m;0>=I.l(b);)v=nt(v),I=nt(I);var w=j(v,1),T=j(I,1);for(I=j(I,2),v=j(v,2);!E(I);){var g=T.add(I);0>=g.l(b)&&(w=w.add(v),T=g),I=j(I,1),v=j(v,1)}return m=k(b,w.j(m)),new N(w,m)}for(w=y;0<=b.l(m);){for(v=Math.max(1,Math.floor(b.m()/m.m())),I=Math.ceil(Math.log(v)/Math.LN2),I=48>=I?1:Math.pow(2,I-48),T=h(v),g=T.j(m);C(g)||0<g.l(b);)v-=I,T=h(v),g=T.j(m);E(T)&&(T=_),w=w.add(T),b=k(b,g)}return new N(w,b)}n.A=function(b){return M(this,b).h},n.and=function(b){for(var m=Math.max(this.g.length,b.g.length),v=[],I=0;I<m;I++)v[I]=this.i(I)&b.i(I);return new a(v,this.h&b.h)},n.or=function(b){for(var m=Math.max(this.g.length,b.g.length),v=[],I=0;I<m;I++)v[I]=this.i(I)|b.i(I);return new a(v,this.h|b.h)},n.xor=function(b){for(var m=Math.max(this.g.length,b.g.length),v=[],I=0;I<m;I++)v[I]=this.i(I)^b.i(I);return new a(v,this.h^b.h)};function nt(b){for(var m=b.g.length+1,v=[],I=0;I<m;I++)v[I]=b.i(I)<<1|b.i(I-1)>>>31;return new a(v,b.h)}function j(b,m){var v=m>>5;m%=32;for(var I=b.g.length-v,w=[],T=0;T<I;T++)w[T]=0<m?b.i(T+v)>>>m|b.i(T+v+1)<<32-m:b.i(T+v);return new a(w,b.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,ol=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=h,a.fromString=f,de=a}).apply(typeof na<"u"?na:typeof self<"u"?self:typeof window<"u"?window:{});var ir=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var al,ln,ll,cr,Li,cl,ul,dl;(function(){var n,t=typeof Object.defineProperties=="function"?Object.defineProperty:function(s,l,d){return s==Array.prototype||s==Object.prototype||(s[l]=d.value),s};function e(s){s=[typeof globalThis=="object"&&globalThis,s,typeof window=="object"&&window,typeof self=="object"&&self,typeof ir=="object"&&ir];for(var l=0;l<s.length;++l){var d=s[l];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var r=e(this);function i(s,l){if(l)t:{var d=r;s=s.split(".");for(var p=0;p<s.length-1;p++){var x=s[p];if(!(x in d))break t;d=d[x]}s=s[s.length-1],p=d[s],l=l(p),l!=p&&l!=null&&t(d,s,{configurable:!0,writable:!0,value:l})}}function o(s,l){s instanceof String&&(s+="");var d=0,p=!1,x={next:function(){if(!p&&d<s.length){var R=d++;return{value:l(R,s[R]),done:!1}}return p=!0,{done:!0,value:void 0}}};return x[Symbol.iterator]=function(){return x},x}i("Array.prototype.values",function(s){return s||function(){return o(this,function(l,d){return d})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var a=a||{},c=this||self;function u(s){var l=typeof s;return l=l!="object"?l:s?Array.isArray(s)?"array":l:"null",l=="array"||l=="object"&&typeof s.length=="number"}function h(s){var l=typeof s;return l=="object"&&s!=null||l=="function"}function f(s,l,d){return s.call.apply(s.bind,arguments)}function y(s,l,d){if(!s)throw Error();if(2<arguments.length){var p=Array.prototype.slice.call(arguments,2);return function(){var x=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(x,p),s.apply(l,x)}}return function(){return s.apply(l,arguments)}}function _(s,l,d){return _=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?f:y,_.apply(null,arguments)}function A(s,l){var d=Array.prototype.slice.call(arguments,1);return function(){var p=d.slice();return p.push.apply(p,arguments),s.apply(this,p)}}function E(s,l){function d(){}d.prototype=l.prototype,s.aa=l.prototype,s.prototype=new d,s.prototype.constructor=s,s.Qb=function(p,x,R){for(var L=Array(arguments.length-2),X=2;X<arguments.length;X++)L[X-2]=arguments[X];return l.prototype[x].apply(p,L)}}function C(s){const l=s.length;if(0<l){const d=Array(l);for(let p=0;p<l;p++)d[p]=s[p];return d}return[]}function P(s,l){for(let d=1;d<arguments.length;d++){const p=arguments[d];if(u(p)){const x=s.length||0,R=p.length||0;s.length=x+R;for(let L=0;L<R;L++)s[x+L]=p[L]}else s.push(p)}}class k{constructor(l,d){this.i=l,this.j=d,this.h=0,this.g=null}get(){let l;return 0<this.h?(this.h--,l=this.g,this.g=l.next,l.next=null):l=this.i(),l}}function D(s){return/^[\s\xa0]*$/.test(s)}function N(){var s=c.navigator;return s&&(s=s.userAgent)?s:""}function M(s){return M[" "](s),s}M[" "]=function(){};var nt=N().indexOf("Gecko")!=-1&&!(N().toLowerCase().indexOf("webkit")!=-1&&N().indexOf("Edge")==-1)&&!(N().indexOf("Trident")!=-1||N().indexOf("MSIE")!=-1)&&N().indexOf("Edge")==-1;function j(s,l,d){for(const p in s)l.call(d,s[p],p,s)}function b(s,l){for(const d in s)l.call(void 0,s[d],d,s)}function m(s){const l={};for(const d in s)l[d]=s[d];return l}const v="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function I(s,l){let d,p;for(let x=1;x<arguments.length;x++){p=arguments[x];for(d in p)s[d]=p[d];for(let R=0;R<v.length;R++)d=v[R],Object.prototype.hasOwnProperty.call(p,d)&&(s[d]=p[d])}}function w(s){var l=1;s=s.split(":");const d=[];for(;0<l&&s.length;)d.push(s.shift()),l--;return s.length&&d.push(s.join(":")),d}function T(s){c.setTimeout(()=>{throw s},0)}function g(){var s=Qr;let l=null;return s.g&&(l=s.g,s.g=s.g.next,s.g||(s.h=null),l.next=null),l}class Ft{constructor(){this.h=this.g=null}add(l,d){const p=He.get();p.set(l,d),this.h?this.h.next=p:this.g=p,this.h=p}}var He=new k(()=>new Gc,s=>s.reset());class Gc{constructor(){this.next=this.g=this.h=null}set(l,d){this.h=l,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let Ue,We=!1,Qr=new Ft,Ws=()=>{const s=c.Promise.resolve(void 0);Ue=()=>{s.then(Kc)}};var Kc=()=>{for(var s;s=g();){try{s.h.call(s.g)}catch(d){T(d)}var l=He;l.j(s),100>l.h&&(l.h++,s.next=l.g,l.g=s)}We=!1};function Qt(){this.s=this.s,this.C=this.C}Qt.prototype.s=!1,Qt.prototype.ma=function(){this.s||(this.s=!0,this.N())},Qt.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function pt(s,l){this.type=s,this.g=this.target=l,this.defaultPrevented=!1}pt.prototype.h=function(){this.defaultPrevented=!0};var Xc=function(){if(!c.addEventListener||!Object.defineProperty)return!1;var s=!1,l=Object.defineProperty({},"passive",{get:function(){s=!0}});try{const d=()=>{};c.addEventListener("test",d,l),c.removeEventListener("test",d,l)}catch{}return s}();function Qe(s,l){if(pt.call(this,s?s.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,s){var d=this.type=s.type,p=s.changedTouches&&s.changedTouches.length?s.changedTouches[0]:null;if(this.target=s.target||s.srcElement,this.g=l,l=s.relatedTarget){if(nt){t:{try{M(l.nodeName);var x=!0;break t}catch{}x=!1}x||(l=null)}}else d=="mouseover"?l=s.fromElement:d=="mouseout"&&(l=s.toElement);this.relatedTarget=l,p?(this.clientX=p.clientX!==void 0?p.clientX:p.pageX,this.clientY=p.clientY!==void 0?p.clientY:p.pageY,this.screenX=p.screenX||0,this.screenY=p.screenY||0):(this.clientX=s.clientX!==void 0?s.clientX:s.pageX,this.clientY=s.clientY!==void 0?s.clientY:s.pageY,this.screenX=s.screenX||0,this.screenY=s.screenY||0),this.button=s.button,this.key=s.key||"",this.ctrlKey=s.ctrlKey,this.altKey=s.altKey,this.shiftKey=s.shiftKey,this.metaKey=s.metaKey,this.pointerId=s.pointerId||0,this.pointerType=typeof s.pointerType=="string"?s.pointerType:Jc[s.pointerType]||"",this.state=s.state,this.i=s,s.defaultPrevented&&Qe.aa.h.call(this)}}E(Qe,pt);var Jc={2:"touch",3:"pen",4:"mouse"};Qe.prototype.h=function(){Qe.aa.h.call(this);var s=this.i;s.preventDefault?s.preventDefault():s.returnValue=!1};var Fn="closure_listenable_"+(1e6*Math.random()|0),Zc=0;function Yc(s,l,d,p,x){this.listener=s,this.proxy=null,this.src=l,this.type=d,this.capture=!!p,this.ha=x,this.key=++Zc,this.da=this.fa=!1}function jn(s){s.da=!0,s.listener=null,s.proxy=null,s.src=null,s.ha=null}function zn(s){this.src=s,this.g={},this.h=0}zn.prototype.add=function(s,l,d,p,x){var R=s.toString();s=this.g[R],s||(s=this.g[R]=[],this.h++);var L=Gr(s,l,p,x);return-1<L?(l=s[L],d||(l.fa=!1)):(l=new Yc(l,this.src,R,!!p,x),l.fa=d,s.push(l)),l};function $r(s,l){var d=l.type;if(d in s.g){var p=s.g[d],x=Array.prototype.indexOf.call(p,l,void 0),R;(R=0<=x)&&Array.prototype.splice.call(p,x,1),R&&(jn(l),s.g[d].length==0&&(delete s.g[d],s.h--))}}function Gr(s,l,d,p){for(var x=0;x<s.length;++x){var R=s[x];if(!R.da&&R.listener==l&&R.capture==!!d&&R.ha==p)return x}return-1}var Kr="closure_lm_"+(1e6*Math.random()|0),Xr={};function Qs(s,l,d,p,x){if(Array.isArray(l)){for(var R=0;R<l.length;R++)Qs(s,l[R],d,p,x);return null}return d=Ks(d),s&&s[Fn]?s.K(l,d,h(p)?!!p.capture:!1,x):tu(s,l,d,!1,p,x)}function tu(s,l,d,p,x,R){if(!l)throw Error("Invalid event type");var L=h(x)?!!x.capture:!!x,X=Zr(s);if(X||(s[Kr]=X=new zn(s)),d=X.add(l,d,p,L,R),d.proxy)return d;if(p=eu(),d.proxy=p,p.src=s,p.listener=d,s.addEventListener)Xc||(x=L),x===void 0&&(x=!1),s.addEventListener(l.toString(),p,x);else if(s.attachEvent)s.attachEvent(Gs(l.toString()),p);else if(s.addListener&&s.removeListener)s.addListener(p);else throw Error("addEventListener and attachEvent are unavailable.");return d}function eu(){function s(d){return l.call(s.src,s.listener,d)}const l=nu;return s}function $s(s,l,d,p,x){if(Array.isArray(l))for(var R=0;R<l.length;R++)$s(s,l[R],d,p,x);else p=h(p)?!!p.capture:!!p,d=Ks(d),s&&s[Fn]?(s=s.i,l=String(l).toString(),l in s.g&&(R=s.g[l],d=Gr(R,d,p,x),-1<d&&(jn(R[d]),Array.prototype.splice.call(R,d,1),R.length==0&&(delete s.g[l],s.h--)))):s&&(s=Zr(s))&&(l=s.g[l.toString()],s=-1,l&&(s=Gr(l,d,p,x)),(d=-1<s?l[s]:null)&&Jr(d))}function Jr(s){if(typeof s!="number"&&s&&!s.da){var l=s.src;if(l&&l[Fn])$r(l.i,s);else{var d=s.type,p=s.proxy;l.removeEventListener?l.removeEventListener(d,p,s.capture):l.detachEvent?l.detachEvent(Gs(d),p):l.addListener&&l.removeListener&&l.removeListener(p),(d=Zr(l))?($r(d,s),d.h==0&&(d.src=null,l[Kr]=null)):jn(s)}}}function Gs(s){return s in Xr?Xr[s]:Xr[s]="on"+s}function nu(s,l){if(s.da)s=!0;else{l=new Qe(l,this);var d=s.listener,p=s.ha||s.src;s.fa&&Jr(s),s=d.call(p,l)}return s}function Zr(s){return s=s[Kr],s instanceof zn?s:null}var Yr="__closure_events_fn_"+(1e9*Math.random()>>>0);function Ks(s){return typeof s=="function"?s:(s[Yr]||(s[Yr]=function(l){return s.handleEvent(l)}),s[Yr])}function ft(){Qt.call(this),this.i=new zn(this),this.M=this,this.F=null}E(ft,Qt),ft.prototype[Fn]=!0,ft.prototype.removeEventListener=function(s,l,d,p){$s(this,s,l,d,p)};function Et(s,l){var d,p=s.F;if(p)for(d=[];p;p=p.F)d.push(p);if(s=s.M,p=l.type||l,typeof l=="string")l=new pt(l,s);else if(l instanceof pt)l.target=l.target||s;else{var x=l;l=new pt(p,s),I(l,x)}if(x=!0,d)for(var R=d.length-1;0<=R;R--){var L=l.g=d[R];x=qn(L,p,!0,l)&&x}if(L=l.g=s,x=qn(L,p,!0,l)&&x,x=qn(L,p,!1,l)&&x,d)for(R=0;R<d.length;R++)L=l.g=d[R],x=qn(L,p,!1,l)&&x}ft.prototype.N=function(){if(ft.aa.N.call(this),this.i){var s=this.i,l;for(l in s.g){for(var d=s.g[l],p=0;p<d.length;p++)jn(d[p]);delete s.g[l],s.h--}}this.F=null},ft.prototype.K=function(s,l,d,p){return this.i.add(String(s),l,!1,d,p)},ft.prototype.L=function(s,l,d,p){return this.i.add(String(s),l,!0,d,p)};function qn(s,l,d,p){if(l=s.i.g[String(l)],!l)return!0;l=l.concat();for(var x=!0,R=0;R<l.length;++R){var L=l[R];if(L&&!L.da&&L.capture==d){var X=L.listener,lt=L.ha||L.src;L.fa&&$r(s.i,L),x=X.call(lt,p)!==!1&&x}}return x&&!p.defaultPrevented}function Xs(s,l,d){if(typeof s=="function")d&&(s=_(s,d));else if(s&&typeof s.handleEvent=="function")s=_(s.handleEvent,s);else throw Error("Invalid listener argument");return 2147483647<Number(l)?-1:c.setTimeout(s,l||0)}function Js(s){s.g=Xs(()=>{s.g=null,s.i&&(s.i=!1,Js(s))},s.l);const l=s.h;s.h=null,s.m.apply(null,l)}class ru extends Qt{constructor(l,d){super(),this.m=l,this.l=d,this.h=null,this.i=!1,this.g=null}j(l){this.h=arguments,this.g?this.i=!0:Js(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function $e(s){Qt.call(this),this.h=s,this.g={}}E($e,Qt);var Zs=[];function Ys(s){j(s.g,function(l,d){this.g.hasOwnProperty(d)&&Jr(l)},s),s.g={}}$e.prototype.N=function(){$e.aa.N.call(this),Ys(this)},$e.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var ti=c.JSON.stringify,iu=c.JSON.parse,su=class{stringify(s){return c.JSON.stringify(s,void 0)}parse(s){return c.JSON.parse(s,void 0)}};function ei(){}ei.prototype.h=null;function to(s){return s.h||(s.h=s.i())}function eo(){}var Ge={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function ni(){pt.call(this,"d")}E(ni,pt);function ri(){pt.call(this,"c")}E(ri,pt);var se={},no=null;function Hn(){return no=no||new ft}se.La="serverreachability";function ro(s){pt.call(this,se.La,s)}E(ro,pt);function Ke(s){const l=Hn();Et(l,new ro(l))}se.STAT_EVENT="statevent";function io(s,l){pt.call(this,se.STAT_EVENT,s),this.stat=l}E(io,pt);function It(s){const l=Hn();Et(l,new io(l,s))}se.Ma="timingevent";function so(s,l){pt.call(this,se.Ma,s),this.size=l}E(so,pt);function Xe(s,l){if(typeof s!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){s()},l)}function Je(){this.g=!0}Je.prototype.xa=function(){this.g=!1};function ou(s,l,d,p,x,R){s.info(function(){if(s.g)if(R)for(var L="",X=R.split("&"),lt=0;lt<X.length;lt++){var $=X[lt].split("=");if(1<$.length){var mt=$[0];$=$[1];var gt=mt.split("_");L=2<=gt.length&&gt[1]=="type"?L+(mt+"="+$+"&"):L+(mt+"=redacted&")}}else L=null;else L=R;return"XMLHTTP REQ ("+p+") [attempt "+x+"]: "+l+`
`+d+`
`+L})}function au(s,l,d,p,x,R,L){s.info(function(){return"XMLHTTP RESP ("+p+") [ attempt "+x+"]: "+l+`
`+d+`
`+R+" "+L})}function ye(s,l,d,p){s.info(function(){return"XMLHTTP TEXT ("+l+"): "+cu(s,d)+(p?" "+p:"")})}function lu(s,l){s.info(function(){return"TIMEOUT: "+l})}Je.prototype.info=function(){};function cu(s,l){if(!s.g)return l;if(!l)return null;try{var d=JSON.parse(l);if(d){for(s=0;s<d.length;s++)if(Array.isArray(d[s])){var p=d[s];if(!(2>p.length)){var x=p[1];if(Array.isArray(x)&&!(1>x.length)){var R=x[0];if(R!="noop"&&R!="stop"&&R!="close")for(var L=1;L<x.length;L++)x[L]=""}}}}return ti(d)}catch{return l}}var Un={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},oo={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},ii;function Wn(){}E(Wn,ei),Wn.prototype.g=function(){return new XMLHttpRequest},Wn.prototype.i=function(){return{}},ii=new Wn;function $t(s,l,d,p){this.j=s,this.i=l,this.l=d,this.R=p||1,this.U=new $e(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new ao}function ao(){this.i=null,this.g="",this.h=!1}var lo={},si={};function oi(s,l,d){s.L=1,s.v=Kn(jt(l)),s.m=d,s.P=!0,co(s,null)}function co(s,l){s.F=Date.now(),Qn(s),s.A=jt(s.v);var d=s.A,p=s.R;Array.isArray(p)||(p=[String(p)]),wo(d.i,"t",p),s.C=0,d=s.j.J,s.h=new ao,s.g=qo(s.j,d?l:null,!s.m),0<s.O&&(s.M=new ru(_(s.Y,s,s.g),s.O)),l=s.U,d=s.g,p=s.ca;var x="readystatechange";Array.isArray(x)||(x&&(Zs[0]=x.toString()),x=Zs);for(var R=0;R<x.length;R++){var L=Qs(d,x[R],p||l.handleEvent,!1,l.h||l);if(!L)break;l.g[L.key]=L}l=s.H?m(s.H):{},s.m?(s.u||(s.u="POST"),l["Content-Type"]="application/x-www-form-urlencoded",s.g.ea(s.A,s.u,s.m,l)):(s.u="GET",s.g.ea(s.A,s.u,null,l)),Ke(),ou(s.i,s.u,s.A,s.l,s.R,s.m)}$t.prototype.ca=function(s){s=s.target;const l=this.M;l&&zt(s)==3?l.j():this.Y(s)},$t.prototype.Y=function(s){try{if(s==this.g)t:{const gt=zt(this.g);var l=this.g.Ba();const _e=this.g.Z();if(!(3>gt)&&(gt!=3||this.g&&(this.h.h||this.g.oa()||Vo(this.g)))){this.J||gt!=4||l==7||(l==8||0>=_e?Ke(3):Ke(2)),ai(this);var d=this.g.Z();this.X=d;e:if(uo(this)){var p=Vo(this.g);s="";var x=p.length,R=zt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){oe(this),Ze(this);var L="";break e}this.h.i=new c.TextDecoder}for(l=0;l<x;l++)this.h.h=!0,s+=this.h.i.decode(p[l],{stream:!(R&&l==x-1)});p.length=0,this.h.g+=s,this.C=0,L=this.h.g}else L=this.g.oa();if(this.o=d==200,au(this.i,this.u,this.A,this.l,this.R,gt,d),this.o){if(this.T&&!this.K){e:{if(this.g){var X,lt=this.g;if((X=lt.g?lt.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!D(X)){var $=X;break e}}$=null}if(d=$)ye(this.i,this.l,d,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,li(this,d);else{this.o=!1,this.s=3,It(12),oe(this),Ze(this);break t}}if(this.P){d=!0;let Vt;for(;!this.J&&this.C<L.length;)if(Vt=uu(this,L),Vt==si){gt==4&&(this.s=4,It(14),d=!1),ye(this.i,this.l,null,"[Incomplete Response]");break}else if(Vt==lo){this.s=4,It(15),ye(this.i,this.l,L,"[Invalid Chunk]"),d=!1;break}else ye(this.i,this.l,Vt,null),li(this,Vt);if(uo(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),gt!=4||L.length!=0||this.h.h||(this.s=1,It(16),d=!1),this.o=this.o&&d,!d)ye(this.i,this.l,L,"[Invalid Chunked Response]"),oe(this),Ze(this);else if(0<L.length&&!this.W){this.W=!0;var mt=this.j;mt.g==this&&mt.ba&&!mt.M&&(mt.j.info("Great, no buffering proxy detected. Bytes received: "+L.length),fi(mt),mt.M=!0,It(11))}}else ye(this.i,this.l,L,null),li(this,L);gt==4&&oe(this),this.o&&!this.J&&(gt==4?Oo(this.j,this):(this.o=!1,Qn(this)))}else Ru(this.g),d==400&&0<L.indexOf("Unknown SID")?(this.s=3,It(12)):(this.s=0,It(13)),oe(this),Ze(this)}}}catch{}finally{}};function uo(s){return s.g?s.u=="GET"&&s.L!=2&&s.j.Ca:!1}function uu(s,l){var d=s.C,p=l.indexOf(`
`,d);return p==-1?si:(d=Number(l.substring(d,p)),isNaN(d)?lo:(p+=1,p+d>l.length?si:(l=l.slice(p,p+d),s.C=p+d,l)))}$t.prototype.cancel=function(){this.J=!0,oe(this)};function Qn(s){s.S=Date.now()+s.I,ho(s,s.I)}function ho(s,l){if(s.B!=null)throw Error("WatchDog timer not null");s.B=Xe(_(s.ba,s),l)}function ai(s){s.B&&(c.clearTimeout(s.B),s.B=null)}$t.prototype.ba=function(){this.B=null;const s=Date.now();0<=s-this.S?(lu(this.i,this.A),this.L!=2&&(Ke(),It(17)),oe(this),this.s=2,Ze(this)):ho(this,this.S-s)};function Ze(s){s.j.G==0||s.J||Oo(s.j,s)}function oe(s){ai(s);var l=s.M;l&&typeof l.ma=="function"&&l.ma(),s.M=null,Ys(s.U),s.g&&(l=s.g,s.g=null,l.abort(),l.ma())}function li(s,l){try{var d=s.j;if(d.G!=0&&(d.g==s||ci(d.h,s))){if(!s.K&&ci(d.h,s)&&d.G==3){try{var p=d.Da.g.parse(l)}catch{p=null}if(Array.isArray(p)&&p.length==3){var x=p;if(x[0]==0){t:if(!d.u){if(d.g)if(d.g.F+3e3<s.F)er(d),Yn(d);else break t;pi(d),It(18)}}else d.za=x[1],0<d.za-d.T&&37500>x[2]&&d.F&&d.v==0&&!d.C&&(d.C=Xe(_(d.Za,d),6e3));if(1>=mo(d.h)&&d.ca){try{d.ca()}catch{}d.ca=void 0}}else le(d,11)}else if((s.K||d.g==s)&&er(d),!D(l))for(x=d.Da.g.parse(l),l=0;l<x.length;l++){let $=x[l];if(d.T=$[0],$=$[1],d.G==2)if($[0]=="c"){d.K=$[1],d.ia=$[2];const mt=$[3];mt!=null&&(d.la=mt,d.j.info("VER="+d.la));const gt=$[4];gt!=null&&(d.Aa=gt,d.j.info("SVER="+d.Aa));const _e=$[5];_e!=null&&typeof _e=="number"&&0<_e&&(p=1.5*_e,d.L=p,d.j.info("backChannelRequestTimeoutMs_="+p)),p=d;const Vt=s.g;if(Vt){const rr=Vt.g?Vt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(rr){var R=p.h;R.g||rr.indexOf("spdy")==-1&&rr.indexOf("quic")==-1&&rr.indexOf("h2")==-1||(R.j=R.l,R.g=new Set,R.h&&(ui(R,R.h),R.h=null))}if(p.D){const mi=Vt.g?Vt.g.getResponseHeader("X-HTTP-Session-Id"):null;mi&&(p.ya=mi,J(p.I,p.D,mi))}}d.G=3,d.l&&d.l.ua(),d.ba&&(d.R=Date.now()-s.F,d.j.info("Handshake RTT: "+d.R+"ms")),p=d;var L=s;if(p.qa=zo(p,p.J?p.ia:null,p.W),L.K){go(p.h,L);var X=L,lt=p.L;lt&&(X.I=lt),X.B&&(ai(X),Qn(X)),p.g=L}else Bo(p);0<d.i.length&&tr(d)}else $[0]!="stop"&&$[0]!="close"||le(d,7);else d.G==3&&($[0]=="stop"||$[0]=="close"?$[0]=="stop"?le(d,7):hi(d):$[0]!="noop"&&d.l&&d.l.ta($),d.v=0)}}Ke(4)}catch{}}var du=class{constructor(s,l){this.g=s,this.map=l}};function po(s){this.l=s||10,c.PerformanceNavigationTiming?(s=c.performance.getEntriesByType("navigation"),s=0<s.length&&(s[0].nextHopProtocol=="hq"||s[0].nextHopProtocol=="h2")):s=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=s?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function fo(s){return s.h?!0:s.g?s.g.size>=s.j:!1}function mo(s){return s.h?1:s.g?s.g.size:0}function ci(s,l){return s.h?s.h==l:s.g?s.g.has(l):!1}function ui(s,l){s.g?s.g.add(l):s.h=l}function go(s,l){s.h&&s.h==l?s.h=null:s.g&&s.g.has(l)&&s.g.delete(l)}po.prototype.cancel=function(){if(this.i=yo(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const s of this.g.values())s.cancel();this.g.clear()}};function yo(s){if(s.h!=null)return s.i.concat(s.h.D);if(s.g!=null&&s.g.size!==0){let l=s.i;for(const d of s.g.values())l=l.concat(d.D);return l}return C(s.i)}function hu(s){if(s.V&&typeof s.V=="function")return s.V();if(typeof Map<"u"&&s instanceof Map||typeof Set<"u"&&s instanceof Set)return Array.from(s.values());if(typeof s=="string")return s.split("");if(u(s)){for(var l=[],d=s.length,p=0;p<d;p++)l.push(s[p]);return l}l=[],d=0;for(p in s)l[d++]=s[p];return l}function pu(s){if(s.na&&typeof s.na=="function")return s.na();if(!s.V||typeof s.V!="function"){if(typeof Map<"u"&&s instanceof Map)return Array.from(s.keys());if(!(typeof Set<"u"&&s instanceof Set)){if(u(s)||typeof s=="string"){var l=[];s=s.length;for(var d=0;d<s;d++)l.push(d);return l}l=[],d=0;for(const p in s)l[d++]=p;return l}}}function vo(s,l){if(s.forEach&&typeof s.forEach=="function")s.forEach(l,void 0);else if(u(s)||typeof s=="string")Array.prototype.forEach.call(s,l,void 0);else for(var d=pu(s),p=hu(s),x=p.length,R=0;R<x;R++)l.call(void 0,p[R],d&&d[R],s)}var Ao=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function fu(s,l){if(s){s=s.split("&");for(var d=0;d<s.length;d++){var p=s[d].indexOf("="),x=null;if(0<=p){var R=s[d].substring(0,p);x=s[d].substring(p+1)}else R=s[d];l(R,x?decodeURIComponent(x.replace(/\+/g," ")):"")}}}function ae(s){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,s instanceof ae){this.h=s.h,$n(this,s.j),this.o=s.o,this.g=s.g,Gn(this,s.s),this.l=s.l;var l=s.i,d=new en;d.i=l.i,l.g&&(d.g=new Map(l.g),d.h=l.h),_o(this,d),this.m=s.m}else s&&(l=String(s).match(Ao))?(this.h=!1,$n(this,l[1]||"",!0),this.o=Ye(l[2]||""),this.g=Ye(l[3]||"",!0),Gn(this,l[4]),this.l=Ye(l[5]||"",!0),_o(this,l[6]||"",!0),this.m=Ye(l[7]||"")):(this.h=!1,this.i=new en(null,this.h))}ae.prototype.toString=function(){var s=[],l=this.j;l&&s.push(tn(l,Eo,!0),":");var d=this.g;return(d||l=="file")&&(s.push("//"),(l=this.o)&&s.push(tn(l,Eo,!0),"@"),s.push(encodeURIComponent(String(d)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.s,d!=null&&s.push(":",String(d))),(d=this.l)&&(this.g&&d.charAt(0)!="/"&&s.push("/"),s.push(tn(d,d.charAt(0)=="/"?yu:gu,!0))),(d=this.i.toString())&&s.push("?",d),(d=this.m)&&s.push("#",tn(d,Au)),s.join("")};function jt(s){return new ae(s)}function $n(s,l,d){s.j=d?Ye(l,!0):l,s.j&&(s.j=s.j.replace(/:$/,""))}function Gn(s,l){if(l){if(l=Number(l),isNaN(l)||0>l)throw Error("Bad port number "+l);s.s=l}else s.s=null}function _o(s,l,d){l instanceof en?(s.i=l,_u(s.i,s.h)):(d||(l=tn(l,vu)),s.i=new en(l,s.h))}function J(s,l,d){s.i.set(l,d)}function Kn(s){return J(s,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),s}function Ye(s,l){return s?l?decodeURI(s.replace(/%25/g,"%2525")):decodeURIComponent(s):""}function tn(s,l,d){return typeof s=="string"?(s=encodeURI(s).replace(l,mu),d&&(s=s.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),s):null}function mu(s){return s=s.charCodeAt(0),"%"+(s>>4&15).toString(16)+(s&15).toString(16)}var Eo=/[#\/\?@]/g,gu=/[#\?:]/g,yu=/[#\?]/g,vu=/[#\?@]/g,Au=/#/g;function en(s,l){this.h=this.g=null,this.i=s||null,this.j=!!l}function Gt(s){s.g||(s.g=new Map,s.h=0,s.i&&fu(s.i,function(l,d){s.add(decodeURIComponent(l.replace(/\+/g," ")),d)}))}n=en.prototype,n.add=function(s,l){Gt(this),this.i=null,s=ve(this,s);var d=this.g.get(s);return d||this.g.set(s,d=[]),d.push(l),this.h+=1,this};function Io(s,l){Gt(s),l=ve(s,l),s.g.has(l)&&(s.i=null,s.h-=s.g.get(l).length,s.g.delete(l))}function bo(s,l){return Gt(s),l=ve(s,l),s.g.has(l)}n.forEach=function(s,l){Gt(this),this.g.forEach(function(d,p){d.forEach(function(x){s.call(l,x,p,this)},this)},this)},n.na=function(){Gt(this);const s=Array.from(this.g.values()),l=Array.from(this.g.keys()),d=[];for(let p=0;p<l.length;p++){const x=s[p];for(let R=0;R<x.length;R++)d.push(l[p])}return d},n.V=function(s){Gt(this);let l=[];if(typeof s=="string")bo(this,s)&&(l=l.concat(this.g.get(ve(this,s))));else{s=Array.from(this.g.values());for(let d=0;d<s.length;d++)l=l.concat(s[d])}return l},n.set=function(s,l){return Gt(this),this.i=null,s=ve(this,s),bo(this,s)&&(this.h-=this.g.get(s).length),this.g.set(s,[l]),this.h+=1,this},n.get=function(s,l){return s?(s=this.V(s),0<s.length?String(s[0]):l):l};function wo(s,l,d){Io(s,l),0<d.length&&(s.i=null,s.g.set(ve(s,l),C(d)),s.h+=d.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const s=[],l=Array.from(this.g.keys());for(var d=0;d<l.length;d++){var p=l[d];const R=encodeURIComponent(String(p)),L=this.V(p);for(p=0;p<L.length;p++){var x=R;L[p]!==""&&(x+="="+encodeURIComponent(String(L[p]))),s.push(x)}}return this.i=s.join("&")};function ve(s,l){return l=String(l),s.j&&(l=l.toLowerCase()),l}function _u(s,l){l&&!s.j&&(Gt(s),s.i=null,s.g.forEach(function(d,p){var x=p.toLowerCase();p!=x&&(Io(this,p),wo(this,x,d))},s)),s.j=l}function Eu(s,l){const d=new Je;if(c.Image){const p=new Image;p.onload=A(Kt,d,"TestLoadImage: loaded",!0,l,p),p.onerror=A(Kt,d,"TestLoadImage: error",!1,l,p),p.onabort=A(Kt,d,"TestLoadImage: abort",!1,l,p),p.ontimeout=A(Kt,d,"TestLoadImage: timeout",!1,l,p),c.setTimeout(function(){p.ontimeout&&p.ontimeout()},1e4),p.src=s}else l(!1)}function Iu(s,l){const d=new Je,p=new AbortController,x=setTimeout(()=>{p.abort(),Kt(d,"TestPingServer: timeout",!1,l)},1e4);fetch(s,{signal:p.signal}).then(R=>{clearTimeout(x),R.ok?Kt(d,"TestPingServer: ok",!0,l):Kt(d,"TestPingServer: server error",!1,l)}).catch(()=>{clearTimeout(x),Kt(d,"TestPingServer: error",!1,l)})}function Kt(s,l,d,p,x){try{x&&(x.onload=null,x.onerror=null,x.onabort=null,x.ontimeout=null),p(d)}catch{}}function bu(){this.g=new su}function wu(s,l,d){const p=d||"";try{vo(s,function(x,R){let L=x;h(x)&&(L=ti(x)),l.push(p+R+"="+encodeURIComponent(L))})}catch(x){throw l.push(p+"type="+encodeURIComponent("_badmap")),x}}function Xn(s){this.l=s.Ub||null,this.j=s.eb||!1}E(Xn,ei),Xn.prototype.g=function(){return new Jn(this.l,this.j)},Xn.prototype.i=function(s){return function(){return s}}({});function Jn(s,l){ft.call(this),this.D=s,this.o=l,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}E(Jn,ft),n=Jn.prototype,n.open=function(s,l){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=s,this.A=l,this.readyState=1,rn(this)},n.send=function(s){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const l={headers:this.u,method:this.B,credentials:this.m,cache:void 0};s&&(l.body=s),(this.D||c).fetch(new Request(this.A,l)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,nn(this)),this.readyState=0},n.Sa=function(s){if(this.g&&(this.l=s,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=s.headers,this.readyState=2,rn(this)),this.g&&(this.readyState=3,rn(this),this.g)))if(this.responseType==="arraybuffer")s.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in s){if(this.j=s.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;xo(this)}else s.text().then(this.Ra.bind(this),this.ga.bind(this))};function xo(s){s.j.read().then(s.Pa.bind(s)).catch(s.ga.bind(s))}n.Pa=function(s){if(this.g){if(this.o&&s.value)this.response.push(s.value);else if(!this.o){var l=s.value?s.value:new Uint8Array(0);(l=this.v.decode(l,{stream:!s.done}))&&(this.response=this.responseText+=l)}s.done?nn(this):rn(this),this.readyState==3&&xo(this)}},n.Ra=function(s){this.g&&(this.response=this.responseText=s,nn(this))},n.Qa=function(s){this.g&&(this.response=s,nn(this))},n.ga=function(){this.g&&nn(this)};function nn(s){s.readyState=4,s.l=null,s.j=null,s.v=null,rn(s)}n.setRequestHeader=function(s,l){this.u.append(s,l)},n.getResponseHeader=function(s){return this.h&&this.h.get(s.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const s=[],l=this.h.entries();for(var d=l.next();!d.done;)d=d.value,s.push(d[0]+": "+d[1]),d=l.next();return s.join(`\r
`)};function rn(s){s.onreadystatechange&&s.onreadystatechange.call(s)}Object.defineProperty(Jn.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(s){this.m=s?"include":"same-origin"}});function To(s){let l="";return j(s,function(d,p){l+=p,l+=":",l+=d,l+=`\r
`}),l}function di(s,l,d){t:{for(p in d){var p=!1;break t}p=!0}p||(d=To(d),typeof s=="string"?d!=null&&encodeURIComponent(String(d)):J(s,l,d))}function et(s){ft.call(this),this.headers=new Map,this.o=s||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}E(et,ft);var xu=/^https?$/i,Tu=["POST","PUT"];n=et.prototype,n.Ha=function(s){this.J=s},n.ea=function(s,l,d,p){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+s);l=l?l.toUpperCase():"GET",this.D=s,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():ii.g(),this.v=this.o?to(this.o):to(ii),this.g.onreadystatechange=_(this.Ea,this);try{this.B=!0,this.g.open(l,String(s),!0),this.B=!1}catch(R){Ro(this,R);return}if(s=d||"",d=new Map(this.headers),p)if(Object.getPrototypeOf(p)===Object.prototype)for(var x in p)d.set(x,p[x]);else if(typeof p.keys=="function"&&typeof p.get=="function")for(const R of p.keys())d.set(R,p.get(R));else throw Error("Unknown input type for opt_headers: "+String(p));p=Array.from(d.keys()).find(R=>R.toLowerCase()=="content-type"),x=c.FormData&&s instanceof c.FormData,!(0<=Array.prototype.indexOf.call(Tu,l,void 0))||p||x||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[R,L]of d)this.g.setRequestHeader(R,L);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{So(this),this.u=!0,this.g.send(s),this.u=!1}catch(R){Ro(this,R)}};function Ro(s,l){s.h=!1,s.g&&(s.j=!0,s.g.abort(),s.j=!1),s.l=l,s.m=5,Co(s),Zn(s)}function Co(s){s.A||(s.A=!0,Et(s,"complete"),Et(s,"error"))}n.abort=function(s){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=s||7,Et(this,"complete"),Et(this,"abort"),Zn(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Zn(this,!0)),et.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?Po(this):this.bb())},n.bb=function(){Po(this)};function Po(s){if(s.h&&typeof a<"u"&&(!s.v[1]||zt(s)!=4||s.Z()!=2)){if(s.u&&zt(s)==4)Xs(s.Ea,0,s);else if(Et(s,"readystatechange"),zt(s)==4){s.h=!1;try{const L=s.Z();t:switch(L){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var l=!0;break t;default:l=!1}var d;if(!(d=l)){var p;if(p=L===0){var x=String(s.D).match(Ao)[1]||null;!x&&c.self&&c.self.location&&(x=c.self.location.protocol.slice(0,-1)),p=!xu.test(x?x.toLowerCase():"")}d=p}if(d)Et(s,"complete"),Et(s,"success");else{s.m=6;try{var R=2<zt(s)?s.g.statusText:""}catch{R=""}s.l=R+" ["+s.Z()+"]",Co(s)}}finally{Zn(s)}}}}function Zn(s,l){if(s.g){So(s);const d=s.g,p=s.v[0]?()=>{}:null;s.g=null,s.v=null,l||Et(s,"ready");try{d.onreadystatechange=p}catch{}}}function So(s){s.I&&(c.clearTimeout(s.I),s.I=null)}n.isActive=function(){return!!this.g};function zt(s){return s.g?s.g.readyState:0}n.Z=function(){try{return 2<zt(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(s){if(this.g){var l=this.g.responseText;return s&&l.indexOf(s)==0&&(l=l.substring(s.length)),iu(l)}};function Vo(s){try{if(!s.g)return null;if("response"in s.g)return s.g.response;switch(s.H){case"":case"text":return s.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in s.g)return s.g.mozResponseArrayBuffer}return null}catch{return null}}function Ru(s){const l={};s=(s.g&&2<=zt(s)&&s.g.getAllResponseHeaders()||"").split(`\r
`);for(let p=0;p<s.length;p++){if(D(s[p]))continue;var d=w(s[p]);const x=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const R=l[x]||[];l[x]=R,R.push(d)}b(l,function(p){return p.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function sn(s,l,d){return d&&d.internalChannelParams&&d.internalChannelParams[s]||l}function Do(s){this.Aa=0,this.i=[],this.j=new Je,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=sn("failFast",!1,s),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=sn("baseRetryDelayMs",5e3,s),this.cb=sn("retryDelaySeedMs",1e4,s),this.Wa=sn("forwardChannelMaxRetries",2,s),this.wa=sn("forwardChannelRequestTimeoutMs",2e4,s),this.pa=s&&s.xmlHttpFactory||void 0,this.Xa=s&&s.Tb||void 0,this.Ca=s&&s.useFetchStreams||!1,this.L=void 0,this.J=s&&s.supportsCrossDomainXhr||!1,this.K="",this.h=new po(s&&s.concurrentRequestLimit),this.Da=new bu,this.P=s&&s.fastHandshake||!1,this.O=s&&s.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=s&&s.Rb||!1,s&&s.xa&&this.j.xa(),s&&s.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&s&&s.detectBufferingProxy||!1,this.ja=void 0,s&&s.longPollingTimeout&&0<s.longPollingTimeout&&(this.ja=s.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=Do.prototype,n.la=8,n.G=1,n.connect=function(s,l,d,p){It(0),this.W=s,this.H=l||{},d&&p!==void 0&&(this.H.OSID=d,this.H.OAID=p),this.F=this.X,this.I=zo(this,null,this.W),tr(this)};function hi(s){if(ko(s),s.G==3){var l=s.U++,d=jt(s.I);if(J(d,"SID",s.K),J(d,"RID",l),J(d,"TYPE","terminate"),on(s,d),l=new $t(s,s.j,l),l.L=2,l.v=Kn(jt(d)),d=!1,c.navigator&&c.navigator.sendBeacon)try{d=c.navigator.sendBeacon(l.v.toString(),"")}catch{}!d&&c.Image&&(new Image().src=l.v,d=!0),d||(l.g=qo(l.j,null),l.g.ea(l.v)),l.F=Date.now(),Qn(l)}jo(s)}function Yn(s){s.g&&(fi(s),s.g.cancel(),s.g=null)}function ko(s){Yn(s),s.u&&(c.clearTimeout(s.u),s.u=null),er(s),s.h.cancel(),s.s&&(typeof s.s=="number"&&c.clearTimeout(s.s),s.s=null)}function tr(s){if(!fo(s.h)&&!s.s){s.s=!0;var l=s.Ga;Ue||Ws(),We||(Ue(),We=!0),Qr.add(l,s),s.B=0}}function Cu(s,l){return mo(s.h)>=s.h.j-(s.s?1:0)?!1:s.s?(s.i=l.D.concat(s.i),!0):s.G==1||s.G==2||s.B>=(s.Va?0:s.Wa)?!1:(s.s=Xe(_(s.Ga,s,l),Fo(s,s.B)),s.B++,!0)}n.Ga=function(s){if(this.s)if(this.s=null,this.G==1){if(!s){this.U=Math.floor(1e5*Math.random()),s=this.U++;const x=new $t(this,this.j,s);let R=this.o;if(this.S&&(R?(R=m(R),I(R,this.S)):R=this.S),this.m!==null||this.O||(x.H=R,R=null),this.P)t:{for(var l=0,d=0;d<this.i.length;d++){e:{var p=this.i[d];if("__data__"in p.map&&(p=p.map.__data__,typeof p=="string")){p=p.length;break e}p=void 0}if(p===void 0)break;if(l+=p,4096<l){l=d;break t}if(l===4096||d===this.i.length-1){l=d+1;break t}}l=1e3}else l=1e3;l=Lo(this,x,l),d=jt(this.I),J(d,"RID",s),J(d,"CVER",22),this.D&&J(d,"X-HTTP-Session-Id",this.D),on(this,d),R&&(this.O?l="headers="+encodeURIComponent(String(To(R)))+"&"+l:this.m&&di(d,this.m,R)),ui(this.h,x),this.Ua&&J(d,"TYPE","init"),this.P?(J(d,"$req",l),J(d,"SID","null"),x.T=!0,oi(x,d,null)):oi(x,d,l),this.G=2}}else this.G==3&&(s?No(this,s):this.i.length==0||fo(this.h)||No(this))};function No(s,l){var d;l?d=l.l:d=s.U++;const p=jt(s.I);J(p,"SID",s.K),J(p,"RID",d),J(p,"AID",s.T),on(s,p),s.m&&s.o&&di(p,s.m,s.o),d=new $t(s,s.j,d,s.B+1),s.m===null&&(d.H=s.o),l&&(s.i=l.D.concat(s.i)),l=Lo(s,d,1e3),d.I=Math.round(.5*s.wa)+Math.round(.5*s.wa*Math.random()),ui(s.h,d),oi(d,p,l)}function on(s,l){s.H&&j(s.H,function(d,p){J(l,p,d)}),s.l&&vo({},function(d,p){J(l,p,d)})}function Lo(s,l,d){d=Math.min(s.i.length,d);var p=s.l?_(s.l.Na,s.l,s):null;t:{var x=s.i;let R=-1;for(;;){const L=["count="+d];R==-1?0<d?(R=x[0].g,L.push("ofs="+R)):R=0:L.push("ofs="+R);let X=!0;for(let lt=0;lt<d;lt++){let $=x[lt].g;const mt=x[lt].map;if($-=R,0>$)R=Math.max(0,x[lt].g-100),X=!1;else try{wu(mt,L,"req"+$+"_")}catch{p&&p(mt)}}if(X){p=L.join("&");break t}}}return s=s.i.splice(0,d),l.D=s,p}function Bo(s){if(!s.g&&!s.u){s.Y=1;var l=s.Fa;Ue||Ws(),We||(Ue(),We=!0),Qr.add(l,s),s.v=0}}function pi(s){return s.g||s.u||3<=s.v?!1:(s.Y++,s.u=Xe(_(s.Fa,s),Fo(s,s.v)),s.v++,!0)}n.Fa=function(){if(this.u=null,Mo(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var s=2*this.R;this.j.info("BP detection timer enabled: "+s),this.A=Xe(_(this.ab,this),s)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,It(10),Yn(this),Mo(this))};function fi(s){s.A!=null&&(c.clearTimeout(s.A),s.A=null)}function Mo(s){s.g=new $t(s,s.j,"rpc",s.Y),s.m===null&&(s.g.H=s.o),s.g.O=0;var l=jt(s.qa);J(l,"RID","rpc"),J(l,"SID",s.K),J(l,"AID",s.T),J(l,"CI",s.F?"0":"1"),!s.F&&s.ja&&J(l,"TO",s.ja),J(l,"TYPE","xmlhttp"),on(s,l),s.m&&s.o&&di(l,s.m,s.o),s.L&&(s.g.I=s.L);var d=s.g;s=s.ia,d.L=1,d.v=Kn(jt(l)),d.m=null,d.P=!0,co(d,s)}n.Za=function(){this.C!=null&&(this.C=null,Yn(this),pi(this),It(19))};function er(s){s.C!=null&&(c.clearTimeout(s.C),s.C=null)}function Oo(s,l){var d=null;if(s.g==l){er(s),fi(s),s.g=null;var p=2}else if(ci(s.h,l))d=l.D,go(s.h,l),p=1;else return;if(s.G!=0){if(l.o)if(p==1){d=l.m?l.m.length:0,l=Date.now()-l.F;var x=s.B;p=Hn(),Et(p,new so(p,d)),tr(s)}else Bo(s);else if(x=l.s,x==3||x==0&&0<l.X||!(p==1&&Cu(s,l)||p==2&&pi(s)))switch(d&&0<d.length&&(l=s.h,l.i=l.i.concat(d)),x){case 1:le(s,5);break;case 4:le(s,10);break;case 3:le(s,6);break;default:le(s,2)}}}function Fo(s,l){let d=s.Ta+Math.floor(Math.random()*s.cb);return s.isActive()||(d*=2),d*l}function le(s,l){if(s.j.info("Error code "+l),l==2){var d=_(s.fb,s),p=s.Xa;const x=!p;p=new ae(p||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||$n(p,"https"),Kn(p),x?Eu(p.toString(),d):Iu(p.toString(),d)}else It(2);s.G=0,s.l&&s.l.sa(l),jo(s),ko(s)}n.fb=function(s){s?(this.j.info("Successfully pinged google.com"),It(2)):(this.j.info("Failed to ping google.com"),It(1))};function jo(s){if(s.G=0,s.ka=[],s.l){const l=yo(s.h);(l.length!=0||s.i.length!=0)&&(P(s.ka,l),P(s.ka,s.i),s.h.i.length=0,C(s.i),s.i.length=0),s.l.ra()}}function zo(s,l,d){var p=d instanceof ae?jt(d):new ae(d);if(p.g!="")l&&(p.g=l+"."+p.g),Gn(p,p.s);else{var x=c.location;p=x.protocol,l=l?l+"."+x.hostname:x.hostname,x=+x.port;var R=new ae(null);p&&$n(R,p),l&&(R.g=l),x&&Gn(R,x),d&&(R.l=d),p=R}return d=s.D,l=s.ya,d&&l&&J(p,d,l),J(p,"VER",s.la),on(s,p),p}function qo(s,l,d){if(l&&!s.J)throw Error("Can't create secondary domain capable XhrIo object.");return l=s.Ca&&!s.pa?new et(new Xn({eb:d})):new et(s.pa),l.Ha(s.J),l}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function Ho(){}n=Ho.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function nr(){}nr.prototype.g=function(s,l){return new Rt(s,l)};function Rt(s,l){ft.call(this),this.g=new Do(l),this.l=s,this.h=l&&l.messageUrlParams||null,s=l&&l.messageHeaders||null,l&&l.clientProtocolHeaderRequired&&(s?s["X-Client-Protocol"]="webchannel":s={"X-Client-Protocol":"webchannel"}),this.g.o=s,s=l&&l.initMessageHeaders||null,l&&l.messageContentType&&(s?s["X-WebChannel-Content-Type"]=l.messageContentType:s={"X-WebChannel-Content-Type":l.messageContentType}),l&&l.va&&(s?s["X-WebChannel-Client-Profile"]=l.va:s={"X-WebChannel-Client-Profile":l.va}),this.g.S=s,(s=l&&l.Sb)&&!D(s)&&(this.g.m=s),this.v=l&&l.supportsCrossDomainXhr||!1,this.u=l&&l.sendRawJson||!1,(l=l&&l.httpSessionIdParam)&&!D(l)&&(this.g.D=l,s=this.h,s!==null&&l in s&&(s=this.h,l in s&&delete s[l])),this.j=new Ae(this)}E(Rt,ft),Rt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Rt.prototype.close=function(){hi(this.g)},Rt.prototype.o=function(s){var l=this.g;if(typeof s=="string"){var d={};d.__data__=s,s=d}else this.u&&(d={},d.__data__=ti(s),s=d);l.i.push(new du(l.Ya++,s)),l.G==3&&tr(l)},Rt.prototype.N=function(){this.g.l=null,delete this.j,hi(this.g),delete this.g,Rt.aa.N.call(this)};function Uo(s){ni.call(this),s.__headers__&&(this.headers=s.__headers__,this.statusCode=s.__status__,delete s.__headers__,delete s.__status__);var l=s.__sm__;if(l){t:{for(const d in l){s=d;break t}s=void 0}(this.i=s)&&(s=this.i,l=l!==null&&s in l?l[s]:void 0),this.data=l}else this.data=s}E(Uo,ni);function Wo(){ri.call(this),this.status=1}E(Wo,ri);function Ae(s){this.g=s}E(Ae,Ho),Ae.prototype.ua=function(){Et(this.g,"a")},Ae.prototype.ta=function(s){Et(this.g,new Uo(s))},Ae.prototype.sa=function(s){Et(this.g,new Wo)},Ae.prototype.ra=function(){Et(this.g,"b")},nr.prototype.createWebChannel=nr.prototype.g,Rt.prototype.send=Rt.prototype.o,Rt.prototype.open=Rt.prototype.m,Rt.prototype.close=Rt.prototype.close,dl=function(){return new nr},ul=function(){return Hn()},cl=se,Li={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Un.NO_ERROR=0,Un.TIMEOUT=8,Un.HTTP_ERROR=6,cr=Un,oo.COMPLETE="complete",ll=oo,eo.EventType=Ge,Ge.OPEN="a",Ge.CLOSE="b",Ge.ERROR="c",Ge.MESSAGE="d",ft.prototype.listen=ft.prototype.K,ln=eo,et.prototype.listenOnce=et.prototype.L,et.prototype.getLastError=et.prototype.Ka,et.prototype.getLastErrorCode=et.prototype.Ba,et.prototype.getStatus=et.prototype.Z,et.prototype.getResponseJson=et.prototype.Oa,et.prototype.getResponseText=et.prototype.oa,et.prototype.send=et.prototype.ea,et.prototype.setWithCredentials=et.prototype.Ha,al=et}).apply(typeof ir<"u"?ir:typeof self<"u"?self:typeof window<"u"?window:{});const ra="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vp{constructor(t,e,r,i){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=r,this.indexManager=i}getDocument(t,e){let r=null;return this.documentOverlayCache.getOverlay(t,e).next(i=>(r=i,this.remoteDocumentCache.getEntry(t,e))).next(i=>(r!==null&&mn(r.mutation,i,Ct.empty(),ot.now()),i))}getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next(r=>this.getLocalViewOfDocuments(t,r,U()).next(()=>r))}getLocalViewOfDocuments(t,e,r=U()){const i=ue();return this.populateOverlays(t,i,e).next(()=>this.computeViews(t,e,i,r).next(o=>{let a=cn();return o.forEach((c,u)=>{a=a.insert(c,u.overlayedDocument)}),a}))}getOverlayedDocuments(t,e){const r=ue();return this.populateOverlays(t,r,e).next(()=>this.computeViews(t,e,r,U()))}populateOverlays(t,e,r){const i=[];return r.forEach(o=>{e.has(o)||i.push(o)}),this.documentOverlayCache.getOverlays(t,i).next(o=>{o.forEach((a,c)=>{e.set(a,c)})})}computeViews(t,e,r,i){let o=Wt();const a=fn(),c=function(){return fn()}();return e.forEach((u,h)=>{const f=r.get(h.key);i.has(h.key)&&(f===void 0||f.mutation instanceof re)?o=o.insert(h.key,h):f!==void 0?(a.set(h.key,f.mutation.getFieldMask()),mn(f.mutation,h,f.mutation.getFieldMask(),ot.now())):a.set(h.key,Ct.empty())}),this.recalculateAndSaveOverlays(t,o).next(u=>(u.forEach((h,f)=>a.set(h,f)),e.forEach((h,f)=>{var y;return c.set(h,new Sp(f,(y=a.get(h))!==null&&y!==void 0?y:null))}),c))}recalculateAndSaveOverlays(t,e){const r=fn();let i=new tt((a,c)=>a-c),o=U();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next(a=>{for(const c of a)c.keys().forEach(u=>{const h=e.get(u);if(h===null)return;let f=r.get(u)||Ct.empty();f=c.applyToLocalView(h,f),r.set(u,f);const y=(i.get(c.batchId)||U()).add(u);i=i.insert(c.batchId,y)})}).next(()=>{const a=[],c=i.getReverseIterator();for(;c.hasNext();){const u=c.getNext(),h=u.key,f=u.value,y=Cl();f.forEach(_=>{if(!o.has(_)){const A=Nl(e.get(_),r.get(_));A!==null&&y.set(_,A),o=o.add(_)}}),a.push(this.documentOverlayCache.saveOverlays(t,h,y))}return V.waitFor(a)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(t,e){return this.remoteDocumentCache.getEntries(t,e).next(r=>this.recalculateAndSaveOverlays(t,r))}getDocumentsMatchingQuery(t,e,r,i){return function(a){return F.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0}(e)?this.getDocumentsMatchingDocumentQuery(t,e.path):bl(e)?this.getDocumentsMatchingCollectionGroupQuery(t,e,r,i):this.getDocumentsMatchingCollectionQuery(t,e,r,i)}getNextDocuments(t,e,r,i){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,r,i).next(o=>{const a=i-o.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,r.largestBatchId,i-o.size):V.resolve(ue());let c=-1,u=o;return a.next(h=>V.forEach(h,(f,y)=>(c<y.largestBatchId&&(c=y.largestBatchId),o.get(f)?V.resolve():this.remoteDocumentCache.getEntry(t,f).next(_=>{u=u.insert(f,_)}))).next(()=>this.populateOverlays(t,h,o)).next(()=>this.computeViews(t,u,h,U())).next(f=>({batchId:c,changes:Rl(f)})))})}getDocumentsMatchingDocumentQuery(t,e){return this.getDocument(t,new F(e)).next(r=>{let i=cn();return r.isFoundDocument()&&(i=i.insert(r.key,r)),i})}getDocumentsMatchingCollectionGroupQuery(t,e,r,i){const o=e.collectionGroup;let a=cn();return this.indexManager.getCollectionParents(t,o).next(c=>V.forEach(c,u=>{const h=function(y,_){return new Oe(_,null,y.explicitOrderBy.slice(),y.filters.slice(),y.limit,y.limitType,y.startAt,y.endAt)}(e,u.child(o));return this.getDocumentsMatchingCollectionQuery(t,h,r,i).next(f=>{f.forEach((y,_)=>{a=a.insert(y,_)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(t,e,r,i){let o;return this.documentOverlayCache.getOverlaysForCollection(t,e.path,r.largestBatchId).next(a=>(o=a,this.remoteDocumentCache.getDocumentsMatchingQuery(t,e,r,o,i))).next(a=>{o.forEach((u,h)=>{const f=h.getKey();a.get(f)===null&&(a=a.insert(f,At.newInvalidDocument(f)))});let c=cn();return a.forEach((u,h)=>{const f=o.get(u);f!==void 0&&mn(f.mutation,h,Ct.empty(),ot.now()),Vr(e,h)&&(c=c.insert(u,h))}),c})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yt="WebChannelConnection";class ef extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const r=e.ssl?"https":"http",i=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+e.host,this.vo=`projects/${i}/databases/${o}`,this.Co=this.databaseId.database==="(default)"?`project_id=${i}`:`project_id=${i}&database_id=${o}`}get Fo(){return!1}Mo(e,r,i,o,a){const c=Ei(),u=this.xo(e,r.toUriEncodedString());O("RestConnection",`Sending RPC '${e}' ${c}:`,u,i);const h={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(h,o,a),this.No(e,u,h,i).then(f=>(O("RestConnection",`Received RPC '${e}' ${c}: `,f),f),f=>{throw Pe("RestConnection",`RPC '${e}' ${c} failed with error: `,f,"url: ",u,"request:",i),f})}Lo(e,r,i,o,a,c){return this.Mo(e,r,i,o,a)}Oo(e,r,i){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Me}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((o,a)=>e[a]=o),i&&i.headers.forEach((o,a)=>e[a]=o)}xo(e,r){const i=Yp[e];return`${this.Do}/v1/${r}:${i}`}terminate(){}}{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}No(t,e,r,i){const o=Ei();return new Promise((a,c)=>{const u=new al;u.setWithCredentials(!0),u.listenOnce(ll.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case cr.NO_ERROR:const f=u.getResponseJson();O(yt,`XHR for RPC '${t}' ${o} received:`,JSON.stringify(f)),a(f);break;case cr.TIMEOUT:O(yt,`RPC '${t}' ${o} timed out`),c(new B(S.DEADLINE_EXCEEDED,"Request time out"));break;case cr.HTTP_ERROR:const y=u.getStatus();if(O(yt,`RPC '${t}' ${o} failed with status:`,y,"response text:",u.getResponseText()),y>0){let _=u.getResponseJson();Array.isArray(_)&&(_=_[0]);const A=_==null?void 0:_.error;if(A&&A.status&&A.message){const E=function(P){const k=P.toLowerCase().replace(/_/g,"-");return Object.values(S).indexOf(k)>=0?k:S.UNKNOWN}(A.status);c(new B(E,A.message))}else c(new B(S.UNKNOWN,"Server responded with status "+u.getStatus()))}else c(new B(S.UNAVAILABLE,"Connection failed."));break;default:z()}}finally{O(yt,`RPC '${t}' ${o} completed.`)}});const h=JSON.stringify(i);O(yt,`RPC '${t}' ${o} sending request:`,i),u.send(e,"POST",h,r,15)})}Bo(t,e,r){const i=Ei(),o=[this.Do,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=dl(),c=ul(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Oo(u.initMessageHeaders,e,r),u.encodeInitMessageHeaders=!0;const f=o.join("");O(yt,`Creating RPC '${t}' stream ${i}: ${f}`,u);const y=a.createWebChannel(f,u);let _=!1,A=!1;const E=new tf({Io:P=>{A?O(yt,`Not sending because RPC '${t}' stream ${i} is closed:`,P):(_||(O(yt,`Opening RPC '${t}' stream ${i} transport.`),y.open(),_=!0),O(yt,`RPC '${t}' stream ${i} sending:`,P),y.send(P))},To:()=>y.close()}),C=(P,k,D)=>{P.listen(k,N=>{try{D(N)}catch(M){setTimeout(()=>{throw M},0)}})};return C(y,ln.EventType.OPEN,()=>{A||(O(yt,`RPC '${t}' stream ${i} transport opened.`),E.yo())}),C(y,ln.EventType.CLOSE,()=>{A||(A=!0,O(yt,`RPC '${t}' stream ${i} transport closed`),E.So())}),C(y,ln.EventType.ERROR,P=>{A||(A=!0,Pe(yt,`RPC '${t}' stream ${i} transport errored:`,P),E.So(new B(S.UNAVAILABLE,"The operation could not be completed")))}),C(y,ln.EventType.MESSAGE,P=>{var k;if(!A){const D=P.data[0];K(!!D);const N=D,M=N.error||((k=N[0])===null||k===void 0?void 0:k.error);if(M){O(yt,`RPC '${t}' stream ${i} received error:`,M);const nt=M.status;let j=function(v){const I=it[v];if(I!==void 0)return Bl(I)}(nt),b=M.message;j===void 0&&(j=S.INTERNAL,b="Unknown error status: "+nt+" with message "+M.message),A=!0,E.So(new B(j,b)),y.close()}else O(yt,`RPC '${t}' stream ${i} received:`,D),E.bo(D)}}),C(c,cl.STAT_EVENT,P=>{P.stat===Li.PROXY?O(yt,`RPC '${t}' stream ${i} detected buffering proxy`):P.stat===Li.NOPROXY&&O(yt,`RPC '${t}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{E.wo()},0),E}}function Ii(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function js(n){return Dn(n=wt(n,Bt)),new rm(n,t=>Mn(n,t))}(function(t,e=!0){(function(i){Me=i})(Gd),gr(new gn("firestore",(r,{instanceIdentifier:i,options:o})=>{const a=r.getProvider("app").getImmediate(),c=new Bt(new ch(r.getProvider("auth-internal")),new ph(r.getProvider("app-check-internal")),function(h,f){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new B(S.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new _n(h.options.projectId,f)}(a,i),a);return o=Object.assign({useFetchStreams:e},o),c._setSettings(o),c},"PUBLIC").setMultipleInstances(!0)),xe(ra,"4.7.3",t),xe(ra,"4.7.3","esm2017")})();const im={apiKey:"AIzaSyCs0qf02HaIv0-aAe7wVntfosDL1SjdOws",authDomain:"feria-vinos-sucovi-2027.firebaseapp.com",databaseURL:"https://feria-vinos-sucovi-2027-default-rtdb.firebaseio.com",projectId:"feria-vinos-sucovi-2027",storageBucket:"feria-vinos-sucovi-2027.firebasestorage.app",messagingSenderId:"1686119758",appId:"1:1686119758:web:2c3c6d96e36f1276052a1f",measurementId:"G-VRMTQ3SS7E"},sm=rl(im),Y=$f(sm),Re=[{id:0,nombre:"Sucovi",region:"Pruebas / Bebidas",pass:"stand00"},{id:1,nombre:"Alta Vista",region:"Mendoza",pass:"stand01"},{id:2,nombre:"Andillian",region:"Mendoza",pass:"stand02"},{id:3,nombre:"Ante Nada",region:"Mendoza",pass:"stand03"},{id:4,nombre:"Bodega Benegas",region:"Mendoza",pass:"stand04"},{id:5,nombre:"Bianchi",region:"San Rafael",pass:"stand05"},{id:6,nombre:"Catena Zapata",region:"Luján de Cuyo",pass:"stand06"},{id:7,nombre:"Bodegas Bórbore",region:"Mendoza (1936)",pass:"stand07"},{id:8,nombre:"Fábula Wines",region:"Mendoza",pass:"stand08"},{id:9,nombre:"Finca Iral",region:"Mendoza",pass:"stand09"},{id:10,nombre:"Giménez Riili",region:"Mendoza",pass:"stand10"},{id:11,nombre:"Jorge Rubio",region:"Mendoza",pass:"stand11"},{id:12,nombre:"La Coste de los Andes",region:"Mendoza",pass:"stand12"},{id:13,nombre:"Las Perdices",region:"Mendoza",pass:"stand13"},{id:14,nombre:"Lorenzo de Agrelo",region:"Mendoza",pass:"stand14"},{id:15,nombre:"Pannunzio Wines",region:"Mendoza",pass:"stand15"},{id:16,nombre:"Bodega Patritti",region:"Mendoza",pass:"stand16"},{id:17,nombre:"Rosell Boher",region:"Mendoza",pass:"stand17"},{id:18,nombre:"Valle de la Puerta",region:"La Rioja",pass:"stand18"}];async function xr(n){return await Cc(Tt(Y,"invitados"),{...n,creadoEn:Sc()})}async function Ce(n,t){await ze(Mt(Y,"invitados",n),t)}function On(n){return qe(Hr(Tt(Y,"invitados"),Ur("creadoEn","desc")),t=>n(t.docs.map(e=>({fireId:e.id,...e.data()}))))}async function Tr(n){const e=(await Bn(Tt(Y,"invitados"))).docs.find(r=>r.data().token===n);return e?{fireId:e.id,...e.data()}:null}async function om(n){const e=(await Bn(Tt(Y,"invitados"))).docs.find(r=>r.data().codigo===n);return e?{fireId:e.id,...e.data()}:null}async function Vc(n,t,e,r,i){const o=Mt(Y,"carritos",n,"items",String(t)),a=await Tc(o);if(a.exists()){const c=a.data(),u=c.items||[],h=u.findIndex(f=>f.key===r.key);h>=0?u[h]=r:u.push(r),await Ha(o,{standId:t,standNombre:e,items:u,retiro:i||c.retiro||"stand"})}else await Ha(o,{standId:t,standNombre:e,items:[r],retiro:i||"stand"})}async function zs(n,t,e){await ze(Mt(Y,"carritos",n,"items",String(t)),{retiro:e})}async function Rr(n,t,e){const r=Mt(Y,"carritos",n,"items",String(t)),i=await Tc(r);if(!i.exists())return;const o=(i.data().items||[]).filter(a=>a.key!==e);o.length?await ze(r,{items:o}):await Rc(r)}async function Dc(n){return(await Bn(Tt(Y,"carritos",n,"items"))).docs.map(e=>({standId:e.id,...e.data()}))}function qs(n,t){return qe(Tt(Y,"carritos",n,"items"),e=>t(e.docs.map(r=>({standDocId:r.id,...r.data()}))))}async function kc(n){const t=await Bn(Tt(Y,"carritos",n,"items")),e=js(Y);t.docs.forEach(r=>e.delete(r.ref)),await e.commit()}async function Nc(n,t){const e=js(Y),r=[];return t.forEach(i=>{const o=Mt(Tt(Y,"pedidos"));r.push(o),e.set(o,{invFireId:n.fireId,invNombre:n.nombre+" "+n.apellido,invCodigo:n.codigo,standId:i.standId,standNombre:i.standNombre,items:i.items||[],total:(i.items||[]).reduce((a,c)=>a+(c.sub||0),0),retiro:i.retiro||"stand",estado:"pagado",creadoEn:Sc()})}),await e.commit(),r.map(i=>i.id)}function Wr(n){return qe(Hr(Tt(Y,"pedidos"),Ur("creadoEn","desc")),t=>n(t.docs.map(e=>({fireId:e.id,...e.data()}))))}function Lc(n,t){return qe(Hr(Tt(Y,"pedidos"),Ur("creadoEn","desc")),e=>t(e.docs.map(r=>({fireId:r.id,...r.data()})).filter(r=>Number(r.standId)===Number(n))))}function Bc(n,t){return qe(Hr(Tt(Y,"pedidos"),Ur("creadoEn","desc")),e=>t(e.docs.map(r=>({fireId:r.id,...r.data()})).filter(r=>r.invFireId===n)))}async function Mc(n){await ze(Mt(Y,"pedidos",n),{estado:"entregado"})}async function Oc(n,t){const e={pendiente:"pagado",pagado:"listo",listo:"entregado"};e[t]&&await ze(Mt(Y,"pedidos",n),{estado:e[t]})}function Hs(n,t){return qe(Tt(Y,"bodegas",String(n),"vinos"),e=>t(e.docs.map(r=>({fireId:r.id,...r.data()}))))}async function Fc(n,t){return await Cc(Tt(Y,"bodegas",String(n),"vinos"),t)}async function jc(n,t,e){await ze(Mt(Y,"bodegas",String(n),"vinos",t),e)}async function zc(n,t){await Rc(Mt(Y,"bodegas",String(n),"vinos",t))}async function qc(){const n=["invitados","pedidos"];for(const t of n){const e=await Bn(Tt(Y,t)),r=js(Y);e.docs.forEach(i=>r.delete(i.ref)),await r.commit()}}const Hc=Object.freeze(Object.defineProperty({__proto__:null,BODEGAS:Re,actualizarInvitado:Ce,actualizarRetiroStand:zs,actualizarVino:jc,agregarAlCarrito:Vc,avanzarEstado:Oc,buscarInvitadoPorCodigo:om,buscarInvitadoPorToken:Tr,crearInvitado:xr,crearPedidosDesdeCarrito:Nc,eliminarItemCarrito:Rr,eliminarVino:zc,escucharCarrito:qs,escucharInvitados:On,escucharPedidos:Wr,escucharPedidosPorInvitado:Bc,escucharPedidosPorStand:Lc,escucharVinos:Hs,guardarVino:Fc,leerCarrito:Dc,limpiarDatosPrueba:qc,marcarEntregado:Mc,vaciarCarrito:kc},Symbol.toStringTag,{value:"Module"})),am="modulepreload",lm=function(n){return"/"+n},Ua={},Us=function(t,e,r){let i=Promise.resolve();if(e&&e.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),c=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));i=Promise.allSettled(e.map(u=>{if(u=lm(u),u in Ua)return;Ua[u]=!0;const h=u.endsWith(".css"),f=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${f}`))return;const y=document.createElement("link");if(y.rel=h?"stylesheet":am,h||(y.as="script"),y.crossOrigin="",y.href=u,c&&y.setAttribute("nonce",c),document.head.appendChild(y),h)return new Promise((_,A)=>{y.addEventListener("load",_),y.addEventListener("error",()=>A(new Error(`Unable to preload CSS for ${u}`)))})}))}function o(a){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=a,window.dispatchEvent(c),!c.defaultPrevented)throw a}return i.then(a=>{for(const c of a||[])c.status==="rejected"&&o(c.reason);return t().catch(o)})},Uc="data:image/png;base64,";function Pt({title:n,sub:t="",backHref:e="",backLabel:r="← Panel",actions:i=[]}={}){return`
  ...
  `,document.head.appendChild(n)}async function cm(){window.qrcode||await new Promise((n,t)=>{const e=document.createElement("script");e.src="https://cdn.jsdelivr.net/npm/qrcode-generator@1.4.4/qrcode.min.js",e.onload=n,e.onerror=t,document.head.appendChild(e)})}async function Wa(n,t,e){await cm();const r=document.getElementById(n);if(r)try{const i=qrcode(0,"M");i.addData(String(t)),i.make();const o=i.getModuleCount(),a=e/o;r.width=e,r.height=e;const c=r.getContext("2d");c.fillStyle="#fff",c.fillRect(0,0,e,e),c.fillStyle="#000";for(let u=0;u<o;u++)for(let h=0;h<o;h++)i.isDark(u,h)&&c.fillRect(h*a,u*a,a,a)}catch(i){console.error("QR error:",i)}}const lr=n=>Number(n).toLocaleString("es-AR"),Qa=()=>Math.random().toString(36).slice(2,10).toUpperCase(),$a=n=>"INV-"+String(n).padStart(4,"0");function Ga(n){return{pendiente:'<span class="badge b-pend">Pendiente</span>',pagado:'<span class="badge b-pago">Bono pagado</span>',ingresado:'<span class="badge b-ingr">Ingresó</span>',invalidado:'<span class="badge b-inv">Invalidado</span>'}[n]||""}const um={pendiente:"Pendiente",pagado:"Pagado",listo:"Listo",entregado:"Entregado"},dm={pendiente:"b-pend",pagado:"b-pago",listo:"b-list",entregado:"b-entr"};function hm(n){Ot();let t=[],e=[],r="inv",i=null;n.innerHTML=Pt({title:"Sucovi 2027",sub:"20 jun 2026 · 19:30 hs · Roma 656, Olivos"})+`
    ...
    <div id="modal-wa" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;
      ...
      <div class="card" style="width:100%;max-width:380px;max-height:90vh;overflow-y:auto">
    ...
    </div>`,On(A=>{t=A,r==="inv"&&o(),r==="res"&&y()}),Wr(A=>{e=A,r==="ped"&&h(),r==="res"&&y()}),window._aTab=(A,E)=>{var P;r=A,document.querySelectorAll(".nav button").forEach(k=>k.classList.remove("on")),E.classList.add("on");const C={inv:o,reg:a,excel:c,ped:h,stands:f,res:y,config:_};(P=C[A])==null||P.call(C)};function o(){const A=document.getElementById("tab-content");document.getElementById("buscar-inv")||(A.innerHTML=`
        ...
        </div>`}).join("")}},window._fInv()}window._invalidar=async(A,E)=>{confirm(`¿Invalidar a ${E}?`)&&await Ce(A,{estado:"invalidado"})},window._reactivar=async A=>await Ce(A,{estado:"pendiente"});function a(){document.getElementById("tab-content").innerHTML=`
      ...
      </div>`}window._registrar=async()=>{const A=document.getElementById("rn").value.trim(),E=document.getElementById("ra").value.trim(),C=document.getElementById("rt").value.trim(),P=document.querySelector('input[name="rp"]:checked').value,k=document.getElementById("reg-msg");if(!A||!E||!C){k.innerHTML='<span style="color:#A32D2D">Nombre, apellido y WhatsApp son obligatorios.</span>';return}k.innerHTML='<span style="color:#888">Guardando...</span>';try{const D=$a(t.length+1),N=Qa(),M=await xr({nombre:A,apellido:E,tel:C,email:document.getElementById("re").value.trim()||void 0,familia:document.getElementById("rf").value.trim()||void 0,comentarios:document.getElementById("rc").value.trim()||void 0,estado:P,codigo:D,token:N});k.innerHTML=`<span style="color:#3B6D11">✓ ${A} ${E} (${D})</span>`,["rn","ra","rt","re","rf","rc"].forEach(nt=>{const j=document.getElementById(nt);j&&(j.value="")}),P==="pagado"&&setTimeout(()=>window._abrirWA(M.id),600)}catch(D){k.innerHTML=`<span style="color:#A32D2D">Error: ${D.message}</span>`}};function c(){document.getElementById("tab-content").innerHTML=`
      <div class="card" style="max-width:540px">
        ...
        </div>`,document.getElementById("btn-importar").style.display="block"}catch(P){C.innerHTML=`<p style="color:#A32D2D;font-size:12px">Error al leer el archivo: ${P.message}</p>`}},window._importarExcel=async()=>{if(!u.length)return;const A=document.getElementById("btn-importar"),E=document.getElementById("excel-msg");A.disabled=!0,A.textContent="Importando...",E.innerHTML='<span style="color:#888">Procesando...</span>';let C=0,P=0;const k=t.length;for(let D=0;D<u.length;D++)try{const N=u[D];await xr({...N,codigo:$a(k+D+1),token:Qa()}),C++}catch{P++}E.innerHTML=`<span style="color:#3B6D11">✓ ${C} invitados importados${P?` (${P} errores)`:""}</span>`,A.style.display="none",u=[]};function h(){const A=document.getElementById("tab-content");if(!e.length){A.innerHTML='<div class="empty">Sin pedidos aún 🍷</div>';return}A.innerHTML=e.map(E=>{var C;return`
      ...
      </div>`}).join("")}function f(){const A=window.location.origin;document.getElementById("tab-content").innerHTML=`
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(175px,1fr));gap:10px">
        ${Re.map(E=>`
          <div class="card" style="text-align:center">
            ...
            <div style="font-size:10px;color:#aaa;margin-bottom:8px;word-break:break-all">${A}/stand/${E.id}</div>
            <div style="display:flex;flex-direction:column;gap:5px">
              <a href="${A}/stand/${E.id}" target="_blank" class="btn btn-v" style="font-size:11px;padding:5px;text-decoration:none">Vista cliente</a>
              <a href="${A}/panel/${E.id}" target="_blank" class="btn btn-b" style="font-size:11px;padding:5px;text-decoration:none">Panel stand</a>
              <a href="${A}/bodega/${E.id}/vinos" target="_blank" class="btn" style="font-size:11px;padding:5px;text-decoration:none;color:#3B6D11;border-color:#3B6D11">Cargar vinos</a>
              <div style="font-size:10px;color:#aaa">Pass: <strong>${E.pass}</strong></div>
            </div>
          </div>`).join("")}
      </div>`,Re.forEach(E=>setTimeout(()=>Wa("qr-s"+E.id,`${A}/stand/${E.id}`,110),50))}function y(){const A=t.filter(N=>N.estado==="pagado").length,E=t.filter(N=>N.estado==="ingresado").length,C=(A+E)*35e3,P=e.reduce((N,M)=>N+(M.total||0),0),k={};e.forEach(N=>{k[N.standId]||(k[N.standId]={n:N.standNombre,t:0,c:0}),k[N.standId].t+=N.total||0,k[N.standId].c++});const D=Object.values(k).sort((N,M)=>M.t-N.t);document.getElementById("tab-content").innerHTML=`
      <div class="stats">
        ${[[t.filter(N=>N.estado!=="invalidado").length,"Invitados"],[A+E,"Con bono"],["$"+lr(C),"Bonos"],[e.length,"Pedidos"],["$"+lr(P),"Ventas"],[e.filter(N=>N.retiro==="envio").length,"Envíos"]].map(([N,M])=>`<div class="stat"><div class="v" style="font-size:${String(N).length>7?"13px":"20px"}">${N}</div><div class="l">${M}</div></div>`).join("")}
      </div>
      <div class="card">
      ...
      <div class="card" style="max-width:480px;margin-bottom:14px">
        ...
        ${[["Registro público (para compartir con invitados)","/registro"],["Panel de caja","/caja"],["Control de puerta","/puerta"],["Logística / envíos","/logistica"]].map(([A,E])=>`
...
Esta acción no se puede deshacer.`)||!confirm("Segunda confirmación: ¿borrar todos los datos de prueba?"))return;const A=document.getElementById("limpiar-msg");A.innerHTML='<span style="color:#888">Borrando...</span>';try{await qc(),A.innerHTML='<span style="color:#3B6D11">✓ Datos borrados correctamente</span>'}catch(E){A.innerHTML=`<span style="color:#A32D2D">Error: ${E.message}</span>`}},window._abrirWA=A=>{const E=t.find(N=>N.fireId===A);if(!E)return;i=A,document.getElementById("mw-tit").textContent=E.nombre+" "+E.apellido,document.getElementById("mw-cod").textContent=E.codigo||"",document.getElementById("mw-bdg").innerHTML=Ga(E.estado);const C=window.location.origin,P=`${C}/acceso?inv=${E.token}`;document.getElementById("mw-link").textContent=P;const k=E.estado==="pagado"?`Hola ${E.nombre}! 🍷
...
Consultas: José Pannunzio +54 9 11 5400-1313`;document.getElementById("mw-msg").textContent=k;const D=document.getElementById("mw-btn-p");E.estado==="pendiente"?(D.textContent="✓ Marcar como pagado",D.disabled=!1,D.style.display="block"):D.style.display="none",Wa("mw-canvas",E.codigo||E.fireId,80),document.getElementById("modal-wa").style.display="flex"},window._pagarM=async()=>{const A=t.find(E=>E.fireId===i);!A||A.estado!=="pendiente"||await Ce(A.fireId,{estado:"pagado"})},window._copWA=()=>{var C;(C=navigator.clipboard)==null||C.writeText(document.getElementById("mw-msg").textContent).catch(()=>{});const A=document.querySelector("#modal-wa .btn-g"),E=A.innerHTML;A.innerHTML="✓ ¡Copiado!",setTimeout(()=>A.innerHTML=E,2e3)},window._cModal=()=>{document.getElementById("modal-wa").style.display="none",i=null},o()}const Ee=n=>Number(n).toLocaleString("es-AR");async function pm(){window.jsQR||await new Promise((n,t)=>{const e=document.createElement("script");e.src="https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.js",e.onload=n,e.onerror=t,document.head.appendChild(e)})}function fm(n){Ot();let t=[],e=[],r="cobrar",i=null,o=[],a=null,c=!1;n.innerHTML=Pt({title:"💰 Caja central",sub:"Sucovi 2027 · Roma 656, Olivos",backHref:"/admin"})+`
    <div class="nav">
    ...
    <div id="scan-overlay" class="scan-overlay" style="display:none">
    ...
    </div>`,On(A=>{t=A}),Wr(A=>{e=A,r!=="cobrar"&&u()}),window._cajaVista=(A,E)=>{r=A,i=null,document.querySelectorAll(".nav button").forEach(C=>C.classList.remove("on")),E.classList.add("on"),u()};function u(){r==="cobrar"&&h(),r==="pedidos"&&y(),r==="logistica"&&_()}function h(){const A=document.getElementById("caja-content");if(i){f();return}A.innerHTML=`
      ...
      <div id="resultados-busqueda"></div>`}window._buscarInv=(A=!1)=>{var k;const E=(((k=document.getElementById("buscar-caja"))==null?void 0:k.value)||"").toLowerCase().trim();if(!E){document.getElementById("resultados-busqueda").innerHTML="";return}const C=t.filter(D=>D.estado!=="invalidado"&&((D.codigo||"").toLowerCase().includes(E)||(D.nombre+" "+D.apellido).toLowerCase().includes(E)));if(A&&C.length===1){window._seleccionarInv(C[0].fireId);return}const P=document.getElementById("resultados-busqueda");if(P){if(!C.length){P.innerHTML='<div class="empty">Sin resultados</div>';return}P.innerHTML=C.map(D=>`
      ...
      </div>`).join("")}},window._seleccionarInv=async A=>{i=t.find(E=>E.fireId===A),i&&(o=await Dc(A),f())};async function f(){const A=document.getElementById("caja-content");if(!A)return;const E=i,C=o.filter(D=>{var N;return(N=D.items)==null?void 0:N.length}),P=C.reduce((D,N)=>D+(N.items||[]).reduce((M,nt)=>M+(nt.sub||0),0),0),k=e.filter(D=>D.invFireId===E.fireId);A.innerHTML=`
    ...
    `}window._volverCobrar=()=>{i=null,o=[],h()},window._cobrar=async()=>{const A=i,E=o.filter(k=>{var D;return(D=k.items)==null?void 0:D.length});if(!E.length)return;const C=document.querySelector("#caja-content .btn-g");C&&(C.disabled=!0,C.textContent="Procesando...");const P=document.getElementById("cobro-msg");try{await Nc(A,E),await kc(A.fireId),P.innerHTML=`<span style="color:#065F46;font-size:14px;font-weight:500">
        ✅ ¡Cobrado! ${E.length} voucher${E.length>1?"s":""} generado${E.length>1?"s":""}.
      </span>`,C&&(C.style.display="none")}catch(k){P.innerHTML=`<span style="color:#C0392B">Error: ${k.message}</span>`,C&&(C.disabled=!1,C.textContent="Reintentar")}};function y(){const A=document.getElementById("caja-content"),E=e.filter(k=>k.retiro!=="envio"),C={pagado:"Pagado",listo:"Listo",entregado:"Entregado"},P={pagado:"b-pago",listo:"b-list",entregado:"b-entr"};if(!E.length){A.innerHTML='<div class="empty">Sin pedidos aún</div>';return}A.innerHTML=E.map(k=>{var D;return`
      <div class="card" style="margin-bottom:8px;display:flex;align-items:center;gap:8px;flex-wrap:wrap">
      ...
      </div>`}).join("")}function _(){const A=document.getElementById("caja-content"),E=e.filter(C=>C.retiro==="envio");if(!E.length){A.innerHTML='<div class="empty">Sin envíos</div>';return}A.innerHTML=E.map(C=>{var P;return`
      ...
      </div>`}).join("")}window._abrirScanner=async()=>{document.getElementById("scan-overlay").style.display="flex";const A=document.getElementById("scan-status");A&&(A.textContent="Cargando escáner...");try{await pm(),a=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}});const E=document.getElementById("scan-video");E.srcObject=a,c=!0,A&&(A.textContent="Buscando QR...");const C=document.createElement("canvas"),P=C.getContext("2d",{willReadFrequently:!0}),k=()=>{if(c){if(E.readyState===E.HAVE_ENOUGH_DATA&&E.videoWidth>0){C.width=E.videoWidth,C.height=E.videoHeight,P.drawImage(E,0,0);const D=P.getImageData(0,0,C.width,C.height),N=window.jsQR(D.data,D.width,D.height,{inversionAttempts:"dontInvert"});if(N&&N.data){const M=N.data;window._cerrarScanner();const nt=M.match(/INV-\d+/),j=M.match(/inv=([A-Z0-9]+)/i);if(nt){const b=document.getElementById("buscar-caja");b&&(b.value=nt[0],window._buscarInv(!0))}else j&&Us(async()=>{const{buscarInvitadoPorToken:b}=await Promise.resolve().then(()=>Hc);return{buscarInvitadoPorToken:b}},void 0).then(({buscarInvitadoPorToken:b})=>b(j[1]).then(m=>{m&&window._seleccionarInv(m.fireId)}));return}}c&&requestAnimationFrame(k)}};E.addEventListener("loadeddata",()=>requestAnimationFrame(k))}catch{A&&(A.textContent="No se pudo acceder a la cámara. Ingresá el código manualmente.")}},window._cerrarScanner=()=>{c=!1,a&&(a.getTracks().forEach(E=>E.stop()),a=null);const A=document.getElementById("scan-overlay");A&&(A.style.display="none")},h()}const xi=n=>Number(n).toLocaleString("es-AR");function mm(n,t,e){if(Ot(),!e||e.estado==="invalidado"){n.innerHTML=Pt({title:"🍷 "+t.nombre,sub:"Stand #"+t.id+" · Sucovi 2027"})+`
    ...
    </button>`,Hs(t.id,u=>{r=u,a()}),qs(e.fireId,u=>{var E,C,P;const h=u.find(k=>Number(k.standId)===t.id),f=u.reduce((k,D)=>k+(D.items||[]).reduce((N,M)=>N+(M.sub||0),0),0),y=u.reduce((k,D)=>k+(D.items||[]).length,0),_=document.getElementById("cart-fab"),A=document.getElementById("cart-fab-txt");_&&y>0?(_.style.display="flex",A.textContent=`Ver carrito · $${xi(f)}`):_&&(_.style.display="none"),h&&((E=h.items)!=null&&E.length)?(i=h.retiro||"stand",(C=document.getElementById("rb-stand"))==null||C.classList.toggle("sel",i==="stand"),(P=document.getElementById("rb-envio"))==null||P.classList.toggle("sel",i==="envio"),document.getElementById("retiro-box").style.display="block",document.getElementById("stand-resumen").style.display="block",document.getElementById("stand-resumen-lines").innerHTML=h.items.map(k=>`
        ...
        ${(h.unidades||[]).map((y,_)=>`
          <div class="qty-row">
            <span class="qty-label">
              ${y.u} — <span style="color:#6B1C1C;font-weight:600">$${xi(y.p)}</span>
            </span>
        ...
        <div style="display:flex;justify-content:space-between;margin-bottom:6px">
          <div>
            <span style="font-size:18px;font-weight:500;color:#6B1C1C">
              #${(y=f.fireId)==null?void 0:y.slice(-4).toUpperCase()}
            </span>
    ...
    <div style="max-width:600px;margin:0 auto;padding:14px">
      ...
      </div>`).join("")}});const o=["vn","vv","vc","vd","vb","v6","v12"],a=()=>{o.forEach(c=>{const u=document.getElementById(c);u&&(u.value="")})};window._guardarV=async()=>{const c=document.getElementById("vn").value.trim(),u=document.getElementById("vm");if(!c){u.innerHTML='<span style="color:#A32D2D">El nombre es requerido.</span>';return}const h=parseFloat(document.getElementById("vb").value),f=parseFloat(document.getElementById("v6").value),y=parseFloat(document.getElementById("v12").value),_=[];if(h&&_.push({u:"Botella",p:h}),f&&_.push({u:"Caja x6",p:f}),y&&_.push({u:"Caja x12",p:y}),!_.length){u.innerHTML='<span style="color:#A32D2D">Ingresá al menos un precio.</span>';return}const A={nombre:c,varietal:document.getElementById("vv").value.trim(),cosecha:document.getElementById("vc").value.trim(),descripcion:document.getElementById("vd").value.trim(),unidades:_};u.innerHTML='<span style="color:#888">Guardando...</span>';try{i?(await jc(t.id,i,A),i=null):await Fc(t.id,A),a(),document.getElementById("form-titulo").textContent="Agregar vino",document.getElementById("btn-cancelar-edit").style.display="none",u.innerHTML='<span style="color:#3B6D11">✓ Guardado correctamente</span>',setTimeout(()=>{const E=document.getElementById("vm");E&&(E.innerHTML="")},3e3)}catch(E){u.innerHTML=`<span style="color:#A32D2D">Error: ${E.message}</span>`}},window._editarV=c=>{const u=r.find(_=>_.fireId===c);if(!u)return;i=c,document.getElementById("form-titulo").textContent=`Editando: ${u.nombre}`,document.getElementById("vn").value=u.nombre||"",document.getElementById("vv").value=u.varietal||"",document.getElementById("vc").value=u.cosecha||"",document.getElementById("vd").value=u.descripcion||"";const h=(u.unidades||[]).find(_=>_.u==="Botella"),f=(u.unidades||[]).find(_=>_.u==="Caja x6"),y=(u.unidades||[]).find(_=>_.u==="Caja x12");document.getElementById("vb").value=(h==null?void 0:h.p)||"",document.getElementById("v6").value=(f==null?void 0:f.p)||"",document.getElementById("v12").value=(y==null?void 0:y.p)||"",document.getElementById("btn-cancelar-edit").style.display="block",window.scrollTo({top:0,behavior:"smooth"})},window._cancelarEdit=()=>{i=null,a(),document.getElementById("form-titulo").textContent="Agregar vino",document.getElementById("btn-cancelar-edit").style.display="none"},window._eliminarV=async c=>{const u=r.find(h=>h.fireId===c);confirm(`¿Eliminar "${u==null?void 0:u.nombre}"?`)&&await zc(t.id,c)}}window._scannerStop=null;async function vm(){window.jsQR||await new Promise((n,t)=>{const e=document.createElement("script");e.src="https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.js",e.onload=n,e.onerror=t,document.head.appendChild(e)})}window._initScanner=async function(n,t,e){const r=e?document.getElementById(e):null;r&&(r.textContent="Iniciando cámara...");try{await vm();const i=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}}),o=document.getElementById(n);if(!o){i.getTracks().forEach(f=>f.stop());return}o.srcObject=i;const a=document.createElement("canvas"),c=a.getContext("2d",{willReadFrequently:!0});let u=!0;window._scannerStop=()=>{u=!1,i.getTracks().forEach(f=>f.stop()),window._scannerStop=null},r&&(r.textContent="Buscando QR...");const h=()=>{var f;if(u){if(o.readyState===o.HAVE_ENOUGH_DATA&&o.videoWidth>0){a.width=o.videoWidth,a.height=o.videoHeight,c.drawImage(o,0,0);const y=c.getImageData(0,0,a.width,a.height),_=window.jsQR(y.data,y.width,y.height,{inversionAttempts:"dontInvert"});if(_&&_.data){(f=window._scannerStop)==null||f.call(window),t(_.data);return}}requestAnimationFrame(h)}};o.addEventListener("loadeddata",()=>requestAnimationFrame(h))}catch{r&&(r.textContent="No se pudo acceder a la cámara. Ingresá el código manualmente.")}};function Am(n){Ot();let t=[],e=[];n.innerHTML=`
    <div class="hdr">
    ...
    <div class="wrap" id="log-lista"></div>`,Wr(r=>{t=r,e()}),window._avzLog=async(r,i)=>{await Oc(r,i)};function e(){const r=document.getElementById("log-lista");if(!r)return;const i=t.filter(c=>c.retiro==="envio");if(!i.length){r.innerHTML='<div class="empty">🚚<br><br>Sin pedidos de envío</div>';return}const o=i.filter(c=>c.estado!=="entregado"),a=i.filter(c=>c.estado==="entregado");r.innerHTML=(o.length?`<p style="font-size:12px;font-weight:500;color:#5A1E99;margin-bottom:8px">Pendientes (${o.length})</p>`:"")+o.map(c=>{var u;return`
        <div class="card" style="margin-bottom:10px;border-left:3px solid #5A1E99">
          <div style="display:flex;justify-content:space-between;margin-bottom:6px">
            ...
            <span class="badge ${Im[c.estado]}">${Em[c.estado]}</span>
          </div>
          <div style="font-size:13px;font-weight:500;margin-bottom:4px">${c.invNombre||""}</div>
          <div style="font-size:12px;color:#666;margin-bottom:6px">
          ...
          <div style="display:flex;justify-content:space-between;align-items:center">
            ...
            ${xm[c.estado]?`<button class="btn ${wm[c.estado]}" style="font-size:12px"
                  onclick="window._avzLog('${c.fireId}','${c.estado}')">${bm[c.estado]}</button>`:""}
          </div>
        ...
        </div>`}).join("")}}async function Rm(){window.qrcode||await new Promise((n,t)=>{const e=document.createElement("script");e.src="https://cdn.jsdelivr.net/npm/qrcode-generator@1.4.4/qrcode.min.js",e.onload=n,e.onerror=t,document.head.appendChild(e)})}async function Cm(n,t,e){await Rm();const r=document.getElementById(n);if(r)try{const i=qrcode(0,"M");i.addData(String(t)),i.make();const o=i.getModuleCount(),a=e/o;r.width=e,r.height=e;const c=r.getContext("2d");c.fillStyle="#fff",c.fillRect(0,0,e,e),c.fillStyle="#000";for(let u=0;u<o;u++)for(let h=0;h<o;h++)i.isDark(u,h)&&c.fillRect(h*a,u*a,a,a)}catch(i){console.error("QR error:",i)}}const Pm=n=>Number(n).toLocaleString("es-AR");async function Sm(n,t){if(Ot(),n.innerHTML=Ji(null)+`
    ...
    <p style="font-size:11px;color:#aaa;margin-top:12px">
      ...
      ${i.map(a=>{const c={pagado:"Listo para retirar",entregado:"Entregado"},u=a.estado==="pagado";return`
          <div style="background:${u?"#EAF3DE":"#f5f5f5"};border:.5px solid ${u?"#3B6D11":"#ddd"};
            ...
            <div style="font-size:14px;font-weight:500">$${Pm(a.total||0)}</div>
    ...
    </div>`,window._autoRegistrar=async()=>{const r=document.getElementById("rn").value.trim(),i=document.getElementById("ra").value.trim(),o=document.getElementById("rt").value.trim(),a=document.getElementById("re").value.trim(),c=document.getElementById("rf").value.trim(),u=document.getElementById("rc").value.trim(),h=document.getElementById("reg-msg");if(!r||!i||!o){h.innerHTML='<span style="color:#A32D2D">Nombre, apellido y WhatsApp son obligatorios.</span>';return}h.innerHTML='<span style="color:#888">Registrando...</span>';try{const f=await Us(()=>Promise.resolve().then(()=>Hc),void 0).then(_=>_.escucharInvitados),y="INV-"+String(t+1).padStart(4,"0");await xr({nombre:r,apellido:i,tel:o,...a&&{email:a},...c&&{familia:c},...u&&{comentarios:u},estado:"pendiente",codigo:y,token:Vm()}),document.getElementById("reg-form").innerHTML=`
    ...
    <div style="max-width:480px;margin:0 auto;padding:14px" id="carrito-body">
      ...
      <div id="carrito-msg" style="font-size:12px;text-align:center;min-height:16px;margin-bottom:8px"></div>`}window._quitarCarrito=async(i,o)=>{const a=e.find(c=>c.standDocId===i);a&&await Rr(t.fireId,Number(a.standId),o)},window._cambiarRetiro=async(i,o,a)=>{await zs(t.fireId,Number(o),a)}}async function $c(){const t=window.location.pathname.replace("/Sucovi2027","")||"/",e=new URLSearchParams(window.location.search),r=document.getElementById("app"),i=t.match(/^\/stand\/(\d+)$/);if(i){const c=parseInt(i[1]),u=Re.find(y=>y.id===c);if(!u){r.innerHTML=Ci("Stand no encontrado");return}const h=e.get("inv"),f=h?await Tr(h):null;return mm(r,u,f)}const o=t.match(/^\/panel\/(\d+)$/);if(o){const c=Re.find(u=>u.id===parseInt(o[1]));if(!c){r.innerHTML=Ci("Panel no encontrado");return}return Wc(r,c)}const a=t.match(/^\/bodega\/(\d+)\/vinos$/);if(a){const c=Re.find(u=>u.id===parseInt(a[1]));if(!c){r.innerHTML=Ci("Bodega no encontrada");return}return Qc(r,c)}if(t==="/carrito"){const c=e.get("inv"),u=c?await Tr(c):null;return km(r,u)}return t==="/acceso"?Sm(r,e.get("inv")):t==="/registro"?Dm(r):t==="/caja"?fm(r):t==="/puerta"?Am(r):t==="/logistica"?Tm(r):hm(r)}function Ci(n){return`<div style="padding:60px;text-align:center;color:#aaa;font-size:14px">${n}</div>`}$c();window.addEventListener("popstate",$c);(function(){var n=window.location.search.match(/[?&]p=([^&]+)/);if(n){var t="/Sucovi2027",e=decodeURIComponent(n[1].replace(/~and~/g,"&"));window.history.replaceState(null,null,t+"/"+e)}})();
