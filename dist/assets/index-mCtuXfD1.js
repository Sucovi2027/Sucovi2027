 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ht=new tl("@firebase/app"),hd="@firebase/app-compat",fd="@firebase/analytics-compat",pd="@firebase/analytics",gd="@firebase/app-check-compat",md="@firebase/app-check",yd="@firebase/auth",vd="@firebase/auth-compat",Ad="@firebase/database",_d="@firebase/data-connect",Ed="@firebase/database-compat",Id="@firebase/functions",bd="@firebase/functions-compat",wd="@firebase/installations",Td="@firebase/installations-compat",xd="@firebase/messaging",Rd="@firebase/messaging-compat",Cd="@firebase/performance",Pd="@firebase/performance-compat",Sd="@firebase/remote-config",Vd="@firebase/remote-config-compat",Dd="@firebase/storage",kd="@firebase/storage-compat",Nd="@firebase/firestore",Ld="@firebase/vertexai-preview",Bd="@firebase/firestore-compat",Od="firebase",Md="10.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qd="firebase-heartbeat-database",Gd=1,mn="firebase-heartbeat-store";let vi=null;function il(){return vi||(vi=ad(Qd,Gd,{upgrade:(n,t)=>{switch(t){case 0:try{n.createObjectStore(mn)}catch(e){console.warn(e)}}}}).catch(n=>{throw Zt.create("idb-open",{originalErrorMessage:n.message})})),vi}async function $d(n){try{const e=(await il()).transaction(mn),r=await e.objectStore(mn).get(sl(n));return await e.done,r}catch(t){if(t instanceof Le)Ht.warn(t.message);else{const e=Zt.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});Ht.warn(e.message)}}}async function Zo(n,t){try{const r=(await il()).transaction(mn,"readwrite");await r.objectStore(mn).put(t,sl(n)),await r.done}catch(e){if(e instanceof Le)Ht.warn(e.message);else{const r=Zt.create("idb-set",{originalErrorMessage:e==null?void 0:e.message});Ht.warn(r.message)}}}function sl(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function th(n){pr(new gn("platform-logger",t=>new ud(t),"PRIVATE")),pr(new gn("heartbeat",t=>new Jd(t),"PRIVATE")),we(Vi,Xo,n),we(Vi,Xo,"esm2017"),we("fire-js","")}th("");var eh="firebase",nh="10.14.1";/**
 * @license
...
*/var de,ol;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function t(b,g){function v(){}v.prototype=g.prototype,b.D=g.prototype,b.prototype=new v,b.prototype.constructor=b,b.C=function(E,I,x){for(var y=Array(arguments.length-2),Ft=2;Ft<arguments.length;Ft++)y[Ft-2]=arguments[Ft];return g.prototype[I].apply(E,y)}}function e(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}t(r,e),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(b,g,v){v||(v=0);var E=Array(16);if(typeof g=="string")for(var I=0;16>I;++I)E[I]=g.charCodeAt(v++)|g.charCodeAt(v++)<<8|g.charCodeAt(v++)<<16|g.charCodeAt(v++)<<24;else for(I=0;16>I;++I)E[I]=g[v++]|g[v++]<<8|g[v++]<<16|g[v++]<<24;g=b.g[0],v=b.g[1],I=b.g[2];var x=b.g[3],y=g+(x^v&(I^x))+E[0]+3614090360&4294967295;g=v+(y<<7&4294967295|y>>>25),y=x+(I^g&(v^I))+E[1]+3905402710&4294967295,x=g+(y<<12&4294967295|y>>>20),y=I+(v^x&(g^v))+E[2]+606105819&4294967295,I=x+(y<<17&4294967295|y>>>15),y=v+(g^I&(x^g))+E[3]+3250441966&4294967295,v=I+(y<<22&4294967295|y>>>10),y=g+(x^v&(I^x))+E[4]+4118548399&4294967295,g=v+(y<<7&4294967295|y>>>25),y=x+(I^g&(v^I))+E[5]+1200080426&4294967295,x=g+(y<<12&4294967295|y>>>20),y=I+(v^x&(g^v))+E[6]+2821735955&4294967295,I=x+(y<<17&4294967295|y>>>15),y=v+(g^I&(x^g))+E[7]+4249261313&4294967295,v=I+(y<<22&4294967295|y>>>10),y=g+(x^v&(I^x))+E[8]+1770035416&4294967295,g=v+(y<<7&4294967295|y>>>25),y=x+(I^g&(v^I))+E[9]+2336552879&4294967295,x=g+(y<<12&4294967295|y>>>20),y=I+(v^x&(g^v))+E[10]+4294925233&4294967295,I=x+(y<<17&4294967295|y>>>15),y=v+(g^I&(x^g))+E[11]+2304563134&4294967295,v=I+(y<<22&4294967295|y>>>10),y=g+(x^v&(I^x))+E[12]+1804603682&4294967295,g=v+(y<<7&4294967295|y>>>25),y=x+(I^g&(v^I))+E[13]+4254626195&4294967295,x=g+(y<<12&4294967295|y>>>20),y=I+(v^x&(g^v))+E[14]+2792965006&4294967295,I=x+(y<<17&4294967295|y>>>15),y=v+(g^I&(x^g))+E[15]+1236535329&4294967295,v=I+(y<<22&4294967295|y>>>10),y=g+(I^x&(v^I))+E[1]+4129170786&4294967295,g=v+(y<<5&4294967295|y>>>27),y=x+(v^I&(g^v))+E[6]+3225465664&4294967295,x=g+(y<<9&4294967295|y>>>23),y=I+(g^v&(x^g))+E[11]+643717713&4294967295,I=x+(y<<14&4294967295|y>>>18),y=v+(x^g&(I^x))+E[0]+3921069994&4294967295,v=I+(y<<20&4294967295|y>>>12),y=g+(I^x&(v^I))+E[5]+3593408605&4294967295,g=v+(y<<5&4294967295|y>>>27),y=x+(v^I&(g^v))+E[10]+38016083&4294967295,x=g+(y<<9&4294967295|y>>>23),y=I+(g^v&(x^g))+E[15]+3634488961&4294967295,I=x+(y<<14&4294967295|y>>>18),y=v+(x^g&(I^x))+E[4]+3889429448&4294967295,v=I+(y<<20&4294967295|y>>>12),y=g+(I^x&(v^I))+E[9]+568446438&4294967295,g=v+(y<<5&4294967295|y>>>27),y=x+(v^I&(g^v))+E[14]+3275163606&4294967295,x=g+(y<<9&4294967295|y>>>23),y=I+(g^v&(x^g))+E[3]+4107603335&4294967295,I=x+(y<<14&4294967295|y>>>18),y=v+(x^g&(I^x))+E[8]+1163531501&4294967295,v=I+(y<<20&4294967295|y>>>12),y=g+(I^x&(v^I))+E[13]+2850285829&4294967295,g=v+(y<<5&4294967295|y>>>27),y=x+(v^I&(g^v))+E[2]+4243563512&4294967295,x=g+(y<<9&4294967295|y>>>23),y=I+(g^v&(x^g))+E[7]+1735328473&4294967295,I=x+(y<<14&4294967295|y>>>18),y=v+(x^g&(I^x))+E[12]+2368359562&4294967295,v=I+(y<<20&4294967295|y>>>12),y=g+(v^I^x)+E[5]+4294588738&4294967295,g=v+(y<<4&4294967295|y>>>28),y=x+(g^v^I)+E[8]+2272392833&4294967295,x=g+(y<<11&4294967295|y>>>21),y=I+(x^g^v)+E[11]+1839030562&4294967295,I=x+(y<<16&4294967295|y>>>16),y=v+(I^x^g)+E[14]+4259657740&4294967295,v=I+(y<<23&4294967295|y>>>9),y=g+(v^I^x)+E[1]+2763975236&4294967295,g=v+(y<<4&4294967295|y>>>28),y=x+(g^v^I)+E[4]+1272893353&4294967295,x=g+(y<<11&4294967295|y>>>21),y=I+(x^g^v)+E[7]+4139469664&4294967295,I=x+(y<<16&4294967295|y>>>16),y=v+(I^x^g)+E[10]+3200236656&4294967295,v=I+(y<<23&4294967295|y>>>9),y=g+(v^I^x)+E[13]+681279174&4294967295,g=v+(y<<4&4294967295|y>>>28),y=x+(g^v^I)+E[0]+3936430074&4294967295,x=g+(y<<11&4294967295|y>>>21),y=I+(x^g^v)+E[3]+3572445317&4294967295,I=x+(y<<16&4294967295|y>>>16),y=v+(I^x^g)+E[6]+76029189&4294967295,v=I+(y<<23&4294967295|y>>>9),y=g+(v^I^x)+E[9]+3654602809&4294967295,g=v+(y<<4&4294967295|y>>>28),y=x+(g^v^I)+E[12]+3873151461&4294967295,x=g+(y<<11&4294967295|y>>>21),y=I+(x^g^v)+E[15]+530742520&4294967295,I=x+(y<<16&4294967295|y>>>16),y=v+(I^x^g)+E[2]+3299628645&4294967295,v=I+(y<<23&4294967295|y>>>9),y=g+(I^(v|~x))+E[0]+4096336452&4294967295,g=v+(y<<6&4294967295|y>>>26),y=x+(v^(g|~I))+E[7]+1126891415&4294967295,x=g+(y<<10&4294967295|y>>>22),y=I+(g^(x|~v))+E[14]+2878612391&4294967295,I=x+(y<<15&4294967295|y>>>17),y=v+(x^(I|~g))+E[5]+4237533241&4294967295,v=I+(y<<21&4294967295|y>>>11),y=g+(I^(v|~x))+E[12]+1700485571&4294967295,g=v+(y<<6&4294967295|y>>>26),y=x+(v^(g|~I))+E[3]+2399980690&4294967295,x=g+(y<<10&4294967295|y>>>22),y=I+(g^(x|~v))+E[10]+4293915773&4294967295,I=x+(y<<15&4294967295|y>>>17),y=v+(x^(I|~g))+E[1]+2240044497&4294967295,v=I+(y<<21&4294967295|y>>>11),y=g+(I^(v|~x))+E[8]+1873313359&4294967295,g=v+(y<<6&4294967295|y>>>26),y=x+(v^(g|~I))+E[15]+4264355552&4294967295,x=g+(y<<10&4294967295|y>>>22),y=I+(g^(x|~v))+E[6]+2734768916&4294967295,I=x+(y<<15&4294967295|y>>>17),y=v+(x^(I|~g))+E[13]+1309151649&4294967295,v=I+(y<<21&4294967295|y>>>11),y=g+(I^(v|~x))+E[4]+4149444226&4294967295,g=v+(y<<6&4294967295|y>>>26),y=x+(v^(g|~I))+E[11]+3174756917&4294967295,x=g+(y<<10&4294967295|y>>>22),y=I+(g^(x|~v))+E[2]+718787259&4294967295,I=x+(y<<15&4294967295|y>>>17),y=v+(x^(I|~g))+E[9]+3951481745&4294967295,b.g[0]=b.g[0]+g&4294967295,b.g[1]=b.g[1]+(I+(y<<21&4294967295|y>>>11))&4294967295,b.g[2]=b.g[2]+I&4294967295,b.g[3]=b.g[3]+x&4294967295}r.prototype.u=function(b,g){g===void 0&&(g=b.length);for(var v=g-this.blockSize,E=this.B,I=this.h,x=0;x<g;){if(I==0)for(;x<=v;)i(this,b,x),x+=this.blockSize;if(typeof b=="string"){for(;x<g;)if(E[I++]=b.charCodeAt(x++),I==this.blockSize){i(this,E),I=0;break}}else for(;x<g;)if(E[I++]=b[x++],I==this.blockSize){i(this,E),I=0;break}}this.h=I,this.o+=g},r.prototype.v=function(){var b=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);b[0]=128;for(var g=1;g<b.length-8;++g)b[g]=0;var v=8*this.o;for(g=b.length-8;g<b.length;++g)b[g]=v&255,v/=256;for(this.u(b),b=Array(16),g=v=0;4>g;++g)for(var E=0;32>E;E+=8)b[v++]=this.g[g]>>>E&255;return b};function o(b,g){var v=c;return Object.prototype.hasOwnProperty.call(v,b)?v[b]:v[b]=g(b)}function a(b,g){this.h=g;for(var v=[],E=!0,I=b.length-1;0<=I;I--){var x=b[I]|0;E&&x==g||(v[I]=x,E=!1)}this.g=v}var c={};function u(b){return-128<=b&&128>b?o(b,function(g){return new a([g|0],0>g?-1:0)}):new a([b|0],0>b?-1:0)}function h(b){if(isNaN(b)||!isFinite(b))return m;if(0>b)return P(h(-b));for(var g=[],v=1,E=0;b>=v;E++)g[E]=b/v|0,v*=4294967296;return new a(g,0)}function f(b,g){if(b.length==0)throw Error("number format error: empty string");if(g=g||10,2>g||36<g)throw Error("radix out of range: "+g);if(b.charAt(0)=="-")return P(f(b.substring(1),g));if(0<=b.indexOf("-"))throw Error('number format error: interior "-" character');for(var v=h(Math.pow(g,8)),E=m,I=0;I<b.length;I+=8){var x=Math.min(8,b.length-I),y=parseInt(b.substring(I,I+x),g);8>x?(x=h(Math.pow(g,x)),E=E.j(x).add(h(y))):(E=E.j(v),E=E.add(h(y)))}return E}var m=u(0),A=u(1),_=u(16777216);n=a.prototype,n.m=function(){if(V(this))return-P(this).m();for(var b=0,g=1,v=0;v<this.g.length;v++){var E=this.i(v);b+=(0<=E?E:4294967296+E)*g,g*=4294967296}return b},n.toString=function(b){if(b=b||10,2>b||36<b)throw Error("radix out of range: "+b);if(T(this))return"0";if(V(this))return"-"+P(this).toString(b);for(var g=h(Math.pow(b,6)),v=this,E="";;){var I=M(v,g).g;v=L(v,I.j(g));var x=((0<v.g.length?v.g[0]:v.h)>>>0).toString(b);if(v=I,T(v))return x+E;for(;6>x.length;)x="0"+x;E=x+E}},n.i=function(b){return 0>b?0:b<this.g.length?this.g[b]:this.h};function T(b){if(b.h!=0)return!1;for(var g=0;g<b.g.length;g++)if(b.g[g]!=0)return!1;return!0}function V(b){return b.h==-1}n.l=function(b){return b=L(this,b),V(b)?-1:T(b)?0:1};function P(b){for(var g=b.g.length,v=[],E=0;E<g;E++)v[E]=~b.g[E];return new a(v,~b.h).add(A)}n.abs=function(){return V(this)?P(this):this},n.add=function(b){for(var g=Math.max(this.g.length,b.g.length),v=[],E=0,I=0;I<=g;I++){var x=E+(this.i(I)&65535)+(b.i(I)&65535),y=(x>>>16)+(this.i(I)>>>16)+(b.i(I)>>>16);E=y>>>16,x&=65535,y&=65535,v[I]=y<<16|x}return new a(v,v[v.length-1]&-2147483648?-1:0)};function L(b,g){return b.add(P(g))}n.j=function(b){if(T(this)||T(b))return m;if(V(this))return V(b)?P(this).j(P(b)):P(P(this).j(b));if(V(b))return P(this.j(P(b)));if(0>this.l(_)&&0>b.l(_))return h(this.m()*b.m());for(var g=this.g.length+b.g.length,v=[],E=0;E<2*g;E++)v[E]=0;for(E=0;E<this.g.length;E++)for(var I=0;I<b.g.length;I++){var x=this.i(E)>>>16,y=this.i(E)&65535,Ft=b.i(I)>>>16,qe=b.i(I)&65535;v[2*E+2*I]+=y*qe,O(v,2*E+2*I),v[2*E+2*I+1]+=x*qe,O(v,2*E+2*I+1),v[2*E+2*I+1]+=y*Ft,O(v,2*E+2*I+1),v[2*E+2*I+2]+=x*Ft,O(v,2*E+2*I+2)}for(E=0;E<g;E++)v[E]=v[2*E+1]<<16|v[2*E];for(E=g;E<2*g;E++)v[E]=0;return new a(v,0)};function O(b,g){for(;(b[g]&65535)!=b[g];)b[g+1]+=b[g]>>>16,b[g]&=65535,g++}function N(b,g){this.g=b,this.h=g}function M(b,g){if(T(g))throw Error("division by zero");if(T(b))return new N(m,m);if(V(b))return g=M(P(b),g),new N(P(g.g),P(g.h));if(V(g))return g=M(b,P(g)),new N(P(g.g),g.h);if(30<b.g.length){if(V(b)||V(g))throw Error("slowDivide_ only works with positive integers.");for(var v=A,E=g;0>=E.l(b);)v=ht(v),E=ht(E);var I=z(v,1),x=z(E,1);for(E=z(E,2),v=z(v,2);!T(E);){var y=x.add(E);0>=y.l(b)&&(I=I.add(v),x=y),E=z(E,1),v=z(v,1)}return g=L(b,I.j(g)),new N(I,g)}for(I=m;0<=b.l(g);){for(v=Math.max(1,Math.floor(b.m()/g.m())),E=Math.ceil(Math.log(v)/Math.LN2),E=48>=E?1:Math.pow(2,E-48),x=h(v),y=x.j(g);V(y)||0<y.l(b);)v-=E,x=h(v),y=x.j(g);T(x)&&(x=A),I=I.add(x),b=L(b,y)}return new N(I,b)}n.A=function(b){return M(this,b).h},n.and=function(b){for(var g=Math.max(this.g.length,b.g.length),v=[],E=0;E<g;E++)v[E]=this.i(E)&b.i(E);return new a(v,this.h&b.h)},n.or=function(b){for(var g=Math.max(this.g.length,b.g.length),v=[],E=0;E<g;E++)v[E]=this.i(E)|b.i(E);return new a(v,this.h|b.h)},n.xor=function(b){for(var g=Math.max(this.g.length,b.g.length),v=[],E=0;E<g;E++)v[E]=this.i(E)^b.i(E);return new a(v,this.h^b.h)};function ht(b){for(var g=b.g.length+1,v=[],E=0;E<g;E++)v[E]=b.i(E)<<1|b.i(E-1)>>>31;return new a(v,b.h)}function z(b,g){var v=g>>5;g%=32;for(var E=b.g.length-v,I=[],x=0;x<E;x++)I[x]=0<g?b.i(x+v)>>>g|b.i(x+v+1)<<32-g:b.i(x+v);return new a(I,b.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,ol=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=h,a.fromString=f,de=a}).apply(typeof ea<"u"?ea:typeof self<"u"?self:typeof window<"u"?window:{});var nr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Tn(n){if(n.code!==C.FAILED_PRECONDITION||n.message!==gh)throw n;B("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ra(n){let t=0;for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t++;return t}function ge(n,t){for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t(e,n[e])}function pl(n){for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function os(n,t){if(n.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:gr(t)?"-0":t}}function Pl(n){return{integerValue:""+n}}function qh(n,t){return vh(t)?Pl(t):os(n,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class If{constructor(t){this.ct=t}}function bf(n){const t=mf({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?ji(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cf{constructor(t,e,r,i){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=r,this.indexManager=i}getDocument(t,e){let r=null;return this.documentOverlayCache.getOverlay(t,e).next(i=>(r=i,this.remoteDocumentCache.getEntry(t,e))).next(i=>(r!==null&&pn(r.mutation,i,Ct.empty(),st.now()),i))}getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next(r=>this.getLocalViewOfDocuments(t,r,U()).next(()=>r))}getLocalViewOfDocuments(t,e,r=U()){const i=ue();return this.populateOverlays(t,i,e).next(()=>this.computeViews(t,e,i,r).next(o=>{let a=ln();return o.forEach((c,u)=>{a=a.insert(c,u.overlayedDocument)}),a}))}getOverlayedDocuments(t,e){const r=ue();return this.populateOverlays(t,r,e).next(()=>this.computeViews(t,e,r,U()))}populateOverlays(t,e,r){const i=[];return r.forEach(o=>{e.has(o)||i.push(o)}),this.documentOverlayCache.getOverlays(t,i).next(o=>{o.forEach((a,c)=>{e.set(a,c)})})}computeViews(t,e,r,i){let o=Wt();const a=fn(),c=function(){return fn()}();return e.forEach((u,h)=>{const f=r.get(h.key);i.has(h.key)&&(f===void 0||f.mutation instanceof re)?o=o.insert(h.key,h):f!==void 0?(a.set(h.key,f.mutation.getFieldMask()),pn(f.mutation,h,f.mutation.getFieldMask(),st.now())):a.set(h.key,Ct.empty())}),this.recalculateAndSaveOverlays(t,o).next(u=>(u.forEach((h,f)=>a.set(h,f)),e.forEach((h,f)=>{var m;return c.set(h,new Rf(f,(m=a.get(h))!==null&&m!==void 0?m:null))}),c))}recalculateAndSaveOverlays(t,e){const r=fn();let i=new tt((a,c)=>a-c),o=U();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next(a=>{for(const c of a)c.keys().forEach(u=>{const h=e.get(u);if(h===null)return;let f=r.get(u)||Ct.empty();f=c.applyToLocalView(h,f),r.set(u,f);const m=(i.get(c.batchId)||U()).add(u);i=i.insert(c.batchId,m)})}).next(()=>{const a=[],c=i.getReverseIterator();for(;c.hasNext();){const u=c.getNext(),h=u.key,f=u.value,m=Cl();f.forEach(A=>{if(!o.has(A)){const _=Nl(e.get(A),r.get(A));_!==null&&m.set(A,_),o=o.add(A)}}),a.push(this.documentOverlayCache.saveOverlays(t,h,m))}return S.waitFor(a)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(t,e){return this.remoteDocumentCache.getEntries(t,e).next(r=>this.recalculateAndSaveOverlays(t,r))}getDocumentsMatchingQuery(t,e,r,i){return function(a){return F.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0}(e)?this.getDocumentsMatchingDocumentQuery(t,e.path):bl(e)?this.getDocumentsMatchingCollectionGroupQuery(t,e,r,i):this.getDocumentsMatchingCollectionQuery(t,e,r,i)}getNextDocuments(t,e,r,i){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,r,i).next(o=>{const a=i-o.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,r.largestBatchId,i-o.size):S.resolve(ue());let c=-1,u=o;return a.next(h=>S.forEach(h,(f,m)=>(c<m.largestBatchId&&(c=m.largestBatchId),o.get(f)?S.resolve():this.remoteDocumentCache.getEntry(t,f).next(A=>{u=u.insert(f,A)}))).next(()=>this.populateOverlays(t,h,o)).next(()=>this.computeViews(t,u,h,U())).next(f=>({batchId:c,changes:Rl(f)})))})}getDocumentsMatchingDocumentQuery(t,e){return this.getDocument(t,new F(e)).next(r=>{let i=ln();return r.isFoundDocument()&&(i=i.insert(r.key,r)),i})}getDocumentsMatchingCollectionGroupQuery(t,e,r,i){const o=e.collectionGroup;let a=ln();return this.indexManager.getCollectionParents(t,o).next(c=>S.forEach(c,u=>{const h=function(m,A){return new Oe(A,null,m.explicitOrderBy.slice(),m.filters.slice(),m.limit,m.limitType,m.startAt,m.endAt)}(e,u.child(o));return this.getDocumentsMatchingCollectionQuery(t,h,r,i).next(f=>{f.forEach((m,A)=>{a=a.insert(m,A)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(t,e,r,i){let o;return this.documentOverlayCache.getOverlaysForCollection(t,e.path,r.largestBatchId).next(a=>(o=a,this.remoteDocumentCache.getDocumentsMatchingQuery(t,e,r,o,i))).next(a=>{o.forEach((u,h)=>{const f=h.getKey();a.get(f)===null&&(a=a.insert(f,At.newInvalidDocument(f)))});let c=ln();return a.forEach((u,h)=>{const f=o.get(u);f!==void 0&&pn(f.mutation,h,Ct.empty(),st.now()),Pr(e,h)&&(c=c.insert(u,h))}),c})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bf{constructor(t,e){this.qr={},this.overlays={},this.Qr=new ts(0),this.Kr=!1,this.Kr=!0,this.$r=new Vf,this.referenceDelegate=t(this),this.Ur=new Lf(this),this.indexManager=new wf,this.remoteDocumentCache=function(i){return new kf(i)}(r=>this.referenceDelegate.Wr(r)),this.serializer=new If(e),this.Gr=new Pf(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(t){return this.indexManager}getDocumentOverlayCache(t){let e=this.overlays[t.toKey()];return e||(e=new Sf,this.overlays[t.toKey()]=e),e}getMutationQueue(t,e){let r=this.qr[t.toKey()];return r||(r=new Df(e,this.referenceDelegate),this.qr[t.toKey()]=r),r}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(t,e,r){B("MemoryPersistence","Starting transaction:",t);const i=new Of(this.Qr.next());return this.referenceDelegate.zr(),r(i).next(o=>this.referenceDelegate.jr(i).next(()=>o)).toPromise().then(o=>(i.raiseOnCommittedEvent(),o))}Hr(t,e){return S.or(Object.values(this.qr).map(r=>()=>r.containsKey(t,e)))}}class Of extends mh{constructor(t){super(),this.currentSequenceNumber=t}}class ds{constructor(t){this.persistence=t,this.Jr=new us,this.Yr=null}static Zr(t){return new ds(t)}get Xr(){if(this.Yr)return this.Yr;throw j()}addReference(t,e,r){return this.Jr.addReference(r,e),this.Xr.delete(r.toString()),S.resolve()}removeReference(t,e,r){return this.Jr.removeReference(r,e),this.Xr.add(r.toString()),S.resolve()}markPotentiallyOrphaned(t,e){return this.Xr.add(e.toString()),S.resolve()}removeTarget(t,e){this.Jr.gr(e.targetId).forEach(i=>this.Xr.add(i.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(t,e.targetId).next(i=>{i.forEach(o=>this.Xr.add(o.toString()))}).next(()=>r.removeTargetData(t,e))}zr(){this.Yr=new Set}jr(t){const e=this.persistence.getRemoteDocumentCache().newChangeBuffer();return S.forEach(this.Xr,r=>{const i=F.fromPath(r);return this.ei(t,i).next(o=>{o||e.removeEntry(i,q.min())})}).next(()=>(this.Yr=null,e.apply(t)))}updateLimboDocument(t,e){return this.ei(t,e).next(r=>{r?this.Xr.delete(e.toString()):this.Xr.add(e.toString())})}Wr(t){return 0}ei(t,e){return S.or([()=>S.resolve(this.Jr.containsKey(e)),()=>this.persistence.getTargetCache().containsKey(t,e),()=>this.persistence.Hr(t,e)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function Fs(n){return Vn(n=wt(n,Bt)),new Yp(n,t=>Bn(n,t))}(function(t,e=!0){(function(i){Be=i})(Ud),pr(new gn("firestore",(r,{instanceIdentifier:i,options:o})=>{const a=r.getProvider("app").getImmediate(),c=new Bt(new sh(r.getProvider("auth-internal")),new ch(r.getProvider("app-check-internal")),function(h,f){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new k(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new An(h.options.projectId,f)}(a,i),a);return o=Object.assign({useFetchStreams:e},o),c._setSettings(o),c},"PUBLIC").setMultipleInstances(!0)),we(na,"4.7.3",t),we(na,"4.7.3","esm2017")})();const tg={apiKey:"AIzaSyCs0qf02HaIv0-aAe7wVntfosDL1SjdOws",authDomain:"feria-vinos-sucovi-2027.firebaseapp.com",databaseURL:"https://feria-vinos-sucovi-2027-default-rtdb.firebaseio.com",projectId:"feria-vinos-sucovi-2027",storageBucket:"feria-vinos-sucovi-2027.firebasestorage.app",messagingSenderId:"1686119758",appId:"1:1686119758:web:2c3c6d96e36f1276052a1f",measurementId:"G-VRMTQ3SS7E"},eg=rl(tg),Y=Hp(eg),xe=[{id:0,nombre:"Sucovi",region:"Pruebas / Bebidas",pass:"stand00"},{id:1,nombre:"Alta Vista",region:"Mendoza",pass:"stand01"},{id:2,nombre:"Andillian",region:"Mendoza",pass:"stand02"},{id:3,nombre:"Ante Nada",region:"Mendoza",pass:"stand03"},{id:4,nombre:"Bodega Benegas",region:"Mendoza",pass:"stand04"},{id:5,nombre:"Bianchi",region:"San Rafael",pass:"stand05"},{id:6,nombre:"Catena Zapata",region:"Luján de Cuyo",pass:"stand06"},{id:7,nombre:"Bodegas Bórbore",region:"Mendoza (1936)",pass:"stand07"},{id:8,nombre:"Fábula Wines",region:"Mendoza",pass:"stand08"},{id:9,nombre:"Finca Iral",region:"Mendoza",pass:"stand09"},{id:10,nombre:"Giménez Riili",region:"Mendoza",pass:"stand10"},{id:11,nombre:"Jorge Rubio",region:"Mendoza",pass:"stand11"},{id:12,nombre:"La Coste de los Andes",region:"Mendoza",pass:"stand12"},{id:13,nombre:"Las Perdices",region:"Mendoza",pass:"stand13"},{id:14,nombre:"Lorenzo de Agrelo",region:"Mendoza",pass:"stand14"},{id:15,nombre:"Pannunzio Wines",region:"Mendoza",pass:"stand15"},{id:16,nombre:"Bodega Patritti",region:"Mendoza",pass:"stand16"},{id:17,nombre:"Rosell Boher",region:"Mendoza",pass:"stand17"},{id:18,nombre:"Valle de la Puerta",region:"La Rioja",pass:"stand18"}];async function br(n){return await Cc(xt(Y,"invitados"),{...n,creadoEn:Sc()})}async function Re(n,t){await je(Ot(Y,"invitados",n),t)}function Hr(n){return ze(zr(xt(Y,"invitados"),qr("creadoEn","desc")),t=>n(t.docs.map(e=>({fireId:e.id,...e.data()}))))}async function wr(n){const e=(await Ln(xt(Y,"invitados"))).docs.find(r=>r.data().token===n);return e?{fireId:e.id,...e.data()}:null}async function ng(n){const e=(await Ln(xt(Y,"invitados"))).docs.find(r=>r.data().codigo===n);return e?{fireId:e.id,...e.data()}:null}async function Vc(n,t,e,r,i){const o=Ot(Y,"carritos",n,"items",String(t)),a=await xc(o);if(a.exists()){const c=a.data(),u=c.items||[],h=u.findIndex(f=>f.key===r.key);h>=0?u[h]=r:u.push(r),await qa(o,{standId:t,standNombre:e,items:u,retiro:i||c.retiro||"stand"})}else await qa(o,{standId:t,standNombre:e,items:[r],retiro:i||"stand"})}async function js(n,t,e){await je(Ot(Y,"carritos",n,"items",String(t)),{retiro:e})}async function Tr(n,t,e){const r=Ot(Y,"carritos",n,"items",String(t)),i=await xc(r);if(!i.exists())return;const o=(i.data().items||[]).filter(a=>a.key!==e);o.length?await je(r,{items:o}):await Rc(r)}async function rg(n){return(await Ln(xt(Y,"carritos",n,"items"))).docs.map(e=>({standId:e.id,...e.data()}))}function zs(n,t){return ze(xt(Y,"carritos",n,"items"),e=>t(e.docs.map(r=>({standDocId:r.id,...r.data()}))))}async function ig(n){const t=await Ln(xt(Y,"carritos",n,"items")),e=Fs(Y);t.docs.forEach(r=>e.delete(r.ref)),await e.commit()}async function sg(n,t){const e=Fs(Y),r=[];return t.forEach(i=>{const o=Ot(xt(Y,"pedidos"));r.push(o),e.set(o,{invFireId:n.fireId,invNombre:n.nombre+" "+n.apellido,invCodigo:n.codigo,standId:i.standId,standNombre:i.standNombre,items:i.items||[],total:(i.items||[]).reduce((a,c)=>a+(c.sub||0),0),retiro:i.retiro||"stand",estado:"pagado",creadoEn:Sc()})}),await e.commit(),r.map(i=>i.id)}function Ur(n){return ze(zr(xt(Y,"pedidos"),qr("creadoEn","desc")),t=>n(t.docs.map(e=>({fireId:e.id,...e.data()}))))}function Dc(n,t){return ze(zr(xt(Y,"pedidos"),qr("creadoEn","desc")),e=>t(e.docs.map(r=>({fireId:r.id,...r.data()})).filter(r=>Number(r.standId)===Number(n))))}function kc(n,t){return ze(zr(xt(Y,"pedidos"),qr("creadoEn","desc")),e=>t(e.docs.map(r=>({fireId:r.id,...r.data()})).filter(r=>r.invFireId===n)))}async function Nc(n){await je(Ot(Y,"pedidos",n),{estado:"entregado"})}async function qs(n,t){const e={pendiente:"pagado",pagado:"listo",listo:"entregado"};e[t]&&await je(Ot(Y,"pedidos",n),{estado:e[t]})}function Hs(n,t){return ze(xt(Y,"bodegas",String(n),"vinos"),e=>t(e.docs.map(r=>({fireId:r.id,...r.data()}))))}async function Lc(n,t){return await Cc(xt(Y,"bodegas",String(n),"vinos"),t)}async function Bc(n,t,e){await je(Ot(Y,"bodegas",String(n),"vinos",t),e)}async function Oc(n,t){await Rc(Ot(Y,"bodegas",String(n),"vinos",t))}async function Mc(){const n=["invitados","pedidos"];for(const t of n){const e=await Ln(xt(Y,t)),r=Fs(Y);e.docs.forEach(i=>r.delete(i.ref)),await r.commit()}}const og=Object.freeze(Object.defineProperty({__proto__:null,BODEGAS:xe,actualizarInvitado:Re,actualizarRetiroStand:js,actualizarVino:Bc,agregarAlCarrito:Vc,avanzarEstado:qs,buscarInvitadoPorCodigo:ng,buscarInvitadoPorToken:wr,crearInvitado:br,crearPedidosDesdeCarrito:sg,eliminarItemCarrito:Tr,eliminarVino:Oc,escucharCarrito:zs,escucharInvitados:Hr,escucharPedidos:Ur,escucharPedidosPorInvitado:kc,escucharPedidosPorStand:Dc,escucharVinos:Hs,guardarVino:Lc,leerCarrito:rg,limpiarDatosPrueba:Mc,marcarEntregado:Nc,vaciarCarrito:ig},Symbol.toStringTag,{value:"Module"})),ag="modulepreload",lg=function(n){return"/"+n},Ha={},Fc=function(t,e,r){let i=Promise.resolve();if(e&&e.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),c=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));i=Promise.allSettled(e.map(u=>{if(u=lg(u),u in Ha)return;Ha[u]=!0;const h=u.endsWith(".css"),f=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${f}`))return;const m=document.createElement("link");if(m.rel=h?"stylesheet":ag,h||(m.as="script"),m.crossOrigin="",m.href=u,c&&m.setAttribute("nonce",c),document.head.appendChild(m),h)return new Promise((A,_)=>{m.addEventListener("load",A),m.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${u}`)))})}))}function o(a){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=a,window.dispatchEvent(c),!c.defaultPrevented)throw a}return i.then(a=>{for(const c of a||[])c.status==="rejected"&&o(c.reason);return t().catch(o)})},jc="data:image/png;base64,";function Vt({title:n,sub:t="",backHref:e="",backLabel:r="← Panel",actions:i=[]}={}){return`
  ...
  `,document.head.appendChild(n)}const or=n=>Number(n).toLocaleString("es-AR"),Ua=()=>Math.random().toString(36).slice(2,10).toUpperCase(),Wa=n=>"INV-"+String(n).padStart(4,"0");function Qa(n){return{pendiente:'<span class="badge b-pend">Pendiente</span>',pagado:'<span class="badge b-pago">Bono pagado</span>',ingresado:'<span class="badge b-ingr">Ingresó</span>',invalidado:'<span class="badge b-inv">Invalidado</span>'}[n]||""}const cg={pendiente:"Pendiente",pagado:"Pagado",listo:"Listo",entregado:"Entregado"},ug={pendiente:"b-pend",pagado:"b-pago",listo:"b-list",entregado:"b-entr"};function dg(n){Mt();let t=[],e=[],r="inv",i=null;n.innerHTML=Vt({title:"Sucovi 2027",sub:"20 jun 2026 · 19:30 hs · Roma 656, Olivos"})+`
    ...
    <div id="modal-wa" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;
    ...
    </div>`,Hr(_=>{t=_,r==="inv"&&o(),r==="res"&&m()}),Ur(_=>{e=_,r==="ped"&&h(),r==="res"&&m()}),window._aTab=(_,T)=>{var P;r=_,document.querySelectorAll(".nav button").forEach(L=>L.classList.remove("on")),T.classList.add("on");const V={inv:o,reg:a,excel:c,ped:h,stands:f,res:m,config:A};(P=V[_])==null||P.call(V)};function o(){const _=document.getElementById("tab-content");document.getElementById("buscar-inv")||(_.innerHTML=`
      ...
      <div class="card" style="margin-bottom:8px;display:flex;align-items:center;gap:8px;flex-wrap:wrap">
        ...
        <span class="badge ${ug[T.estado]}">${cg[T.estado]}</span>
      ...
      </div>`,xe.forEach(T=>setTimeout(()=>Ga("qr-s"+T.id,`${_}/stand/${T.id}`,110),50))}function m(){const _=t.filter(N=>N.estado==="pagado").length,T=t.filter(N=>N.estado==="ingresado").length,V=(_+T)*35e3,P=e.reduce((N,M)=>N+(M.total||0),0),L={};e.forEach(N=>{L[N.standId]||(L[N.standId]={n:N.standNombre,t:0,c:0}),L[N.standId].t+=N.total||0,L[N.standId].c++});const O=Object.values(L).sort((N,M)=>M.t-N.t);document.getElementById("tab-content").innerHTML=`
      <div class="stats">
...
Consultas: José Pannunzio +54 9 11 5400-1313`;document.getElementById("mw-msg").textContent=L;const O=document.getElementById("mw-btn-p");T.estado==="pendiente"?(O.textContent="✓ Marcar como pagado",O.disabled=!1,O.style.display="block"):O.style.display="none",Ga("mw-canvas",T.codigo||T.fireId,80),document.getElementById("modal-wa").style.display="flex"},window._pagarM=async()=>{const _=t.find(T=>T.fireId===i);!_||_.estado!=="pendiente"||await Re(_.fireId,{estado:"pagado"})},window._copWA=()=>{var V;(V=navigator.clipboard)==null||V.writeText(document.getElementById("mw-msg").textContent).catch(()=>{});const _=document.querySelector("#modal-wa .btn-g"),T=_.innerHTML;_.innerHTML="✓ ¡Copiado!",setTimeout(()=>_.innerHTML=T,2e3)},window._cModal=()=>{document.getElementById("modal-wa").style.display="none",i=null},o()}function Ga(n,t,e){const r=document.getElementById(n);if(!r)return;const i=r.getContext("2d");r.width=e,r.height=e;const o=21,a=e/o;i.fillStyle="#fff",i.fillRect(0,0,e,e),i.fillStyle="#1a1a1a";const c=String(t).split("").reduce((h,f)=>h+f.charCodeAt(0),0),u=(h,f)=>(h*7+f*13+c*(h+1))%17<8;for(let h=0;h<o;h++)for(let f=0;f<o;f++){const m=(_,T)=>f>=_&&f<=_+6&&h>=T&&h<=T+6,A=(_,T)=>f>=_+2&&f<=_+4&&h>=T+2&&h<=T+4;if(m(0,0)||m(14,0)||m(0,14)){(m(0,0)&&(f===0||f===6||h===0||h===6||A(0,0))||m(14,0)&&(f===14||f===20||h===0||h===6||f>=16&&f<=18&&h>=2&&h<=4)||m(0,14)&&(f===0||f===6||h===14||h===20||f>=2&&f<=4&&h>=16&&h<=18))&&i.fillRect(f*a,h*a,a,a);continue}u(f,h)&&i.fillRect(f*a+.5,h*a+.5,a-1,a-1)}}const $a=n=>Number(n).toLocaleString("es-AR"),hg={pendiente:"Pendiente",pagado:"Pagado",listo:"Listo",entregado:"Entregado"},fg={pendiente:"b-pend",pagado:"b-pago",listo:"b-list",entregado:"b-entr"},pg={pendiente:"Cobrar ✓",pagado:"Listo ✓",listo:"Entregar ✓"},gg={pendiente:"btn-g",pagado:"btn-b",listo:"btn-v"},mg={pendiente:"pagado",pagado:"listo",listo:"entregado"};function yg(n){Mt();let t=[],e="pendiente";n.innerHTML=`
        ...
        <div class="card" style="margin-bottom:10px">
          <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:6px">
            ...
            <div style="text-align:right">
              <span class="badge ${fg[a.estado]}">${hg[a.estado]}</span>
          ...
          <div style="font-size:12px;color:#666;margin-bottom:8px;line-height:1.7">
            ${(a.items||[]).map(m=>`${m.desc} <strong>$${$a(m.sub)}</strong>`).join("<br>")}
          ...
          <div style="display:flex;justify-content:space-between;align-items:center;border-top:.5px solid #e0d5c8;padding-top:8px">
            ...
            ${mg[a.estado]?`<button class="btn ${gg[a.estado]}" onclick="window._avz('${a.fireId}','${a.estado}')">${pg[a.estado]}</button>`:'<span style="font-size:12px;color:#aaa">Completado</span>'}
          </div>
        </div>`}).join("")}}const wi=n=>Number(n).toLocaleString("es-AR");function vg(n,t,e){if(Mt(),!e||e.estado==="invalidado"){n.innerHTML=Vt({title:"🍷 "+t.nombre,sub:"Stand #"+t.id+" · Sucovi 2027"})+`
    ...
    </button>`,Hs(t.id,u=>{r=u,a()}),zs(e.fireId,u=>{var T,V,P;const h=u.find(L=>Number(L.standId)===t.id),f=u.reduce((L,O)=>L+(O.items||[]).reduce((N,M)=>N+(M.sub||0),0),0),m=u.reduce((L,O)=>L+(O.items||[]).length,0),A=document.getElementById("cart-fab"),_=document.getElementById("cart-fab-txt");A&&m>0?(A.style.display="flex",_.textContent=`Ver carrito · $${wi(f)}`):A&&(A.style.display="none"),h&&((T=h.items)!=null&&T.length)?(i=h.retiro||"stand",(V=document.getElementById("rb-stand"))==null||V.classList.toggle("sel",i==="stand"),(P=document.getElementById("rb-envio"))==null||P.classList.toggle("sel",i==="envio"),document.getElementById("retiro-box").style.display="block",document.getElementById("stand-resumen").style.display="block",document.getElementById("stand-resumen-lines").innerHTML=h.items.map(L=>`
        ...
        ${(h.unidades||[]).map((m,A)=>`
          <div class="qty-row">
            <span class="qty-label">
              ${m.u} — <span style="color:#6B1C1C;font-weight:600">$${wi(m.p)}</span>
            </span>
        ...
        <div style="display:flex;justify-content:space-between;margin-bottom:6px">
          <div>
            <span style="font-size:18px;font-weight:500;color:#6B1C1C">
              #${(m=f.fireId)==null?void 0:m.slice(-4).toUpperCase()}
            </span>
    ...
    <div style="max-width:600px;margin:0 auto;padding:14px">
      ...
      </div>`).join("")}});const o=["vn","vv","vc","vd","vb","v6","v12"],a=()=>{o.forEach(c=>{const u=document.getElementById(c);u&&(u.value="")})};window._guardarV=async()=>{const c=document.getElementById("vn").value.trim(),u=document.getElementById("vm");if(!c){u.innerHTML='<span style="color:#A32D2D">El nombre es requerido.</span>';return}const h=parseFloat(document.getElementById("vb").value),f=parseFloat(document.getElementById("v6").value),m=parseFloat(document.getElementById("v12").value),A=[];if(h&&A.push({u:"Botella",p:h}),f&&A.push({u:"Caja x6",p:f}),m&&A.push({u:"Caja x12",p:m}),!A.length){u.innerHTML='<span style="color:#A32D2D">Ingresá al menos un precio.</span>';return}const _={nombre:c,varietal:document.getElementById("vv").value.trim(),cosecha:document.getElementById("vc").value.trim(),descripcion:document.getElementById("vd").value.trim(),unidades:A};u.innerHTML='<span style="color:#888">Guardando...</span>';try{i?(await Bc(t.id,i,_),i=null):await Lc(t.id,_),a(),document.getElementById("form-titulo").textContent="Agregar vino",document.getElementById("btn-cancelar-edit").style.display="none",u.innerHTML='<span style="color:#3B6D11">✓ Guardado correctamente</span>',setTimeout(()=>{const T=document.getElementById("vm");T&&(T.innerHTML="")},3e3)}catch(T){u.innerHTML=`<span style="color:#A32D2D">Error: ${T.message}</span>`}},window._editarV=c=>{const u=r.find(A=>A.fireId===c);if(!u)return;i=c,document.getElementById("form-titulo").textContent=`Editando: ${u.nombre}`,document.getElementById("vn").value=u.nombre||"",document.getElementById("vv").value=u.varietal||"",document.getElementById("vc").value=u.cosecha||"",document.getElementById("vd").value=u.descripcion||"";const h=(u.unidades||[]).find(A=>A.u==="Botella"),f=(u.unidades||[]).find(A=>A.u==="Caja x6"),m=(u.unidades||[]).find(A=>A.u==="Caja x12");document.getElementById("vb").value=(h==null?void 0:h.p)||"",document.getElementById("v6").value=(f==null?void 0:f.p)||"",document.getElementById("v12").value=(m==null?void 0:m.p)||"",document.getElementById("btn-cancelar-edit").style.display="block",window.scrollTo({top:0,behavior:"smooth"})},window._cancelarEdit=()=>{i=null,a(),document.getElementById("form-titulo").textContent="Agregar vino",document.getElementById("btn-cancelar-edit").style.display="none"},window._eliminarV=async c=>{const u=r.find(h=>h.fireId===c);confirm(`¿Eliminar "${u==null?void 0:u.nombre}"?`)&&await Oc(t.id,c)}}window._scannerStop=null;async function Eg(){window.jsQR||await new Promise((n,t)=>{const e=document.createElement("script");e.src="https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.js",e.onload=n,e.onerror=t,document.head.appendChild(e)})}window._initScanner=async function(n,t,e){const r=e?document.getElementById(e):null;r&&(r.textContent="Iniciando cámara...");try{await Eg();const i=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}}),o=document.getElementById(n);if(!o){i.getTracks().forEach(f=>f.stop());return}o.srcObject=i;const a=document.createElement("canvas"),c=a.getContext("2d",{willReadFrequently:!0});let u=!0;window._scannerStop=()=>{u=!1,i.getTracks().forEach(f=>f.stop()),window._scannerStop=null},r&&(r.textContent="Buscando QR...");const h=()=>{var f;if(u){if(o.readyState===o.HAVE_ENOUGH_DATA&&o.videoWidth>0){a.width=o.videoWidth,a.height=o.videoHeight,c.drawImage(o,0,0);const m=c.getImageData(0,0,a.width,a.height),A=window.jsQR(m.data,m.width,m.height,{inversionAttempts:"dontInvert"});if(A&&A.data){(f=window._scannerStop)==null||f.call(window),t(A.data);return}}requestAnimationFrame(h)}};o.addEventListener("loadeddata",()=>requestAnimationFrame(h))}catch{r&&(r.textContent="No se pudo acceder a la cámara. Ingresá el código manualmente.")}};function Ig(n){Mt();let t=[],e=[];n.innerHTML=`
    <div class="hdr">
    ...
    <div style="max-width:400px;margin:0 auto;padding:16px">
      ...
      </div>`).join("")}}}const bg=n=>Number(n).toLocaleString("es-AR"),wg={pendiente:"Pendiente",pagado:"Pagado",listo:"Listo",entregado:"Entregado"},Tg={pendiente:"b-pend",pagado:"b-pago",listo:"b-list",entregado:"b-entr"},xg={pendiente:"Cobrar ✓",pagado:"Listo ✓",listo:"Entregar ✓"},Rg={pendiente:"btn-g",pagado:"btn-b",listo:"btn-v"},Cg={pendiente:"pagado",pagado:"listo",listo:"entregado"};function Pg(n){Mt();let t=[];n.innerHTML=`
    ...
    <div class="wrap" id="log-lista"></div>`,Ur(r=>{t=r,e()}),window._avzLog=async(r,i)=>{await qs(r,i)};function e(){const r=document.getElementById("log-lista");if(!r)return;const i=t.filter(c=>c.retiro==="envio");if(!i.length){r.innerHTML='<div class="empty">🚚<br><br>Sin pedidos de envío</div>';return}const o=i.filter(c=>c.estado!=="entregado"),a=i.filter(c=>c.estado==="entregado");r.innerHTML=(o.length?`<p style="font-size:12px;font-weight:500;color:#5A1E99;margin-bottom:8px">Pendientes (${o.length})</p>`:"")+o.map(c=>{var u;return`
        <div class="card" style="margin-bottom:10px;border-left:3px solid #5A1E99">
          <div style="display:flex;justify-content:space-between;margin-bottom:6px">
            ...
            <span class="badge ${Tg[c.estado]}">${wg[c.estado]}</span>
          </div>
          ...
          <div style="display:flex;justify-content:space-between;align-items:center">
            <span style="font-size:15px;font-weight:500">$${bg(c.total||0)}</span>
            ${Cg[c.estado]?`<button class="btn ${Rg[c.estado]}" style="font-size:12px"
                  onclick="window._avzLog('${c.fireId}','${c.estado}')">${xg[c.estado]}</button>`:""}
          </div>
        ...
        </div>`}).join("")}}const Sg=n=>Number(n).toLocaleString("es-AR");async function Vg(n,t){if(Mt(),n.innerHTML=Xi(null)+`
    ...
    <p style="font-size:11px;color:#aaa;margin-top:12px">
    ...
    </p>`,setTimeout(()=>Dg("qr-acc",e.codigo,160),50),kc(e.fireId,i=>{const o=document.getElementById("vouchers-acc");if(o){if(!i.length){o.innerHTML="";return}o.innerHTML=`
      ...
      ${i.map(a=>{const c={pagado:"Listo para retirar",entregado:"Entregado"},u=a.estado==="pagado";return`
          <div style="background:${u?"#EAF3DE":"#f5f5f5"};border:.5px solid ${u?"#3B6D11":"#ddd"};
            ...
            <div style="font-size:14px;font-weight:500">$${Sg(a.total||0)}</div>
    ...
    <p style="font-size:12px;color:#aaa;margin-top:16px">José Pannunzio +54 9 11 5400-1313</p>`}function Dg(n,t,e){const r=document.getElementById(n);if(!r)return;const i=r.getContext("2d");r.width=e,r.height=e;const o=21,a=e/o;i.fillStyle="#fff",i.fillRect(0,0,e,e),i.fillStyle="#1a1a1a";const c=String(t).split("").reduce((h,f)=>h+f.charCodeAt(0),0),u=(h,f)=>(h*7+f*13+c*(h+1))%17<8;for(let h=0;h<o;h++)for(let f=0;f<o;f++){const m=(_,T)=>f>=_&&f<=_+6&&h>=T&&h<=T+6,A=(_,T)=>f>=_+2&&f<=_+4&&h>=T+2&&h<=T+4;if(m(0,0)||m(14,0)||m(0,14)){(m(0,0)&&(f===0||f===6||h===0||h===6||A(0,0))||m(14,0)&&(f===14||f===20||h===0||h===6||f>=16&&f<=18&&h>=2&&h<=4)||m(0,14)&&(f===0||f===6||h===14||h===20||f>=2&&f<=4&&h>=16&&h<=18))&&i.fillRect(f*a,h*a,a,a);continue}u(f,h)&&i.fillRect(f*a+.5,h*a+.5,a-1,a-1)}}const kg=()=>Math.random().toString(36).slice(2,10).toUpperCase();function Ng(n){Mt();let t=0;const e=Hr(r=>{t=r.length,e()});n.innerHTML=`
    ...
    <div style="max-width:480px;margin:0 auto;padding:20px 16px">
      ...
      <p style="font-size:11px;color:#aaa;text-align:center;margin-top:16px">
    ...
    </div>`,window._autoRegistrar=async()=>{const r=document.getElementById("rn").value.trim(),i=document.getElementById("ra").value.trim(),o=document.getElementById("rt").value.trim(),a=document.getElementById("re").value.trim(),c=document.getElementById("rf").value.trim(),u=document.getElementById("rc").value.trim(),h=document.getElementById("reg-msg");if(!r||!i||!o){h.innerHTML='<span style="color:#A32D2D">Nombre, apellido y WhatsApp son obligatorios.</span>';return}h.innerHTML='<span style="color:#888">Registrando...</span>';try{const f=await Fc(()=>Promise.resolve().then(()=>og),void 0).then(A=>A.escucharInvitados),m="INV-"+String(t+1).padStart(4,"0");await br({nombre:r,apellido:i,tel:o,...a&&{email:a},...c&&{familia:c},...u&&{comentarios:u},estado:"pendiente",codigo:m,token:kg()}),document.getElementById("reg-form").innerHTML=`
        ...
        </div>`}catch(f){h.innerHTML=`<span style="color:#A32D2D">Error: ${f.message}</span>`}}}const xi=n=>Number(n).toLocaleString("es-AR");function Lg(n,t){if(Mt(),!t||t.estado==="invalidado"){n.innerHTML=`
    ...
    <div style="max-width:480px;margin:0 auto;padding:14px" id="carrito-body">
      ...
      <div id="carrito-msg" style="font-size:12px;text-align:center;min-height:16px;margin-bottom:8px"></div>`}window._quitarCarrito=async(i,o)=>{const a=e.find(c=>c.standDocId===i);a&&await Tr(t.fireId,Number(a.standId),o)},window._cambiarRetiro=async(i,o,a)=>{await js(t.fireId,Number(o),a)}}async function Hc(){const t=window.location.pathname.replace("/Sucovi2027","")||"/",e=new URLSearchParams(window.location.search),r=document.getElementById("app"),i=t.match(/^\/stand\/(\d+)$/);if(i){const c=parseInt(i[1]),u=xe.find(m=>m.id===c);if(!u){r.innerHTML=Ri("Stand no encontrado");return}const h=e.get("inv"),f=h?await wr(h):null;return vg(r,u,f)}const o=t.match(/^\/panel\/(\d+)$/);if(o){const c=xe.find(u=>u.id===parseInt(o[1]));if(!c){r.innerHTML=Ri("Panel no encontrado");return}return zc(r,c)}const a=t.match(/^\/bodega\/(\d+)\/vinos$/);if(a){const c=xe.find(u=>u.id===parseInt(a[1]));if(!c){r.innerHTML=Ri("Bodega no encontrada");return}return qc(r,c)}if(t==="/carrito"){const c=e.get("inv"),u=c?await wr(c):null;return Lg(r,u)}return t==="/acceso"?Vg(r,e.get("inv")):t==="/registro"?Ng(r):t==="/caja"?yg(r):t==="/puerta"?Ig(r):t==="/logistica"?Pg(r):dg(r)}function Ri(n){return`<div style="padding:60px;text-align:center;color:#aaa;font-size:14px">${n}</div>`}Hc();window.addEventListener("popstate",Hc);(function(){var n=window.location.search.match(/[?&]p=([^&]+)/);if(n){var t="/Sucovi2027",e=decodeURIComponent(n[1].replace(/~and~/g,"&"));window.history.replaceState(null,null,t+"/"+e)}})();
